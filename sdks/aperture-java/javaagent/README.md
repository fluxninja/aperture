...
| aperture.agent.api.key                 | APERTURE_AGENT_API_KEY                 |                | API Key to connect with FluxNinjaCloud Agent                                                                                                 |
...
-Daperture.agent.api,key="API_KEY" \
...
aperture.agent.api.key=API_KEY
