...
This project provides a JAR file that can be used to integrate your Java applications with
...
The resulting jar can be found in the `aperture-java/javaagent/build/libs` directory.
