...
| aperture.javaagent.enable.expect.end   | APERTURE_JAVAAGENT_ENABLE_EXPECT_END   | true           | Sets the expect end of flows started by the client. <br /> If set to true, all flows will be expecting the end of the request                |
