...
public interface HttpRuleOrBuilder extends
   ...
   * @return The custom.
   */
  com.fluxninja.generated.google.api.CustomHttpPattern getCustom();
  /**
   * <pre>
   * The custom pattern is used for specifying an HTTP method that is not
   * included in the `pattern` field, such as HEAD, or "*" to leave the
   ...
   * <code>.google.api.CustomHttpPattern custom = 8 [json_name = "custom"];</code>
   */
  com.fluxninja.generated.google.api.CustomHttpPatternOrBuilder getCustomOrBuilder();
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11 [json_name = "additionalBindings"];</code>
   */
  com.fluxninja.generated.google.api.HttpRule getAdditionalBindings(int index);
  /**
   * <pre>
   * Additional HTTP bindings for the selector. Nested bindings must
   * not contain an `additional_bindings` field themselves (that is,
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11 [json_name = "additionalBindings"];</code>
   */
  com.fluxninja.generated.google.api.HttpRuleOrBuilder getAdditionalBindingsOrBuilder(
      int index);

  public com.fluxninja.generated.google.api.HttpRule.PatternCase getPatternCase();
}
