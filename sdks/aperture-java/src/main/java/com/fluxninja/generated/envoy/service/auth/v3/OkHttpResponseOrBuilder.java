...
public interface OkHttpResponseOrBuilder extends
   ...
   */
  java.util.List<com.fluxninja.generated.envoy.config.core.v3.HeaderValueOption> 
      getHeadersList();
  /**
   * <pre>
   * HTTP entity headers in addition to the original request headers. This allows the authorization
   ...
   * <code>repeated .envoy.config.core.v3.HeaderValueOption headers = 2 [json_name = "headers"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.HeaderValueOption getHeaders(int index);
  /**
   * <pre>
   * HTTP entity headers in addition to the original request headers. This allows the authorization
   * service to append, to add or to override headers from the original request before
   ...
   * <code>repeated .envoy.config.core.v3.HeaderValueOption headers = 2 [json_name = "headers"];</code>
   */
  java.util.List<? extends com.fluxninja.generated.envoy.config.core.v3.HeaderValueOptionOrBuilder> 
   ...
   * <code>repeated .envoy.config.core.v3.HeaderValueOption headers = 2 [json_name = "headers"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.HeaderValueOptionOrBuilder getHeadersOrBuilder(
      int index);
   ...
   * <code>repeated .envoy.config.core.v3.HeaderValueOption response_headers_to_add = 6 [json_name = "responseHeadersToAdd"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.HeaderValueOption getResponseHeadersToAdd(int index);
  /**
   * <pre>
   * This field allows the authorization service to send HTTP response headers
   * to the downstream client on success. Note that the :ref:`append field in HeaderValueOption &lt;envoy_v3_api_field_config.core.v3.HeaderValueOption.append&gt;`
   ...
   * <code>repeated .envoy.config.core.v3.HeaderValueOption response_headers_to_add = 6 [json_name = "responseHeadersToAdd"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.HeaderValueOptionOrBuilder getResponseHeadersToAddOrBuilder(
      int index);
   ...
   */
  java.util.List<com.fluxninja.generated.envoy.config.core.v3.QueryParameter> 
   ...
   * <code>repeated .envoy.config.core.v3.QueryParameter query_parameters_to_set = 7 [json_name = "queryParametersToSet"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.QueryParameter getQueryParametersToSet(int index);
  /**
   * <pre>
   * This field allows the authorization service to set (and overwrite) query
   * string parameters on the original request before it is sent upstream.
   ...
   * <code>repeated .envoy.config.core.v3.QueryParameter query_parameters_to_set = 7 [json_name = "queryParametersToSet"];</code>
   */
  java.util.List<? extends com.fluxninja.generated.envoy.config.core.v3.QueryParameterOrBuilder> 
   ...
   * <code>repeated .envoy.config.core.v3.QueryParameter query_parameters_to_set = 7 [json_name = "queryParametersToSet"];</code>
   */
  com.fluxninja.generated.envoy.config.core.v3.QueryParameterOrBuilder getQueryParametersToSetOrBuilder(
      int index);
