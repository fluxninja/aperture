...
class LimiterDecision(_message.Message):
    __slots__ = ["policy_name", "policy_hash", "component_id", "dropped", "reason", "denied_response_status_code", "rate_limiter_info", "load_scheduler_info", "sampler_info", "quota_scheduler_info"]
