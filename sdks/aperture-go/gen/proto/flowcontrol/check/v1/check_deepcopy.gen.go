...
// DeepCopyInto supports using LimiterDecision_LoadRegulatorInfo within kubernetes types, where deepcopy-gen is used.
func (in *LimiterDecision_LoadRegulatorInfo) DeepCopyInto(out *LimiterDecision_LoadRegulatorInfo) {
	p := proto.Clone(in).(*LimiterDecision_LoadRegulatorInfo)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LimiterDecision_LoadRegulatorInfo. Required by controller-gen.
func (in *LimiterDecision_LoadRegulatorInfo) DeepCopy() *LimiterDecision_LoadRegulatorInfo {
	if in == nil {
		return nil
	}
	out := new(LimiterDecision_LoadRegulatorInfo)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LimiterDecision_LoadRegulatorInfo. Required by controller-gen.
func (in *LimiterDecision_LoadRegulatorInfo) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
