...
// DeepCopyInto supports using AWSGatewayCheckRequest within kubernetes types, where deepcopy-gen is used.
func (in *AWSGatewayCheckRequest) DeepCopyInto(out *AWSGatewayCheckRequest) {
	p := proto.Clone(in).(*AWSGatewayCheckRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSGatewayCheckRequest. Required by controller-gen.
func (in *AWSGatewayCheckRequest) DeepCopy() *AWSGatewayCheckRequest {
	if in == nil {
		return nil
	}
	out := new(AWSGatewayCheckRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AWSGatewayCheckRequest. Required by controller-gen.
func (in *AWSGatewayCheckRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
