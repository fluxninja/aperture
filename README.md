...
To try aperture in your K8s environment, refer to [deployment docs](manifests/k8s/README.md).
...
For your convienience, all the needed development tools can be install with [`asdf`](manifests/k8s/README.md#tools).

Before commiting, install `pre-commit` hooks, which will automatically check if your code meets our standards.
...
After your first PR is created you wouldd be asked to sign our [Contributor License Agreement](https://cla-assistant.io/fluxninja/aperture).
