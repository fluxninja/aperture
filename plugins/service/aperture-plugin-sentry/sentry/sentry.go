...
type SentryConfig struct {
	...
	Dsn string `json:"dsn,omitempty" default:"https://6223f112b0ac4344aa67e94d1631eb85@o574197.ingest.sentry.io/6605877"`
	// Environment
	Environment string `json:"environment,omitempty" default:"production"`
	// Sample rate for sampling traces i.e. 0.0 to 1.0
	TracesSampleRate float64 `json:"traces_sample_rate,omitempty" default:"0.2"`
	...
	Debug bool `json:"debug,omitempty" default:"true"`
	// Configure to generate and attach stacktraces to capturing message calls
	AttachStacktrace bool `json:"attach_stack_trace,omitempty" default:"true"`
