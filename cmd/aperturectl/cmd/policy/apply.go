...
// ApplyCmd is the command to apply a policy to the Aperture Controller.
var ApplyCmd = &cobra.Command{
	Use:           "apply",
	Short:         "Apply Aperture Policy to the Aperture Controller",
	Long:          `Use this command to apply the Aperture Policy to the Aperture Controller.`,
	SilenceErrors: true,
	Example: `aperturectl policy apply --file=policies/rate-limiting.yaml

aperturectl policy apply --dir=policies`,
