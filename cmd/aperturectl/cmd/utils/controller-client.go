...
type PolicyClient interface {
	...
	UpsertPolicy(ctx context.Context, in *policylangv1.UpsertPolicyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
var _ CloudBlueprintsClient = cloudv1.BlueprintsServiceClient(nil)
