...
require (
	...
	github.com/open-policy-agent/opa-envoy-plugin v0.42.1-envoy
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20220725142548-1d3ee6a70d75 // indirect
...
require (
	...
	github.com/ionos-cloud/sdk-go/v6 v6.1.1 // indirect
