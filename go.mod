...
replace (
	...
	go.opentelemetry.io/collector/extension/ballastextension => go.opentelemetry.io/collector/extension/ballastextension v0.64.0
	...
	go.opentelemetry.io/collector/processor/memorylimiterprocessor => go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.64.0
