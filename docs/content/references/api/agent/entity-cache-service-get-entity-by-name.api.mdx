---
id: entity-cache-service-get-entity-by-name
title: EntityCacheService_GetEntityByName
description: "EntityCacheService_GetEntityByName"
sidebar_label: /v1/entities/name/{name}
hide_title: true
...
api:
  {
    ...
    "description": "EntityCacheService_GetEntityByName",
    "method": "get",
    "path": "/v1/entities/name/{name}",
    "servers": [{ "url": "https://aperture-agent" }],
    "info": { "title": "Aperture API", "version": "1.0" },
    "postman":
      {
        "name": "Entity Cache Service Get Entity By Name",
...
## EntityCacheService_GetEntityByName
