---
id: entity-cache-service-get-entity-cache
title: EntityCacheService_GetEntityCache
description: "EntityCacheService_GetEntityCache"
sidebar_label: /v1/entities
hide_title: true
...
api:
  {
                ...
                "application/json":
                  {
                    "schema":
                      {
                        "description":
                          "EntityCache contains both mappings of ip address to
                          entity and entity name to entity.",
                        "type": "object",
                        "properties":
                          {
    ...
    "postman":
      {
        "name": "Entity Cache Service Get Entity Cache",
...
## EntityCacheService_GetEntityCache
