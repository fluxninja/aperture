...
| workload_requests_total | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id, workload_index | count (no unit) | A counter of workload requests                            |
...
| Name                 | Type    | Labels                                                                           | Unit            | Description                                                        |
| -------------------- | ------- | -------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------ |
| rate_limiter_counter | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id | count (no unit) | A counter measuring the number of times Rate Limiter was triggered |
