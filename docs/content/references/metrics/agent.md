...
| ---------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---- | ------------------------ |
| flux_meter | Histogram | agent_group, instance, job, process_uuid, flux_meter_name, decision_type, response_status, http_status_code, feature_status, valid | ms   | Flow's workload duration |
...
| flowcontrol_error_reasons_total  | Counter | agent_group, instance, job, process_uuid, error_reason  | count(no unit)  | Number of error reasons other than unspecified  |
