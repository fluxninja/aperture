...
| aperture.rate_limiters                 |      | "policy_name:s1, component_index:18, policy_hash:5kZjj"                                                                                                                   | Rate limiters matched to the traffic               | SDKs, Envoy               |
| aperture.dropping_rate_limiters        |      | "policy_name:s1, component_index:18, policy_hash:5kZjj"                                                                                                                   | Rate limiters dropping the traffic                 | SDKs, Envoy               |
| aperture.concurrency_limiters          |      | "policy_name:s1, component_index:13, policy_hash:5kZjj"                                                                                                                   | Concurrency limiters matched to the traffic        | SDKs, Envoy               |
| aperture.dropping_concurrency_limiters |      | "policy_name:s1, component_index:13, policy_hash:5kZjj"                                                                                                                   | Concurrency limiters dropping the traffic          | SDKs, Envoy               |
| aperture.workloads                     |      | "policy_name:s1, component_index:13, workload_index:0, policy_hash:5kZjj"                                                                                                 | Workloads matched to the traffic                   | SDKs, Envoy               |
| aperture.dropping_workloads            |      | "policy_name:s1, component_index:13, workload_index:0, policy_hash:5kZjj"                                                                                                 | Workloads dropping the traffic                     | SDKs, Envoy               |
| aperture.flux_meters                   |      | s1                                                                                                                                                                        | Flux Meters matched to the traffic                 | SDKs, Envoy               |
...
| aperture.classifiers                   |      | "policy_name:s1, classifier_index:0"                                                                                                                                      | Classifiers matched to the traffic                 | SDKs, Envoy               |
| aperture.classifier_errors             |      | "[ERROR_NONE, ERROR_EVAL_FAILED, ERROR_EMPTY_RESULTSET, ERROR_AMBIGUOUS_RESULTSET, ERROR_MULTI_EXPRESSION, ERROR_EXPRESSION_NOT_MAP], policy_name:s1, classifier_index:0" | Encountered classifier errors for specified policy | SDKs, Envoy               |
| aperture.services                      |      | s1.demoapp.svc.cluster.local, s2.demoapp.svc.cluster.local                                                                                                                | Services to which metrics refer                    | SDKs, Envoy               |
...
| http.host                    |      | s1.demoapp.svc.cluster.local, s2.demoapp.svc.cluster.local | Host address of the response                 | Envoy                     |
