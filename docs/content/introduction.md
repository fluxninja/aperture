...
[**Declarative policies**](./concepts/advanced/policy.md) that facilitates teams
...
that the policy should consider. [**Classifier**](./concepts/classifier.md). →
Create additional Flow Labels based on request metadata, collectively enriching
the policy's operational capability.
