...
To achieve this, the policy makes use of an _Auto Scaler_ component to adjust
the number of instances allocated to the service. Load-based auto-scaling is
...
traffic that the [_Load Scheduler_](/concepts/load-scheduler.md) is throttling
