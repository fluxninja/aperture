...
[Quota Scheduler](/reference/blueprints/quota-scheduler.md#policy-quota-scheduler)
blueprint.
...
[`Quota Scheduler`](/reference/blueprints/quota-scheduler.md) Blueprint, which
brings together the token bucket rate limiting and a
