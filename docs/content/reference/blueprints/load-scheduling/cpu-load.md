...
Blueprint name: <a
href={`https://github.com/fluxninja/aperture/tree/${aver}/blueprints/load-scheduling/cpu-load`}>load-scheduling/cpu-load</a>
...
<a id="policy-k8s-deployment-name"></a>

<ParameterDescription
    name='policy.k8s_deployment_name'
    description='Name of the deployment to protect.'
    type='string'
    reference=''
    value='"__REQUIRED_FIELD__"'
/>
...
<a id="policy-k8s-namespace"></a>

<ParameterDescription
    name='policy.k8s_namespace'
    description='Namespace of the deployment to protect.'
    type='string'
    reference=''
    value='"__REQUIRED_FIELD__"'
/>
