---
title: Load Scheduling based on Java garbage collection times (Kubernetes)
keywords:
  - blueprints
sidebar_position: 3
sidebar_label:
...
Blueprint name: <a href={`https://github.com/fluxninja/aperture/tree/${aver}/blueprints/load-scheduling/java-gc-k8s`}>load-scheduling/java-gc-k8s</a>
...
<a id="policy-jmx-k8s-pod-regex"></a>

<ParameterDescription
    name='policy.jmx.k8s_pod_regex'
