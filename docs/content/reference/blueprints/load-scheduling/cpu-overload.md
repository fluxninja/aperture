...
Blueprint name: <a
href={`https://github.com/fluxninja/aperture/tree/${aver}/blueprints/load-scheduling/cpu-overload`}>load-scheduling/cpu-overload</a>
...
<a id="policy-kubernetes-object-selector-agent-group"></a>

<ParameterDescription
    name='policy.kubernetes_object_selector.agent_group'
    description='Agent group to protect.'
    type='string'
    reference=''
    value='"default"'
/>
