...
<ParameterDescription
    ...
    value='[{"criteria": {"forward": {"threshold": "__REQUIRED_FIELD__"}}, "selectors": [{"control_point": "__REQUIRED_FIELD__", "service": "__REQUIRED_FIELD__"}]}]'
/>
...
<ParameterDescription
    name='criteria'
    description='The criteria for average latency comparison.'
