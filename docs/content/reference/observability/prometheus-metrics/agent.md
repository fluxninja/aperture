...
| invalid_flux_meter_total | Counter   | agent_group, instance, job, process_uuid, flux_meter_name, decision_type, http_status_code, flow_status | ms   | Count of invalid FluxMeter readings |
...
| incoming_work_seconds_total | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id                                                 | seconds         | A counter measuring work incoming into Scheduler |
| accepted_work_seconds_total | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id                                                 | seconds         | A counter measuring work admitted by Scheduler   |
...
| Name                 | Type    | Labels                                                                                                           | Unit            | Description                                                        |
| -------------------- | ------- | ---------------------------------------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------ |
| rate_limiter_counter | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id, decision_type, limiter_dropped | count (no unit) | A counter measuring the number of times Rate Limiter was triggered |
...
| Name                   | Type    | Labels                                                                                                             | Unit            | Description                                                          |
| ---------------------- | ------- | ------------------------------------------------------------------------------------------------------------------ | --------------- | -------------------------------------------------------------------- |
| flow_regulator_counter | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_id, decision_type, regulator_dropped | count (no unit) | A counter measuring the number of times Flow Regulator was triggered |
...
| component_id      | 13                                             | Index of the component in order of specification in the policy. |
| decision_type     | DECISION_TYPE_ACCEPTED, DECISION_TYPE_REJECTED | Whether the flow was accepted or not                            |
| regulator_dropped | true, false                                    | Whether this particular regulator has dropped the request.      |
