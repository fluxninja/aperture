...
| decision_type   | DECISION_TYPE_ACCEPTED, DECISION_TYPE_REJECTED | Whether the flow was accepted or not                               |
| limiter_dropped | true, false                                    | Indicates whether this particular limiter has dropped the request. |
...
| component_id      | 13                                             | Index of the component in order of specification in the policy.      |
| decision_type     | DECISION_TYPE_ACCEPTED, DECISION_TYPE_REJECTED | Whether the flow was accepted or not                                 |
| regulator_dropped | true, false                                    | Indicates whether this particular regulator has dropped the request. |
