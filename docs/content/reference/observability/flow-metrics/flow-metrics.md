...
| aperture.load_samplers          | multi-value | "policy_name:s1, component_id:18, policy_hash:5kZjj"                                                                                                                      | Load Samplers matched to the traffic             | SDKs, Envoy               |
| aperture.dropping_load_samplers | multi-value | "policy_name:s1, component_id:18, policy_hash:5kZjj"                                                                                                                      | Load Samplers dropping the traffic               | SDKs, Envoy               |
