...
See also
[Aperture Controller installation](/aperture-for-infra/controller/controller.md).
...
Disable this flag only if using [Self-Hosted](/aperture-for-infra/aperture-for-infra.md)
Aperture Controller.
