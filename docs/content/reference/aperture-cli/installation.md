...
import {DownloadScript} from '../../aperture-for-infra/agent/bare-metal.md';
```
...
on the [aperturectl](/reference/aperture-cli/aperturectl/aperturectl.md) reference page.
...
[bash completions](/reference/aperture-cli/aperturectl/completion/completion.md), add to your
profile:
...
## [aperturectl](/reference/aperture-cli/aperturectl/completion/completion.md)
