...
[configuration file for the Aperture Agent](/self-hosting/agent/agent.md#agent-self-hosted-controller)
and install it using the
[Aperture Agent installation guide](/self-hosting/agent/agent.md).
