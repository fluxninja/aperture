...
:::note Note to Developers: For implementing rate limiting using Aperture SDKs,
please refer to our developer-centric
[Rate Limiting Guide](/guides/per-user-rate-limiting.md). :::
