...
[configuration file for the Aperture Agent](/aperture-for-infra/agent/agent.md#agent-self-hosted-controller)
and install it using the
[Aperture Agent installation guide](/aperture-for-infra/agent/agent.md).
