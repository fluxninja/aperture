...
| aperture.flow                | "%DYNAMIC_METADATA(envoy.filters.http.ext_authz:aperture.flow)%"              | Aperture Flow Labels                                                                   | Inbound, Outbound |
| aperture.limiter_decisions   | "%DYNAMIC_METADATA(envoy.filters.http.ext_authz:aperture.limiter_decisions)%" | Aperture Limiter Decisions details                                                     | Inbound, Outbound |
| aperture.flux_meters         | "%DYNAMIC_METADATA(envoy.filters.http.ext_authz:aperture.flux_meters)%"       | Aperture Flux Meters details                                                           | Inbound, Outbound |
             ...
             typed_config:
               ...
               attributes:
                 values:
                   ...
                   - key: aperture.limiter_decisions
                     value:
                       string_value: "%DYNAMIC_METADATA(envoy.filters.http.ext_authz:aperture.limiter_decisions)%"
                   - key: aperture.flux_meters
                     value:
                       string_value: "%DYNAMIC_METADATA(envoy.filters.http.ext_authz:aperture.flux_meters)%"
                   - key: control_point
                     value:
                       string_value: "egress"
