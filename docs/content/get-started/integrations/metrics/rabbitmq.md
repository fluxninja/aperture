...
See also [rabbitmqreceiver docs][receiver] in opentelemetry-collect-contrib repo.

:::

::: note

The rabbitmqreceiver extension is available in default agent image, but if you're [building][build] your own Aperture Agent, make sure to add `integrations/otel/rabbitmqreceiver` to `bundled_extensions` list.
