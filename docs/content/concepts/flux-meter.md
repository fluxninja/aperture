...
Additionally, a control loop can use the duration signal generated by the Flux
Meter metric. This signal is sent to a Controller, which then determines the
desired concurrency level for a service.
