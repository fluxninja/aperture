...
local autoScalerKubernetesReplicas = aperture.spec.v1.AutoScalerKubernetesReplicas;
local kubeObjectSelector = aperture.spec.v1.KubernetesObjectSelector;
local increasingGradient = aperture.spec.v1.AutoScalerIncreasingGradient;
local decreasingGradient = aperture.spec.v1.AutoScalerDecreasingGradient;
