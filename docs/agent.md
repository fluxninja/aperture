...
### <span id="agent-info"></span> agent info (*AgentInfo*)
...
### <span id="auto-scale-config"></span> auto scale config (*AutoScaleConfig*)
...
### <span id="client"></span> client (*Client*)
...
### <span id="dist-cache"></span> dist cache (*DistCache*)
...
### <span id="flow-control"></span> flow control (*FlowControl*)
...
### <span id="flux-ninja-extension"></span> flux ninja extension (*FluxNinjaExtension*)
...
### <span id="functions"></span> functions (*Functions*)
...
### <span id="kubernetes-client"></span> kubernetes client (*KubernetesClient*)
...
### <span id="liveness"></span> liveness (*Liveness*)
...
### <span id="metrics"></span> metrics (*Metrics*)
...
### <span id="peer-discovery"></span> peer discovery (*PeerDiscovery*)
...
### <span id="profilers"></span> profilers (*Profilers*)
...
### <span id="prometheus"></span> prometheus (*Prometheus*)
...
### <span id="readiness"></span> readiness (*Readiness*)
...
### <span id="sentry-extension"></span> sentry extension (*SentryExtension*)
...
### <span id="server"></span> server (*Server*)
...
### <span id="service-discovery"></span> service discovery (*ServiceDiscovery*)
...
### <span id="watchdog"></span> watchdog (*Watchdog*)
...
| WorkerLimit | int64 (formatted integer)| `int64` |  | | Limits how many jobs can be running at the same time. This is
...
| SampleRate | double (formatted number)| `float64` |  | | Sample rate for event submission |  |
| TracesSampleRate | double (formatted number)| `float64` |  | | Sample rate for sampling traces |  |
