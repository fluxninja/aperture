...
Ratelimiting is done separately on per-label-value basis. User _label_key_
...
([V1Selector](#v1-selector), `required`) Which control point to apply this ratelimiter
