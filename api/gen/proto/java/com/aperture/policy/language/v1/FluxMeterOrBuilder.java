...
public interface FluxMeterOrBuilder extends
   ...
   */
  com.aperture.policy.language.v1.FluxMeter.StaticBuckets getStaticBuckets();
  /**
   * <code>.aperture.policy.language.v1.FluxMeter.StaticBuckets static_buckets = 2[json_name = "staticBuckets"];</code>
   */
  com.aperture.policy.language.v1.FluxMeter.StaticBucketsOrBuilder getStaticBucketsOrBuilder();
   ...
   */
  com.aperture.policy.language.v1.FluxMeter.LinearBuckets getLinearBuckets();
  /**
   * <code>.aperture.policy.language.v1.FluxMeter.LinearBuckets linear_buckets = 3[json_name = "linearBuckets"];</code>
   */
  com.aperture.policy.language.v1.FluxMeter.LinearBucketsOrBuilder getLinearBucketsOrBuilder();
   ...
   */
  com.aperture.policy.language.v1.FluxMeter.ExponentialBuckets getExponentialBuckets();
  /**
   * <code>.aperture.policy.language.v1.FluxMeter.ExponentialBuckets exponential_buckets = 4[json_name = "exponentialBuckets"];</code>
   */
  com.aperture.policy.language.v1.FluxMeter.ExponentialBucketsOrBuilder getExponentialBucketsOrBuilder();
   ...
   */
  com.aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange getExponentialBucketsRange();
  /**
   * <code>.aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange exponential_buckets_range = 5[json_name = "exponentialBucketsRange"];</code>
   */
  com.aperture.policy.language.v1.FluxMeter.ExponentialBucketsRangeOrBuilder getExponentialBucketsRangeOrBuilder();
  ...
  public com.aperture.policy.language.v1.FluxMeter.HistogramBucketsCase getHistogramBucketsCase();
}
