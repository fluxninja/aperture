...
public interface SchedulerOrBuilder extends
   ...
   */
  java.util.List<com.aperture.policy.language.v1.Scheduler.Workload>
      getWorkloadsList();
  /**
   * <pre>
   * List of workloads to be used in scheduler.
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  com.aperture.policy.language.v1.Scheduler.Workload getWorkloads(int index);
  /**
   * <pre>
   * List of workloads to be used in scheduler.
   * Categorizing [flows](/concepts/flow-control/flow-control.md#flow) into workloads
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  java.util.List<? extends com.aperture.policy.language.v1.Scheduler.WorkloadOrBuilder>
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  com.aperture.policy.language.v1.Scheduler.WorkloadOrBuilder getWorkloadsOrBuilder(
      int index);
   ...
   */
  com.aperture.policy.language.v1.Scheduler.WorkloadParameters getDefaultWorkloadParameters();
  /**
   * <pre>
   * WorkloadParameters to be used if none of workloads specified in `workloads` match.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Scheduler.WorkloadParameters default_workload_parameters = 4[json_name = "defaultWorkloadParameters"];</code>
   */
  com.aperture.policy.language.v1.Scheduler.WorkloadParametersOrBuilder getDefaultWorkloadParametersOrBuilder();
