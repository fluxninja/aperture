...
public interface RuleOrBuilder extends
   ...
   */
  com.aperture.policy.language.v1.Extractor getExtractor();
  /**
   * <pre>
   * High-level declarative extractor.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Extractor extractor = 1[json_name = "extractor"];</code>
   */
  com.aperture.policy.language.v1.ExtractorOrBuilder getExtractorOrBuilder();
   ...
   * @return The rego.
   */
  com.aperture.policy.language.v1.Rule.Rego getRego();
  /**
   * <pre>
   * Rego module to extract a value from the rego module.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Rule.Rego rego = 2[json_name = "rego"];</code>
   */
  com.aperture.policy.language.v1.Rule.RegoOrBuilder getRegoOrBuilder();
  ...
  public com.aperture.policy.language.v1.Rule.SourceCase getSourceCase();
}
