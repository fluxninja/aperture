...
public interface PolicyOrBuilder extends
   ...
   * @return The circuit.
   */
  com.aperture.policy.language.v1.Circuit getCircuit();
  /**
   * <pre>
   * Defines the control-loop logic of the policy.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Circuit circuit = 1[json_name = "circuit"];</code>
   */
  com.aperture.policy.language.v1.CircuitOrBuilder getCircuitOrBuilder();
   ...
   */
  com.aperture.policy.language.v1.Resources getResources();
  /**
   * <pre>
   * Resources (FluxMeters, Classifiers etc.) to setup.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Resources resources = 2[json_name = "resources"];</code>
   */
  com.aperture.policy.language.v1.ResourcesOrBuilder getResourcesOrBuilder();
}
