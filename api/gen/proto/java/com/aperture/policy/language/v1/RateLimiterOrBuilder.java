...
public interface RateLimiterOrBuilder extends
   ...
   */
  java.util.List<com.aperture.policy.language.v1.RateLimiter.Override>
      getOverridesList();
  /**
   * <pre>
   * Allows to specify different limits for particular label values.
   ...
   * <code>repeated .aperture.policy.language.v1.RateLimiter.Override overrides = 5[json_name = "overrides"];</code>
   */
  com.aperture.policy.language.v1.RateLimiter.Override getOverrides(int index);
  /**
   * <pre>
   * Allows to specify different limits for particular label values.
   * </pre>
   ...
   * <code>repeated .aperture.policy.language.v1.RateLimiter.Override overrides = 5[json_name = "overrides"];</code>
   */
  java.util.List<? extends com.aperture.policy.language.v1.RateLimiter.OverrideOrBuilder>
   ...
   * <code>repeated .aperture.policy.language.v1.RateLimiter.Override overrides = 5[json_name = "overrides"];</code>
   */
  com.aperture.policy.language.v1.RateLimiter.OverrideOrBuilder getOverridesOrBuilder(
      int index);
   ...
   * @return The lazySync.
   */
  com.aperture.policy.language.v1.RateLimiter.LazySync getLazySync();
  /**
   * <pre>
   * Configuration of lazy-syncing behaviour of ratelimiter
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.RateLimiter.LazySync lazy_sync = 6[json_name = "lazySync"];</code>
   */
  com.aperture.policy.language.v1.RateLimiter.LazySyncOrBuilder getLazySyncOrBuilder();
}
