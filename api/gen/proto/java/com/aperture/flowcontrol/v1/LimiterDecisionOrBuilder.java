...
public interface LimiterDecisionOrBuilder extends
   ...
   */
  com.aperture.flowcontrol.v1.LimiterDecision.RateLimiterInfo getRateLimiterInfo();
  /**
   * <code>.aperture.flowcontrol.v1.LimiterDecision.RateLimiterInfo rate_limiter_info = 6[json_name = "rateLimiterInfo"];</code>
   */
  com.aperture.flowcontrol.v1.LimiterDecision.RateLimiterInfoOrBuilder getRateLimiterInfoOrBuilder();
   ...
   */
  com.aperture.flowcontrol.v1.LimiterDecision.ConcurrencyLimiterInfo getConcurrencyLimiterInfo();
  /**
   * <code>.aperture.flowcontrol.v1.LimiterDecision.ConcurrencyLimiterInfo concurrency_limiter_info = 7[json_name = "concurrencyLimiterInfo"];</code>
   */
  com.aperture.flowcontrol.v1.LimiterDecision.ConcurrencyLimiterInfoOrBuilder getConcurrencyLimiterInfoOrBuilder();
