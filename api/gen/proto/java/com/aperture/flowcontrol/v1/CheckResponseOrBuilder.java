...
public interface CheckResponseOrBuilder extends
   ...
   * @return The error.
   */
  com.aperture.flowcontrol.v1.CheckResponse.Error getError();
   ...
   */
  com.aperture.flowcontrol.v1.ControlPointInfo getControlPointInfo();
  /**
   * <pre>
   * control_point of request
   * </pre>
   ...
   * <code>.aperture.flowcontrol.v1.ControlPointInfo control_point_info = 5[json_name = "controlPointInfo"];</code>
   */
  com.aperture.flowcontrol.v1.ControlPointInfoOrBuilder getControlPointInfoOrBuilder();
   ...
   */
  com.aperture.flowcontrol.v1.CheckResponse.DecisionType getDecisionType();
   ...
   */
  com.aperture.flowcontrol.v1.CheckResponse.RejectReason getRejectReason();
   ...
   */
  java.util.List<com.aperture.flowcontrol.v1.ClassifierInfo>
   ...
   * <code>repeated .aperture.flowcontrol.v1.ClassifierInfo classifier_infos = 10[json_name = "classifierInfos"];</code>
   */
  com.aperture.flowcontrol.v1.ClassifierInfo getClassifierInfos(int index);
  /**
   * <pre>
   * classifiers that were matched for this request.
   * </pre>
   ...
   * <code>repeated .aperture.flowcontrol.v1.ClassifierInfo classifier_infos = 10[json_name = "classifierInfos"];</code>
   */
  java.util.List<? extends com.aperture.flowcontrol.v1.ClassifierInfoOrBuilder>
   ...
   * <code>repeated .aperture.flowcontrol.v1.ClassifierInfo classifier_infos = 10[json_name = "classifierInfos"];</code>
   */
  com.aperture.flowcontrol.v1.ClassifierInfoOrBuilder getClassifierInfosOrBuilder(
      int index);
   ...
   */
  java.util.List<com.aperture.flowcontrol.v1.FluxMeterInfo>
   ...
   * <code>repeated .aperture.flowcontrol.v1.FluxMeterInfo flux_meter_infos = 11[json_name = "fluxMeterInfos"];</code>
   */
  com.aperture.flowcontrol.v1.FluxMeterInfo getFluxMeterInfos(int index);
  /**
   * <pre>
   * flux meters that were matched for this request.
   * </pre>
   ...
   * <code>repeated .aperture.flowcontrol.v1.FluxMeterInfo flux_meter_infos = 11[json_name = "fluxMeterInfos"];</code>
   */
  java.util.List<? extends com.aperture.flowcontrol.v1.FluxMeterInfoOrBuilder>
   ...
   * <code>repeated .aperture.flowcontrol.v1.FluxMeterInfo flux_meter_infos = 11[json_name = "fluxMeterInfos"];</code>
   */
  com.aperture.flowcontrol.v1.FluxMeterInfoOrBuilder getFluxMeterInfosOrBuilder(
      int index);
