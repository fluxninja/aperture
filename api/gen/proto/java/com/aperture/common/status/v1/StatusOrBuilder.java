...
public interface StatusOrBuilder extends
   ...
   * @return The error.
   */
  com.aperture.common.status.v1.ErrorDetails getError();
  /**
   * <code>.aperture.common.status.v1.ErrorDetails error = 2 [json_name = "error"];</code>
   */
  com.aperture.common.status.v1.ErrorDetailsOrBuilder getErrorOrBuilder();
  ...
  public com.aperture.common.status.v1.Status.DetailsCase getDetailsCase();
}
