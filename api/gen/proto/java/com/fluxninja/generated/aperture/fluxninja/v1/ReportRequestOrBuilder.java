...
public interface ReportRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:aperture.fluxninja.v1.ReportRequest)
   ...
   */
  com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo getControllerInfo();
  /**
   * <code>.aperture.fluxninja.v1.ControllerInfo controller_info = 5 [json_name = "controllerInfo"];</code>
   */
  com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfoOrBuilder getControllerInfoOrBuilder();
   ...
   */
  com.fluxninja.generated.aperture.fluxninja.v1.ServicesList getServicesList();
  /**
   * <code>.aperture.fluxninja.v1.ServicesList services_list = 8 [json_name = "servicesList"];</code>
   */
  com.fluxninja.generated.aperture.fluxninja.v1.ServicesListOrBuilder getServicesListOrBuilder();
   ...
   */
  boolean hasAutoScaleKubernetesControlPoints();
  /**
   * <code>.aperture.autoscale.kubernetes.controlpoints.v1.AutoScaleKubernetesControlPoints auto_scale_kubernetes_control_points = 12 [json_name = "autoScaleKubernetesControlPoints"];</code>
   * @return The autoScaleKubernetesControlPoints.
   */
  com.fluxninja.generated.aperture.autoscale.kubernetes.controlpoints.v1.AutoScaleKubernetesControlPoints getAutoScaleKubernetesControlPoints();
  /**
   * <code>.aperture.autoscale.kubernetes.controlpoints.v1.AutoScaleKubernetesControlPoints auto_scale_kubernetes_control_points = 12 [json_name = "autoScaleKubernetesControlPoints"];</code>
   */
  com.fluxninja.generated.aperture.autoscale.kubernetes.controlpoints.v1.AutoScaleKubernetesControlPointsOrBuilder getAutoScaleKubernetesControlPointsOrBuilder();

  /**
   * <code>string installation_mode = 13 [json_name = "installationMode"];</code>
   * @return The installationMode.
   */
  java.lang.String getInstallationMode();
  /**
   * <code>string installation_mode = 13 [json_name = "installationMode"];</code>
