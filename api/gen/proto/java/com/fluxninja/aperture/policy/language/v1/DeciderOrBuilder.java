...
public interface DeciderOrBuilder extends
   ...
   * @return The inPorts.
   */
  com.fluxninja.aperture.policy.language.v1.Decider.Ins getInPorts();
  /**
   * <pre>
   * Input ports for the Decider component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Decider.Ins in_ports = 1[json_name = "inPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Decider.InsOrBuilder getInPortsOrBuilder();
   ...
   * @return The outPorts.
   */
  com.fluxninja.aperture.policy.language.v1.Decider.Outs getOutPorts();
  /**
   * <pre>
   * Output ports for the Decider component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Decider.Outs out_ports = 2[json_name = "outPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Decider.OutsOrBuilder getOutPortsOrBuilder();
