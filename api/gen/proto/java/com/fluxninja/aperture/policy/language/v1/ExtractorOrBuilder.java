...
public interface ExtractorOrBuilder extends
   ...
   * @return The json.
   */
  com.fluxninja.aperture.policy.language.v1.JSONExtractor getJson();
  /**
   * <pre>
   * Deserialize a json, and extract one of the fields.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.JSONExtractor json = 2[json_name = "json"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.JSONExtractorOrBuilder getJsonOrBuilder();
   ...
   * @return The address.
   */
  com.fluxninja.aperture.policy.language.v1.AddressExtractor getAddress();
  /**
   * <pre>
   * Display an address as a single string - `&lt;ip&gt;:&lt;port&gt;`.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.AddressExtractor address = 3[json_name = "address"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.AddressExtractorOrBuilder getAddressOrBuilder();
   ...
   * @return The jwt.
   */
  com.fluxninja.aperture.policy.language.v1.JWTExtractor getJwt();
  /**
   * <pre>
   * Parse the attribute as JWT and read the payload.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.JWTExtractor jwt = 4[json_name = "jwt"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.JWTExtractorOrBuilder getJwtOrBuilder();
   ...
   */
  com.fluxninja.aperture.policy.language.v1.PathTemplateMatcher getPathTemplates();
  /**
   * <pre>
   * Match HTTP Path to given path templates.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.PathTemplateMatcher path_templates = 5[json_name = "pathTemplates"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.PathTemplateMatcherOrBuilder getPathTemplatesOrBuilder();

  public com.fluxninja.aperture.policy.language.v1.Extractor.VariantCase getVariantCase();
}
