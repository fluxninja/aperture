...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              components_ = new java.util.ArrayList<com.fluxninja.aperture.policy.language.v1.Component>();
              mutable_bitField0_ |= 0x00000001;
            }
            components_.add(
                input.readMessage(com.fluxninja.aperture.policy.language.v1.Component.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.fluxninja.aperture.policy.language.v1.PolicyProto.internal_static_aperture_policy_language_v1_Circuit_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.fluxninja.aperture.policy.language.v1.PolicyProto.internal_static_aperture_policy_language_v1_Circuit_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.fluxninja.aperture.policy.language.v1.Circuit.class, com.fluxninja.aperture.policy.language.v1.Circuit.Builder.class);
  }
  ...
  private java.util.List<com.fluxninja.aperture.policy.language.v1.Component> components_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.fluxninja.aperture.policy.language.v1.Component> getComponentsList() {
    return components_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder>
   ...
   */
  @java.lang.Override
  public com.fluxninja.aperture.policy.language.v1.Component getComponents(int index) {
   ...
   */
  @java.lang.Override
  public com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder getComponentsOrBuilder(
      int index) {
    return components_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.fluxninja.aperture.policy.language.v1.Circuit)) {
      return super.equals(obj);
    }
    com.fluxninja.aperture.policy.language.v1.Circuit other = (com.fluxninja.aperture.policy.language.v1.Circuit) obj;
  ...
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseFrom(
  ...
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseFrom(
  ...
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.fluxninja.aperture.policy.language.v1.Circuit parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.fluxninja.aperture.policy.language.v1.Circuit prototype) {
  ...
  public static final class Builder extends
      ...
      com.fluxninja.aperture.policy.language.v1.CircuitOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.fluxninja.aperture.policy.language.v1.PolicyProto.internal_static_aperture_policy_language_v1_Circuit_descriptor;
    }
    ...
    // Construct using com.fluxninja.aperture.policy.language.v1.Circuit.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.fluxninja.aperture.policy.language.v1.Circuit getDefaultInstanceForType() {
      return com.fluxninja.aperture.policy.language.v1.Circuit.getDefaultInstance();
    }

    @java.lang.Override
    public com.fluxninja.aperture.policy.language.v1.Circuit build() {
      com.fluxninja.aperture.policy.language.v1.Circuit result = buildPartial();
    ...
    @java.lang.Override
    public com.fluxninja.aperture.policy.language.v1.Circuit buildPartial() {
      com.fluxninja.aperture.policy.language.v1.Circuit result = new com.fluxninja.aperture.policy.language.v1.Circuit(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.fluxninja.aperture.policy.language.v1.Circuit) {
        return mergeFrom((com.fluxninja.aperture.policy.language.v1.Circuit)other);
      } else {
    ...
    public Builder mergeFrom(com.fluxninja.aperture.policy.language.v1.Circuit other) {
      if (other == com.fluxninja.aperture.policy.language.v1.Circuit.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.fluxninja.aperture.policy.language.v1.Circuit parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.fluxninja.aperture.policy.language.v1.Circuit) e.getUnfinishedMessage();
    ...
    private void ensureComponentsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        components_ = new java.util.ArrayList<com.fluxninja.aperture.policy.language.v1.Component>(components_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.fluxninja.aperture.policy.language.v1.Component, com.fluxninja.aperture.policy.language.v1.Component.Builder, com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder> componentsBuilder_;
    ...
    public Builder setComponents(
        int index, com.fluxninja.aperture.policy.language.v1.Component value) {
      if (componentsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setComponents(
        int index, com.fluxninja.aperture.policy.language.v1.Component.Builder builderForValue) {
      if (componentsBuilder_ == null) {
        ensureComponentsIsMutable();
     ...
     * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
     */
    public Builder addComponents(com.fluxninja.aperture.policy.language.v1.Component value) {
      if (componentsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addComponents(
        com.fluxninja.aperture.policy.language.v1.Component.Builder builderForValue) {
      if (componentsBuilder_ == null) {
        ensureComponentsIsMutable();
    ...
    public Builder addAllComponents(
        java.lang.Iterable<? extends com.fluxninja.aperture.policy.language.v1.Component> values) {
      if (componentsBuilder_ == null) {
        ensureComponentsIsMutable();
     ...
     * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
     */
    public com.fluxninja.aperture.policy.language.v1.Component.Builder getComponentsBuilder(
        int index) {
     ...
     * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
     */
    public com.fluxninja.aperture.policy.language.v1.Component.Builder addComponentsBuilder() {
      return getComponentsFieldBuilder().addBuilder(
          com.fluxninja.aperture.policy.language.v1.Component.getDefaultInstance());
    }
    /**
     * <pre>
     * Defines a signal processing graph as a list of components.
    ...
    public com.fluxninja.aperture.policy.language.v1.Component.Builder addComponentsBuilder(
        int index) {
      return getComponentsFieldBuilder().addBuilder(
          index, com.fluxninja.aperture.policy.language.v1.Component.getDefaultInstance());
    }
    /**
     * <pre>
     * Defines a signal processing graph as a list of components.
     ...
     * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
     */
    public java.util.List<com.fluxninja.aperture.policy.language.v1.Component.Builder>
         getComponentsBuilderList() {
      return getComponentsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.fluxninja.aperture.policy.language.v1.Component, com.fluxninja.aperture.policy.language.v1.Component.Builder, com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder>
        getComponentsFieldBuilder() {
      if (componentsBuilder_ == null) {
  ...
  private static final com.fluxninja.aperture.policy.language.v1.Circuit DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.fluxninja.aperture.policy.language.v1.Circuit();
  }

  public static com.fluxninja.aperture.policy.language.v1.Circuit getDefaultInstance() {
