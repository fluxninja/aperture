...
public interface EMAOrBuilder extends
   ...
   * @return The inPorts.
   */
  com.fluxninja.aperture.policy.language.v1.EMA.Ins getInPorts();
  /**
   * <pre>
   * Input ports for the EMA component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.EMA.Ins in_ports = 1[json_name = "inPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.EMA.InsOrBuilder getInPortsOrBuilder();
   ...
   * @return The outPorts.
   */
  com.fluxninja.aperture.policy.language.v1.EMA.Outs getOutPorts();
  /**
   * <pre>
   * Output ports for the EMA component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.EMA.Outs out_ports = 2[json_name = "outPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.EMA.OutsOrBuilder getOutPortsOrBuilder();
