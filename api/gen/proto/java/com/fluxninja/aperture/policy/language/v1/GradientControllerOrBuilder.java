...
public interface GradientControllerOrBuilder extends
   ...
   * @return The inPorts.
   */
  com.fluxninja.aperture.policy.language.v1.GradientController.Ins getInPorts();
  /**
   * <pre>
   * Input ports of the Gradient Controller.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.GradientController.Ins in_ports = 1[json_name = "inPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.GradientController.InsOrBuilder getInPortsOrBuilder();
   ...
   * @return The outPorts.
   */
  com.fluxninja.aperture.policy.language.v1.GradientController.Outs getOutPorts();
  /**
   * <pre>
   * Output ports of the Gradient Controller.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.GradientController.Outs out_ports = 2[json_name = "outPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.GradientController.OutsOrBuilder getOutPortsOrBuilder();
