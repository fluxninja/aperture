...
public interface SchedulerOrBuilder extends
   ...
   * @return The outPorts.
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.Outs getOutPorts();
  /**
   * <pre>
   * Output ports for the Scheduler component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Scheduler.Outs out_ports = 1[json_name = "outPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.OutsOrBuilder getOutPortsOrBuilder();
   ...
   */
  java.util.List<com.fluxninja.aperture.policy.language.v1.Scheduler.Workload>
      getWorkloadsList();
  /**
   * <pre>
   * List of workloads to be used in scheduler.
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.Workload getWorkloads(int index);
  /**
   * <pre>
   * List of workloads to be used in scheduler.
   * Categorizing [flows](/concepts/flow-control/flow-control.md#flow) into workloads
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  java.util.List<? extends com.fluxninja.aperture.policy.language.v1.Scheduler.WorkloadOrBuilder>
   ...
   * <code>repeated .aperture.policy.language.v1.Scheduler.Workload workloads = 3[json_name = "workloads"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.WorkloadOrBuilder getWorkloadsOrBuilder(
      int index);
   ...
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.WorkloadParameters getDefaultWorkloadParameters();
  /**
   * <pre>
   * WorkloadParameters to be used if none of workloads specified in `workloads` match.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Scheduler.WorkloadParameters default_workload_parameters = 4[json_name = "defaultWorkloadParameters"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Scheduler.WorkloadParametersOrBuilder getDefaultWorkloadParametersOrBuilder();
