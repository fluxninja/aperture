...
public interface ResourcesOrBuilder extends
  ...
  java.util.Map<java.lang.String, com.fluxninja.aperture.policy.language.v1.FluxMeter>
  getFluxMeters();
  /**
   * <pre>
   * FluxMeters are installed in the data-plane and form the observability leg of the feedback loop.
  ...
  com.fluxninja.aperture.policy.language.v1.FluxMeter getFluxMetersOrDefault(
      java.lang.String key,
  ...
  com.fluxninja.aperture.policy.language.v1.FluxMeter getFluxMetersOrThrow(
      java.lang.String key);
   ...
   */
  java.util.List<com.fluxninja.aperture.policy.language.v1.Classifier>
      getClassifiersList();
  /**
   * <pre>
   * Classifiers are installed in the data-plane and are used to label the requests based on payload content.
   ...
   * <code>repeated .aperture.policy.language.v1.Classifier classifiers = 2[json_name = "classifiers"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Classifier getClassifiers(int index);
  /**
   * <pre>
   * Classifiers are installed in the data-plane and are used to label the requests based on payload content.
   * The flow labels created by Classifiers can be matched by FluxMeters to create metrics for control purposes.
   ...
   * <code>repeated .aperture.policy.language.v1.Classifier classifiers = 2[json_name = "classifiers"];</code>
   */
  java.util.List<? extends com.fluxninja.aperture.policy.language.v1.ClassifierOrBuilder>
   ...
   * <code>repeated .aperture.policy.language.v1.Classifier classifiers = 2[json_name = "classifiers"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ClassifierOrBuilder getClassifiersOrBuilder(
      int index);
}
