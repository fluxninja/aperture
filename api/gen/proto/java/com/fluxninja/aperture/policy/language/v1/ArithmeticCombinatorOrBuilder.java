...
public interface ArithmeticCombinatorOrBuilder extends
   ...
   * @return The inPorts.
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinator.Ins getInPorts();
  /**
   * <pre>
   * Input ports for the Arithmetic Combinator component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.ArithmeticCombinator.Ins in_ports = 1[json_name = "inPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinator.InsOrBuilder getInPortsOrBuilder();
   ...
   * @return The outPorts.
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinator.Outs getOutPorts();
  /**
   * <pre>
   * Output ports for the Arithmetic Combinator component.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.ArithmeticCombinator.Outs out_ports = 2[json_name = "outPorts"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinator.OutsOrBuilder getOutPortsOrBuilder();
