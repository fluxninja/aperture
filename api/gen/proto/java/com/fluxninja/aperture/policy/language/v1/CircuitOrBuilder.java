...
public interface CircuitOrBuilder extends
   ...
   */
  java.util.List<com.fluxninja.aperture.policy.language.v1.Component>
      getComponentsList();
  /**
   * <pre>
   * Defines a signal processing graph as a list of components.
   ...
   * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.Component getComponents(int index);
  /**
   * <pre>
   * Defines a signal processing graph as a list of components.
   * </pre>
   ...
   * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
   */
  java.util.List<? extends com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder>
   ...
   * <code>repeated .aperture.policy.language.v1.Component components = 2[json_name = "components"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ComponentOrBuilder getComponentsOrBuilder(
      int index);
}
