...
public interface ComponentOrBuilder extends
   ...
   */
  com.fluxninja.aperture.policy.language.v1.GradientController getGradientController();
  /**
   * <pre>
   * Gradient controller basically calculates the ratio between the signal and the setpoint to determine the magnitude of the correction that need to be applied.
   * This controller can be used to build AIMD (Additive Increase, Multiplicative Decrease) or MIMD style response.
   ...
   * <code>.aperture.policy.language.v1.GradientController gradient_controller = 1[json_name = "gradientController"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.GradientControllerOrBuilder getGradientControllerOrBuilder();
   ...
   * @return The ema.
   */
  com.fluxninja.aperture.policy.language.v1.EMA getEma();
  /**
   * <pre>
   * Exponential Moving Average filter.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.EMA ema = 2[json_name = "ema"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.EMAOrBuilder getEmaOrBuilder();
   ...
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinator getArithmeticCombinator();
  /**
   * <pre>
   * Applies the given operator on input operands (signals) and emits the result.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.ArithmeticCombinator arithmetic_combinator = 3[json_name = "arithmeticCombinator"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ArithmeticCombinatorOrBuilder getArithmeticCombinatorOrBuilder();
   ...
   * @return The decider.
   */
  com.fluxninja.aperture.policy.language.v1.Decider getDecider();
  /**
   * <pre>
   * Decider emits the binary result of comparison operator on two operands.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Decider decider = 4[json_name = "decider"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.DeciderOrBuilder getDeciderOrBuilder();
   ...
   * @return The switcher.
   */
  com.fluxninja.aperture.policy.language.v1.Switcher getSwitcher();
  /**
   * <pre>
   * Switcher acts as a switch that emits one of the two signals based on third signal.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Switcher switcher = 5[json_name = "switcher"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.SwitcherOrBuilder getSwitcherOrBuilder();
   ...
   */
  com.fluxninja.aperture.policy.language.v1.ConcurrencyLimiter getConcurrencyLimiter();
  /**
   * <pre>
   * Concurrency Limiter provides service protection by applying prioritized load shedding of flows using a network scheduler (e.g. Weighted Fair Queuing).
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.ConcurrencyLimiter concurrency_limiter = 6[json_name = "concurrencyLimiter"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ConcurrencyLimiterOrBuilder getConcurrencyLimiterOrBuilder();
   ...
   * @return The promql.
   */
  com.fluxninja.aperture.policy.language.v1.PromQL getPromql();
  /**
   * <pre>
   * Periodically runs a Prometheus query in the background and emits the result.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.PromQL promql = 8[json_name = "promql"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.PromQLOrBuilder getPromqlOrBuilder();
   ...
   * @return The constant.
   */
  com.fluxninja.aperture.policy.language.v1.Constant getConstant();
  /**
   * <pre>
   * Emits a constant signal.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Constant constant = 9[json_name = "constant"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ConstantOrBuilder getConstantOrBuilder();
   ...
   * @return The sqrt.
   */
  com.fluxninja.aperture.policy.language.v1.Sqrt getSqrt();
  /**
   * <pre>
   * Takes an input signal and emits the square root of the input signal.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Sqrt sqrt = 10[json_name = "sqrt"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.SqrtOrBuilder getSqrtOrBuilder();
   ...
   */
  com.fluxninja.aperture.policy.language.v1.Extrapolator getExtrapolator();
  /**
   * <pre>
   * Takes an input signal and emits the extrapolated value; either mirroring the input value or repeating the last known value up to the maximum extrapolation interval.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Extrapolator extrapolator = 11[json_name = "extrapolator"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.ExtrapolatorOrBuilder getExtrapolatorOrBuilder();
   ...
   * @return The max.
   */
  com.fluxninja.aperture.policy.language.v1.Max getMax();
  /**
   * <pre>
   * Emits the maximum of the input siganls.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Max max = 12[json_name = "max"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.MaxOrBuilder getMaxOrBuilder();
   ...
   * @return The min.
   */
  com.fluxninja.aperture.policy.language.v1.Min getMin();
  /**
   * <pre>
   * Emits the minimum of the input signals.
   * </pre>
   ...
   * <code>.aperture.policy.language.v1.Min min = 13[json_name = "min"];</code>
   */
  com.fluxninja.aperture.policy.language.v1.MinOrBuilder getMinOrBuilder();

  public com.fluxninja.aperture.policy.language.v1.Component.ComponentCase getComponentCase();
}
