...
public final class FlowControlPointsServiceGrpc {
  ...
  /**
   * Base class for the server implementation of the service FlowControlPointsService.
   * <pre>
   * grpc service
   * </pre>
   */
  public static abstract class FlowControlPointsServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return FlowControlPointsServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service FlowControlPointsService.
   * <pre>
   * grpc service
   * </pre>
   */
  public static final class FlowControlPointsServiceStub
      extends io.grpc.stub.AbstractAsyncStub<FlowControlPointsServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service FlowControlPointsService.
   * <pre>
   * grpc service
   * </pre>
   */
  public static final class FlowControlPointsServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<FlowControlPointsServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service FlowControlPointsService.
   * <pre>
   * grpc service
   * </pre>
   */
  public static final class FlowControlPointsServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<FlowControlPointsServiceFutureStub> {
