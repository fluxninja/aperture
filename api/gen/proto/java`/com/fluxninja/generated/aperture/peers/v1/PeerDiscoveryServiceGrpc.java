...
public final class PeerDiscoveryServiceGrpc {
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getPeers(com.google.protobuf.Empty request,
    ...
    /**
     */
    default void getPeer(com.fluxninja.generated.aperture.peers.v1.PeerRequest request,
  ...
  /**
   * Base class for the server implementation of the service PeerDiscoveryService.
   * <pre>
   * PeerDiscoveryService is used to query Peers.
   * </pre>
   */
  public static abstract class PeerDiscoveryServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return PeerDiscoveryServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service PeerDiscoveryService.
   * <pre>
   * PeerDiscoveryService is used to query Peers.
   * </pre>
   */
  public static final class PeerDiscoveryServiceStub
      extends io.grpc.stub.AbstractAsyncStub<PeerDiscoveryServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service PeerDiscoveryService.
   * <pre>
   * PeerDiscoveryService is used to query Peers.
   * </pre>
   */
  public static final class PeerDiscoveryServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<PeerDiscoveryServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service PeerDiscoveryService.
   * <pre>
   * PeerDiscoveryService is used to query Peers.
   * </pre>
   */
  public static final class PeerDiscoveryServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<PeerDiscoveryServiceFutureStub> {
