...
public final class EntitiesServiceGrpc {
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getEntities(com.google.protobuf.Empty request,
    ...
    /**
     */
    default void getEntityByIPAddress(com.fluxninja.generated.aperture.discovery.entities.v1.GetEntityByIPAddressRequest request,
    ...
    /**
     */
    default void getEntityByName(com.fluxninja.generated.aperture.discovery.entities.v1.GetEntityByNameRequest request,
        io.grpc.stub.StreamObserver<com.fluxninja.generated.aperture.discovery.entities.v1.Entity> responseObserver) {
  ...
  /**
   * Base class for the server implementation of the service EntitiesService.
   * <pre>
   * EntitiesService is used to query Entities.
   * </pre>
   */
  public static abstract class EntitiesServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return EntitiesServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service EntitiesService.
   * <pre>
   * EntitiesService is used to query Entities.
   * </pre>
   */
  public static final class EntitiesServiceStub
      extends io.grpc.stub.AbstractAsyncStub<EntitiesServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service EntitiesService.
   * <pre>
   * EntitiesService is used to query Entities.
   * </pre>
   */
  public static final class EntitiesServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<EntitiesServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service EntitiesService.
   * <pre>
   * EntitiesService is used to query Entities.
   * </pre>
   */
  public static final class EntitiesServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<EntitiesServiceFutureStub> {
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.fluxninja.generated.aperture.discovery.entities.v1.Entity>(
                service, METHODID_GET_ENTITY_BY_IPADDRESS)))
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.fluxninja.generated.aperture.discovery.entities.v1.Entity>(
                service, METHODID_GET_ENTITY_BY_NAME)))
        .build();
  }
