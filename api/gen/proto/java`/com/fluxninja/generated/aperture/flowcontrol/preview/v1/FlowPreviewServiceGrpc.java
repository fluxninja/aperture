...
public final class FlowPreviewServiceGrpc {
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void previewFlowLabels(com.fluxninja.generated.aperture.flowcontrol.preview.v1.PreviewRequest request,
    ...
    /**
     */
    default void previewHTTPRequests(com.fluxninja.generated.aperture.flowcontrol.preview.v1.PreviewRequest request,
  ...
  /**
   * Base class for the server implementation of the service FlowPreviewService.
   */
  public static abstract class FlowPreviewServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return FlowPreviewServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service FlowPreviewService.
   */
  public static final class FlowPreviewServiceStub
      extends io.grpc.stub.AbstractAsyncStub<FlowPreviewServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service FlowPreviewService.
   */
  public static final class FlowPreviewServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<FlowPreviewServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service FlowPreviewService.
   */
  public static final class FlowPreviewServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<FlowPreviewServiceFutureStub> {
