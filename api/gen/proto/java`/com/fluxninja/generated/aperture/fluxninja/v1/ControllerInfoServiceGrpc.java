...
public final class ControllerInfoServiceGrpc {
  ...
  public static final String SERVICE_NAME = "aperture.fluxninja.v1.ControllerInfoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo> getGetControllerInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetControllerInfo",
      requestType = com.google.protobuf.Empty.class,
      responseType = com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo> getGetControllerInfoMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo> getGetControllerInfoMethod;
      ...
      synchronized (ControllerInfoServiceGrpc.class) {
        if ((getGetControllerInfoMethod = ControllerInfoServiceGrpc.getGetControllerInfoMethod) == null) {
          ControllerInfoServiceGrpc.getGetControllerInfoMethod = getGetControllerInfoMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getControllerInfo(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetControllerInfoMethod(), responseObserver);
    }
  }

  /**
   * Base class for the server implementation of the service ControllerInfoService.
   * <pre>
   * ControllerInfoService is used to read controllerID to which agent/controller belong.
   * </pre>
   */
  public static abstract class ControllerInfoServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return ControllerInfoServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service ControllerInfoService.
   * <pre>
   * ControllerInfoService is used to read controllerID to which agent/controller belong.
   * </pre>
   */
  public static final class ControllerInfoServiceStub
      extends io.grpc.stub.AbstractAsyncStub<ControllerInfoServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service ControllerInfoService.
   * <pre>
   * ControllerInfoService is used to read controllerID to which agent/controller belong.
   * </pre>
   */
  public static final class ControllerInfoServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<ControllerInfoServiceBlockingStub> {
    ...
    /**
     */
    public com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo getControllerInfo(com.google.protobuf.Empty request) {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service ControllerInfoService.
   * <pre>
   * ControllerInfoService is used to read controllerID to which agent/controller belong.
   * </pre>
   */
  public static final class ControllerInfoServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<ControllerInfoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo> getControllerInfo(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.fluxninja.generated.aperture.fluxninja.v1.ControllerInfo>(
                service, METHODID_GET_CONTROLLER_INFO)))
        .build();
  }
