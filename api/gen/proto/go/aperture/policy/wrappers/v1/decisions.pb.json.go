...
// MarshalJSON implements json.Marshaler
func (msg *ConcurrencyDemandDecisionWrapper) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{
		UseEnumNumbers:  false,
		EmitUnpopulated: false,
		UseProtoNames:   true,
...
// UnmarshalJSON implements json.Unmarshaler
func (msg *ConcurrencyDemandDecisionWrapper) UnmarshalJSON(b []byte) error {
	return protojson.UnmarshalOptions{
		DiscardUnknown: false,
	}.Unmarshal(b, msg)
}
...
// MarshalJSON implements json.Marshaler
func (msg *ConcurrencyMultiplierDecisionWrapper) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{
		UseEnumNumbers:  false,
		EmitUnpopulated: false,
		UseProtoNames:   true,
...
// UnmarshalJSON implements json.Unmarshaler
func (msg *ConcurrencyMultiplierDecisionWrapper) UnmarshalJSON(b []byte) error {
	return protojson.UnmarshalOptions{
		DiscardUnknown: false,
	}.Unmarshal(b, msg)
}
