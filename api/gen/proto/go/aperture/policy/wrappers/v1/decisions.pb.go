...
func (x *LoadShedDecisionWrapper) GetComponentIndex() int64 {
	if x != nil {
...
func (x *LoadShedDecisionWrapper) GetPolicyName() string {
	if x != nil {
		return x.PolicyName
	}
	return ""
...
func (x *LoadShedDecisionWrapper) GetPolicyHash() string {
	if x != nil {
		return x.PolicyHash
	}
	return ""
...
var file_aperture_policy_wrappers_v1_decisions_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe2, 0x01, 0x0a, 0x17, 0x4c, 0x6f, 0x61,
	0x64, 0x53, 0x68, 0x65, 0x64, 0x44, 0x65, 0x63, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x57, 0x72, 0x61,
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x48, 0x61, 0x73, 0x68, 0x42, 0xa1, 0x02, 0x0a, 0x29, 0x63,
	...
	0x70, 0x70, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x44, 0x65, 0x63, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68,
...
var file_aperture_policy_wrappers_v1_decisions_proto_depIdxs = []int32{
	3, // 0: aperture.policy.wrappers.v1.LoadShedDecisionWrapper.load_shed_decision:type_name -> aperture.policy.decisions.v1.LoadShedDecision
