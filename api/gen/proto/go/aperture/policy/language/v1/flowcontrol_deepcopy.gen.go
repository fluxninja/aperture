...
// DeepCopyInto supports using RateLimiter_CustomLimit within kubernetes types, where deepcopy-gen is used.
func (in *RateLimiter_CustomLimit) DeepCopyInto(out *RateLimiter_CustomLimit) {
	p := proto.Clone(in).(*RateLimiter_CustomLimit)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimiter_CustomLimit. Required by controller-gen.
func (in *RateLimiter_CustomLimit) DeepCopy() *RateLimiter_CustomLimit {
	if in == nil {
		return nil
	}
	out := new(RateLimiter_CustomLimit)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new RateLimiter_CustomLimit. Required by controller-gen.
func (in *RateLimiter_CustomLimit) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
