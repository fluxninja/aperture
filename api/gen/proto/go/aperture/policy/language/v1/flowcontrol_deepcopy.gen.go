...
// DeepCopyInto supports using Sampler within kubernetes types, where deepcopy-gen is used.
func (in *Sampler) DeepCopyInto(out *Sampler) {
	p := proto.Clone(in).(*Sampler)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Sampler. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Sampler. Required by controller-gen.
func (in *Sampler) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using Sampler_Parameters within kubernetes types, where deepcopy-gen is used.
func (in *Sampler_Parameters) DeepCopyInto(out *Sampler_Parameters) {
	p := proto.Clone(in).(*Sampler_Parameters)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Sampler_Parameters. Required by controller-gen.
func (in *Sampler_Parameters) DeepCopy() *Sampler_Parameters {
	if in == nil {
		return nil
	}
	out := new(Sampler_Parameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Sampler_Parameters. Required by controller-gen.
func (in *Sampler_Parameters) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using Sampler_Ins within kubernetes types, where deepcopy-gen is used.
func (in *Sampler_Ins) DeepCopyInto(out *Sampler_Ins) {
	p := proto.Clone(in).(*Sampler_Ins)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Sampler_Ins. Required by controller-gen.
func (in *Sampler_Ins) DeepCopy() *Sampler_Ins {
	if in == nil {
		return nil
	}
	out := new(Sampler_Ins)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Sampler_Ins. Required by controller-gen.
func (in *Sampler_Ins) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
