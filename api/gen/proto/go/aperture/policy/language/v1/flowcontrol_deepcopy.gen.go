...
// DeepCopyInto supports using Rego_LabelQuery within kubernetes types, where deepcopy-gen is used.
func (in *Rego_LabelQuery) DeepCopyInto(out *Rego_LabelQuery) {
	p := proto.Clone(in).(*Rego_LabelQuery)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Rego_LabelQuery. Required by controller-gen.
func (in *Rego_LabelQuery) DeepCopy() *Rego_LabelQuery {
	if in == nil {
		return nil
	}
	out := new(Rego_LabelQuery)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Rego_LabelQuery. Required by controller-gen.
func (in *Rego_LabelQuery) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
