...
// DeepCopyInto supports using Selectors within kubernetes types, where deepcopy-gen is used.
func (in *Selectors) DeepCopyInto(out *Selectors) {
	p := proto.Clone(in).(*Selectors)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Selectors. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Selectors. Required by controller-gen.
func (in *Selectors) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
