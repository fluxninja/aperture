...
func (m *NestedCircuit) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ShortDescription) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ShortDescription)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Name) > 0 {
...
func (m *PolicyMetadata) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PolicyMetadata) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PolicyMetadata) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.BlueprintName) > 0 {
		i -= len(m.BlueprintName)
		copy(dAtA[i:], m.BlueprintName)
		i = encodeVarint(dAtA, i, uint64(len(m.BlueprintName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.BlueprintsUri) > 0 {
		i -= len(m.BlueprintsUri)
		copy(dAtA[i:], m.BlueprintsUri)
		i = encodeVarint(dAtA, i, uint64(len(m.BlueprintsUri)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PolicyMetadata) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.BlueprintsUri)
	if l > 0 {
		n += 1 + l + sov(uint64(l))
	}
	l = len(m.BlueprintName)
	if l > 0 {
		n += 1 + l + sov(uint64(l))
	}
	l = len(m.Values)
...
func (m *UpsertPolicyRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.PolicyMetadata == nil {
				m.PolicyMetadata = &PolicyMetadata{}
			}
...
func (m *PolicyMetadata) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlueprintsUri", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlueprintsUri = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlueprintName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlueprintName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
