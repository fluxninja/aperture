...
// Validate checks the field values on UpsertPolicyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on UpsertPolicyResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpsertPolicyResponseMultiError, or nil if none found.
func (m *UpsertPolicyResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpsertPolicyResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpsertPolicyResponseMultiError(errors)
	}

	return nil
}

// UpsertPolicyResponseMultiError is an error wrapping multiple validation
// errors returned by UpsertPolicyResponse.ValidateAll() if the designated
// constraints aren't met.
type UpsertPolicyResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpsertPolicyResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpsertPolicyResponseMultiError) AllErrors() []error { return m }

// UpsertPolicyResponseValidationError is the validation error returned by
// UpsertPolicyResponse.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e UpsertPolicyResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpsertPolicyResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpsertPolicyResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpsertPolicyResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpsertPolicyResponseValidationError) ErrorName() string {
	return "UpsertPolicyResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpsertPolicyResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpsertPolicyResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpsertPolicyResponseValidationError{}
...
// Validate checks the field values on GetDynamicConfigResponses with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetDynamicConfigResponses) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetDynamicConfigResponses with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetDynamicConfigResponsesMultiError, or nil if none found.
func (m *GetDynamicConfigResponses) ValidateAll() error {
	return m.validate(true)
}

func (m *GetDynamicConfigResponses) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResponses() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetDynamicConfigResponsesValidationError{
			...
			if err := v.Validate(); err != nil {
				return GetDynamicConfigResponsesValidationError{
					field:  fmt.Sprintf("Responses[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetDynamicConfigResponsesMultiError(errors)
	}

	return nil
}

// GetDynamicConfigResponsesMultiError is an error wrapping multiple validation
// errors returned by GetDynamicConfigResponses.ValidateAll() if the
// designated constraints aren't met.
type GetDynamicConfigResponsesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetDynamicConfigResponsesMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetDynamicConfigResponsesMultiError) AllErrors() []error { return m }

// GetDynamicConfigResponsesValidationError is the validation error returned by
// GetDynamicConfigResponses.Validate if the designated constraints aren't met.
type GetDynamicConfigResponsesValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetDynamicConfigResponsesValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetDynamicConfigResponsesValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetDynamicConfigResponsesValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetDynamicConfigResponsesValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetDynamicConfigResponsesValidationError) ErrorName() string {
	return "GetDynamicConfigResponsesValidationError"
}

// Error satisfies the builtin error interface
func (e GetDynamicConfigResponsesValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetDynamicConfigResponses.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetDynamicConfigResponsesValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetDynamicConfigResponsesValidationError{}
...
func (m *Component) validate(all bool) error {
	...
	case *Component_PolynomialRangeFunction:
		if v == nil {
			err := ComponentValidationError{
				field:  "Component",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetPolynomialRangeFunction()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ComponentValidationError{
						field:  "PolynomialRangeFunction",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetPolynomialRangeFunction()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return ComponentValidationError{
					field:  "PolynomialRangeFunction",
					reason: "embedded message failed validation",
