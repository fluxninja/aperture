...
// DeepCopyInto supports using AutoScaler_Parameters within kubernetes types, where deepcopy-gen is used.
func (in *AutoScaler_Parameters) DeepCopyInto(out *AutoScaler_Parameters) {
	p := proto.Clone(in).(*AutoScaler_Parameters)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters. Required by controller-gen.
func (in *AutoScaler_Parameters) DeepCopy() *AutoScaler_Parameters {
	if in == nil {
		return nil
	}
	out := new(AutoScaler_Parameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters. Required by controller-gen.
func (in *AutoScaler_Parameters) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using AutoScaler_Parameters_Scaler within kubernetes types, where deepcopy-gen is used.
func (in *AutoScaler_Parameters_Scaler) DeepCopyInto(out *AutoScaler_Parameters_Scaler) {
	p := proto.Clone(in).(*AutoScaler_Parameters_Scaler)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters_Scaler. Required by controller-gen.
func (in *AutoScaler_Parameters_Scaler) DeepCopy() *AutoScaler_Parameters_Scaler {
	if in == nil {
		return nil
	}
	out := new(AutoScaler_Parameters_Scaler)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters_Scaler. Required by controller-gen.
func (in *AutoScaler_Parameters_Scaler) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using AutoScaler_Parameters_Scaler_KubernetesReplicas within kubernetes types, where deepcopy-gen is used.
func (in *AutoScaler_Parameters_Scaler_KubernetesReplicas) DeepCopyInto(out *AutoScaler_Parameters_Scaler_KubernetesReplicas) {
	p := proto.Clone(in).(*AutoScaler_Parameters_Scaler_KubernetesReplicas)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters_Scaler_KubernetesReplicas. Required by controller-gen.
func (in *AutoScaler_Parameters_Scaler_KubernetesReplicas) DeepCopy() *AutoScaler_Parameters_Scaler_KubernetesReplicas {
	if in == nil {
		return nil
	}
	out := new(AutoScaler_Parameters_Scaler_KubernetesReplicas)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AutoScaler_Parameters_Scaler_KubernetesReplicas. Required by controller-gen.
func (in *AutoScaler_Parameters_Scaler_KubernetesReplicas) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
