...
type PostPoliciesRequest struct {
	...
	Policies []*PostPoliciesRequest_PolicyRequest `protobuf:"bytes,1,rep,name=policies,proto3" json:"policies,omitempty"`
}

func (x *PostPoliciesRequest) Reset() {
	*x = PostPoliciesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PostPoliciesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostPoliciesRequest) ProtoMessage() {}

func (x *PostPoliciesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostPoliciesRequest.ProtoReflect.Descriptor instead.
func (*PostPoliciesRequest) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{2}
}

func (x *PostPoliciesRequest) GetPolicies() []*PostPoliciesRequest_PolicyRequest {
	if x != nil {
		return x.Policies
	}
	return nil
...
type PatchDynamicConfigsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DynamicConfigs []*PatchDynamicConfigsRequest_DynamicConfigRequest `protobuf:"bytes,1,rep,name=dynamic_configs,json=dynamicConfigs,proto3" json:"dynamic_configs,omitempty"`
}

func (x *PatchDynamicConfigsRequest) Reset() {
	*x = PatchDynamicConfigsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PatchDynamicConfigsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PatchDynamicConfigsRequest) ProtoMessage() {}

func (x *PatchDynamicConfigsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PatchDynamicConfigsRequest.ProtoReflect.Descriptor instead.
func (*PatchDynamicConfigsRequest) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{3}
}

func (x *PatchDynamicConfigsRequest) GetDynamicConfigs() []*PatchDynamicConfigsRequest_DynamicConfigRequest {
	if x != nil {
...
func (x *PostPoliciesResponse) Reset() {
	*x = PostPoliciesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PostPoliciesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostPoliciesResponse) ProtoMessage() {}

func (x *PostPoliciesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostPoliciesResponse.ProtoReflect.Descriptor instead.
func (*PostPoliciesResponse) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{5}
}

func (x *PostPoliciesResponse) GetErrors() []string {
	if x != nil {
		return x.Errors
	}
	return nil
...
func (x *PostPoliciesResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type PostPoliciesRequest_PolicyRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PostPoliciesRequest_PolicyRequest) Reset() {
	*x = PostPoliciesRequest_PolicyRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PostPoliciesRequest_PolicyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostPoliciesRequest_PolicyRequest) ProtoMessage() {}

func (x *PostPoliciesRequest_PolicyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostPoliciesRequest_PolicyRequest.ProtoReflect.Descriptor instead.
func (*PostPoliciesRequest_PolicyRequest) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{2, 0}
}

func (x *PostPoliciesRequest_PolicyRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PostPoliciesRequest_PolicyRequest) GetPolicy() *Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
type PatchDynamicConfigsRequest_DynamicConfigRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PatchDynamicConfigsRequest_DynamicConfigRequest) Reset() {
	*x = PatchDynamicConfigsRequest_DynamicConfigRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PatchDynamicConfigsRequest_DynamicConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PatchDynamicConfigsRequest_DynamicConfigRequest) ProtoMessage() {}

func (x *PatchDynamicConfigsRequest_DynamicConfigRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PatchDynamicConfigsRequest_DynamicConfigRequest.ProtoReflect.Descriptor instead.
func (*PatchDynamicConfigsRequest_DynamicConfigRequest) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{3, 0}
}

func (x *PatchDynamicConfigsRequest_DynamicConfigRequest) GetPolicyName() string {
	if x != nil {
		return x.PolicyName
	}
	return ""
...
func (x *PatchDynamicConfigsRequest_DynamicConfigRequest) GetDynamicConfig() *structpb.Struct {
	if x != nil {
...
var file_aperture_policy_language_v1_policy_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x50, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50,
	...
	0x63, 0x79, 0x52, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0xd3, 0x01, 0x0a, 0x13, 0x50,
	0x6f, 0x73, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x5a, 0x0a, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x18, 0x01,
	...
	0x76, 0x31, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x52, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x1a, 0x60,
	0x0a, 0x0d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x12, 0x3b, 0x0a, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x02, 0x20,
	...
	,
	...
	0x3e, 0x0a, 0x0e, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x29, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x48, 0x0a, 0x14, 0x50, 0x6f,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x58, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x69, 0x65, 0x73, 0x52, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x22, 0xbd,
	...
	0x72, 0x79, 0x52, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x1a, 0x60, 0x0a, 0x0d,
	...
	0x69, 0x63, 0x79, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8e,
	0x01, 0x0a, 0x06, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x3e, 0x0a, 0x07, 0x63, 0x69, 0x72,
	0x63, 0x75, 0x69, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x70, 0x65,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74,
	0x52, 0x07, 0x63, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74, 0x12, 0x44, 0x0a, 0x09, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x61,
	...
	0x9d, 0x01, 0x0a, 0x07, 0x43, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74, 0x12, 0x4a, 0x0a, 0x13, 0x65,
	...
	0xec, 0x02, 0x0a, 0x09, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x57, 0x0a,
	...
	0x73, 0x12, 0x54, 0x0a, 0x0c, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	0x6c, 0x18, 0x65, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75,
	...
	0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x52, 0x0b, 0x66, 0x6c, 0x6f, 0x77,
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x1a, 0x65, 0x0a, 0x0f, 0x46, 0x6c, 0x75, 0x78, 0x4d,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xdd, 0x07, 0x0a, 0x0d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	,
	...
	,
	...
	0x22, 0x33, 0x92, 0x41, 0x15, 0x0a, 0x13, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2d,
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15,
	0x2a, 0x13, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x2f, 0x7b,
	0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42, 0xa8, 0x02, 0x0a, 0x33, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c,
...
var file_aperture_policy_language_v1_policy_proto_goTypes = []interface{}{
	(*GetPolicyRequest)(nil),                                // 0: aperture.policy.language.v1.GetPolicyRequest
	(*GetPolicyResponse)(nil),                               // 1: aperture.policy.language.v1.GetPolicyResponse
	(*PostPoliciesRequest)(nil),                             // 2: aperture.policy.language.v1.PostPoliciesRequest
	(*PatchDynamicConfigsRequest)(nil),                      // 3: aperture.policy.language.v1.PatchDynamicConfigsRequest
	(*DeletePolicyRequest)(nil),                             // 4: aperture.policy.language.v1.DeletePolicyRequest
	(*PostPoliciesResponse)(nil),                            // 5: aperture.policy.language.v1.PostPoliciesResponse
	(*GetPoliciesResponse)(nil),                             // 6: aperture.policy.language.v1.GetPoliciesResponse
	(*Policies)(nil),                                        // 7: aperture.policy.language.v1.Policies
	(*Policy)(nil),                                          // 8: aperture.policy.language.v1.Policy
	(*Circuit)(nil),                                         // 9: aperture.policy.language.v1.Circuit
	(*Resources)(nil),                                       // 10: aperture.policy.language.v1.Resources
	(*Component)(nil),                                       // 11: aperture.policy.language.v1.Component
	(*NestedCircuit)(nil),                                   // 12: aperture.policy.language.v1.NestedCircuit
	(*PostPoliciesRequest_PolicyRequest)(nil),               // 13: aperture.policy.language.v1.PostPoliciesRequest.PolicyRequest
	(*PatchDynamicConfigsRequest_DynamicConfigRequest)(nil), // 14: aperture.policy.language.v1.PatchDynamicConfigsRequest.DynamicConfigRequest
	nil,                          // 15: aperture.policy.language.v1.Policies.PoliciesEntry
	nil,                          // 16: aperture.policy.language.v1.Resources.FluxMetersEntry
	nil,                          // 17: aperture.policy.language.v1.NestedCircuit.InPortsMapEntry
	nil,                          // 18: aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry
	(*durationpb.Duration)(nil),  // 19: google.protobuf.Duration
	(*Classifier)(nil),           // 20: aperture.policy.language.v1.Classifier
	(*FlowControlResources)(nil), // 21: aperture.policy.language.v1.FlowControlResources
	(*GradientController)(nil),   // 22: aperture.policy.language.v1.GradientController
	(*EMA)(nil),                  // 23: aperture.policy.language.v1.EMA
	(*ArithmeticCombinator)(nil), // 24: aperture.policy.language.v1.ArithmeticCombinator
	(*Decider)(nil),              // 25: aperture.policy.language.v1.Decider
	(*Switcher)(nil),             // 26: aperture.policy.language.v1.Switcher
	(*Variable)(nil),             // 27: aperture.policy.language.v1.Variable
	(*UnaryOperator)(nil),        // 28: aperture.policy.language.v1.UnaryOperator
	(*Extrapolator)(nil),         // 29: aperture.policy.language.v1.Extrapolator
	(*Max)(nil),                  // 30: aperture.policy.language.v1.Max
	(*Min)(nil),                  // 31: aperture.policy.language.v1.Min
	(*FirstValid)(nil),           // 32: aperture.policy.language.v1.FirstValid
	...
	(*And)(nil),                  // 36: aperture.policy.language.v1.And
	(*Or)(nil),                   // 37: aperture.policy.language.v1.Or
	(*Inverter)(nil),             // 38: aperture.policy.language.v1.Inverter
	(*PulseGenerator)(nil),       // 39: aperture.policy.language.v1.PulseGenerator
	(*Holder)(nil),               // 40: aperture.policy.language.v1.Holder
	(*NestedSignalIngress)(nil),  // 41: aperture.policy.language.v1.NestedSignalIngress
	(*NestedSignalEgress)(nil),   // 42: aperture.policy.language.v1.NestedSignalEgress
	(*SignalGenerator)(nil),      // 43: aperture.policy.language.v1.SignalGenerator
	(*Query)(nil),                // 44: aperture.policy.language.v1.Query
	(*FlowControl)(nil),          // 45: aperture.policy.language.v1.FlowControl
	(*AutoScale)(nil),            // 46: aperture.policy.language.v1.AutoScale
	(*structpb.Struct)(nil),      // 47: google.protobuf.Struct
	(*FluxMeter)(nil),            // 48: aperture.policy.language.v1.FluxMeter
...
var file_aperture_policy_language_v1_policy_proto_depIdxs = []int32{
	8,  // 0: aperture.policy.language.v1.GetPolicyResponse.policy:type_name -> aperture.policy.language.v1.Policy
	13, // 1: aperture.policy.language.v1.PostPoliciesRequest.policies:type_name -> aperture.policy.language.v1.PostPoliciesRequest.PolicyRequest
	14, // 2: aperture.policy.language.v1.PatchDynamicConfigsRequest.dynamic_configs:type_name -> aperture.policy.language.v1.PatchDynamicConfigsRequest.DynamicConfigRequest
	7,  // 3: aperture.policy.language.v1.GetPoliciesResponse.policies:type_name -> aperture.policy.language.v1.Policies
	15, // 4: aperture.policy.language.v1.Policies.policies:type_name -> aperture.policy.language.v1.Policies.PoliciesEntry
	9,  // 5: aperture.policy.language.v1.Policy.circuit:type_name -> aperture.policy.language.v1.Circuit
	10, // 6: aperture.policy.language.v1.Policy.resources:type_name -> aperture.policy.language.v1.Resources
	19, // 7: aperture.policy.language.v1.Circuit.evaluation_interval:type_name -> google.protobuf.Duration
	11, // 8: aperture.policy.language.v1.Circuit.components:type_name -> aperture.policy.language.v1.Component
	16, // 9: aperture.policy.language.v1.Resources.flux_meters:type_name -> aperture.policy.language.v1.Resources.FluxMetersEntry
	20, // 10: aperture.policy.language.v1.Resources.classifiers:type_name -> aperture.policy.language.v1.Classifier
	21, // 11: aperture.policy.language.v1.Resources.flow_control:type_name -> aperture.policy.language.v1.FlowControlResources
	22, // 12: aperture.policy.language.v1.Component.gradient_controller:type_name -> aperture.policy.language.v1.GradientController
	23, // 13: aperture.policy.language.v1.Component.ema:type_name -> aperture.policy.language.v1.EMA
	24, // 14: aperture.policy.language.v1.Component.arithmetic_combinator:type_name -> aperture.policy.language.v1.ArithmeticCombinator
	25, // 15: aperture.policy.language.v1.Component.decider:type_name -> aperture.policy.language.v1.Decider
	26, // 16: aperture.policy.language.v1.Component.switcher:type_name -> aperture.policy.language.v1.Switcher
	27, // 17: aperture.policy.language.v1.Component.variable:type_name -> aperture.policy.language.v1.Variable
	28, // 18: aperture.policy.language.v1.Component.unary_operator:type_name -> aperture.policy.language.v1.UnaryOperator
	29, // 19: aperture.policy.language.v1.Component.extrapolator:type_name -> aperture.policy.language.v1.Extrapolator
	30, // 20: aperture.policy.language.v1.Component.max:type_name -> aperture.policy.language.v1.Max
	31, // 21: aperture.policy.language.v1.Component.min:type_name -> aperture.policy.language.v1.Min
	32, // 22: aperture.policy.language.v1.Component.first_valid:type_name -> aperture.policy.language.v1.FirstValid
	33, // 23: aperture.policy.language.v1.Component.alerter:type_name -> aperture.policy.language.v1.Alerter
	34, // 24: aperture.policy.language.v1.Component.integrator:type_name -> aperture.policy.language.v1.Integrator
	35, // 25: aperture.policy.language.v1.Component.differentiator:type_name -> aperture.policy.language.v1.Differentiator
	36, // 26: aperture.policy.language.v1.Component.and:type_name -> aperture.policy.language.v1.And
	37, // 27: aperture.policy.language.v1.Component.or:type_name -> aperture.policy.language.v1.Or
	38, // 28: aperture.policy.language.v1.Component.inverter:type_name -> aperture.policy.language.v1.Inverter
	39, // 29: aperture.policy.language.v1.Component.pulse_generator:type_name -> aperture.policy.language.v1.PulseGenerator
	40, // 30: aperture.policy.language.v1.Component.holder:type_name -> aperture.policy.language.v1.Holder
	12, // 31: aperture.policy.language.v1.Component.nested_circuit:type_name -> aperture.policy.language.v1.NestedCircuit
	41, // 32: aperture.policy.language.v1.Component.nested_signal_ingress:type_name -> aperture.policy.language.v1.NestedSignalIngress
	42, // 33: aperture.policy.language.v1.Component.nested_signal_egress:type_name -> aperture.policy.language.v1.NestedSignalEgress
	43, // 34: aperture.policy.language.v1.Component.signal_generator:type_name -> aperture.policy.language.v1.SignalGenerator
	44, // 35: aperture.policy.language.v1.Component.query:type_name -> aperture.policy.language.v1.Query
	45, // 36: aperture.policy.language.v1.Component.flow_control:type_name -> aperture.policy.language.v1.FlowControl
	46, // 37: aperture.policy.language.v1.Component.auto_scale:type_name -> aperture.policy.language.v1.AutoScale
	17, // 38: aperture.policy.language.v1.NestedCircuit.in_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.InPortsMapEntry
	18, // 39: aperture.policy.language.v1.NestedCircuit.out_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry
	11, // 40: aperture.policy.language.v1.NestedCircuit.components:type_name -> aperture.policy.language.v1.Component
	8,  // 41: aperture.policy.language.v1.PostPoliciesRequest.PolicyRequest.policy:type_name -> aperture.policy.language.v1.Policy
	47, // 42: aperture.policy.language.v1.PatchDynamicConfigsRequest.DynamicConfigRequest.dynamic_config:type_name -> google.protobuf.Struct
	8,  // 43: aperture.policy.language.v1.Policies.PoliciesEntry.value:type_name -> aperture.policy.language.v1.Policy
	48, // 44: aperture.policy.language.v1.Resources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	49, // 45: aperture.policy.language.v1.NestedCircuit.InPortsMapEntry.value:type_name -> aperture.policy.language.v1.InPort
	50, // 46: aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry.value:type_name -> aperture.policy.language.v1.OutPort
	0,  // 47: aperture.policy.language.v1.PolicyService.GetPolicy:input_type -> aperture.policy.language.v1.GetPolicyRequest
	51, // 48: aperture.policy.language.v1.PolicyService.GetPolicies:input_type -> google.protobuf.Empty
	2,  // 49: aperture.policy.language.v1.PolicyService.PostPolicies:input_type -> aperture.policy.language.v1.PostPoliciesRequest
	2,  // 50: aperture.policy.language.v1.PolicyService.PatchPolicies:input_type -> aperture.policy.language.v1.PostPoliciesRequest
	3,  // 51: aperture.policy.language.v1.PolicyService.PatchDynamicConfigs:input_type -> aperture.policy.language.v1.PatchDynamicConfigsRequest
	4,  // 52: aperture.policy.language.v1.PolicyService.DeletePolicy:input_type -> aperture.policy.language.v1.DeletePolicyRequest
	1,  // 53: aperture.policy.language.v1.PolicyService.GetPolicy:output_type -> aperture.policy.language.v1.GetPolicyResponse
	6,  // 54: aperture.policy.language.v1.PolicyService.GetPolicies:output_type -> aperture.policy.language.v1.GetPoliciesResponse
	5,  // 55: aperture.policy.language.v1.PolicyService.PostPolicies:output_type -> aperture.policy.language.v1.PostPoliciesResponse
	5,  // 56: aperture.policy.language.v1.PolicyService.PatchPolicies:output_type -> aperture.policy.language.v1.PostPoliciesResponse
	5,  // 57: aperture.policy.language.v1.PolicyService.PatchDynamicConfigs:output_type -> aperture.policy.language.v1.PostPoliciesResponse
	51, // 58: aperture.policy.language.v1.PolicyService.DeletePolicy:output_type -> google.protobuf.Empty
...
func file_aperture_policy_language_v1_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PostPoliciesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PatchDynamicConfigsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PostPoliciesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PostPoliciesRequest_PolicyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PatchDynamicConfigsRequest_DynamicConfigRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
