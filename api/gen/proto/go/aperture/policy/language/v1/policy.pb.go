...
func (x *Component) GetIntegration() *Integration {
	if x, ok := x.GetComponent().(*Component_Integration); ok {
...
type Component_Integration struct {
	// Integration are components that are used to integrate with external systems.
	Integration *Integration `protobuf:"bytes,100,opt,name=integration,proto3,oneof"`
}
...
func (*Component_Integration) isComponent_Component() {}
...
type Integration struct {
	...
	// Types that are assignable to Component:
	//	*Integration_Promql
	//	*Integration_RateLimiter
	//	*Integration_ConcurrencyLimiter
	//	*Integration_AimdConcurrencyController
	//	*Integration_HorizontalPodScaler
	Component isIntegration_Component `protobuf_oneof:"component"`
}
...
func (m *Integration) GetComponent() isIntegration_Component {
	if m != nil {
		return m.Component
	}
	return nil
...
func (x *Integration) GetPromql() *PromQL {
	if x, ok := x.GetComponent().(*Integration_Promql); ok {
		return x.Promql
	}
	return nil
}

func (x *Integration) GetRateLimiter() *RateLimiter {
	if x, ok := x.GetComponent().(*Integration_RateLimiter); ok {
		return x.RateLimiter
	}
	return nil
}

func (x *Integration) GetConcurrencyLimiter() *ConcurrencyLimiter {
	if x, ok := x.GetComponent().(*Integration_ConcurrencyLimiter); ok {
		return x.ConcurrencyLimiter
	}
	return nil
}

func (x *Integration) GetAimdConcurrencyController() *AIMDConcurrencyController {
	if x, ok := x.GetComponent().(*Integration_AimdConcurrencyController); ok {
		return x.AimdConcurrencyController
	}
	return nil
}

func (x *Integration) GetHorizontalPodScaler() *HorizontalPodScaler {
	if x, ok := x.GetComponent().(*Integration_HorizontalPodScaler); ok {
		return x.HorizontalPodScaler
	}
	return nil
}

type isIntegration_Component interface {
	isIntegration_Component()
}

type Integration_Promql struct {
...
type Integration_RateLimiter struct {
	// Rate Limiter provides service protection by applying rate limiter.
	RateLimiter *RateLimiter `protobuf:"bytes,2,opt,name=rate_limiter,json=rateLimiter,proto3,oneof"`
}

type Integration_ConcurrencyLimiter struct {
	...
	ConcurrencyLimiter *ConcurrencyLimiter `protobuf:"bytes,3,opt,name=concurrency_limiter,json=concurrencyLimiter,proto3,oneof"`
}

type Integration_AimdConcurrencyController struct {
	...
	AimdConcurrencyController *AIMDConcurrencyController `protobuf:"bytes,4,opt,name=aimd_concurrency_controller,json=aimdConcurrencyController,proto3,oneof"`
}

type Integration_HorizontalPodScaler struct {
	// HorizontalPodScaler provides pod horizontal scaling functionality for scalable Kubernetes resources.
	HorizontalPodScaler *HorizontalPodScaler `protobuf:"bytes,5,opt,name=horizontal_pod_scaler,json=horizontalPodScaler,proto3,oneof"`
}

func (*Integration_Promql) isIntegration_Component() {}

func (*Integration_RateLimiter) isIntegration_Component() {}

func (*Integration_ConcurrencyLimiter) isIntegration_Component() {}

func (*Integration_AimdConcurrencyController) isIntegration_Component() {}

func (*Integration_HorizontalPodScaler) isIntegration_Component() {}
...
type GradientController struct {
	...
	// Gradient Parameters.
	GradientParameters *GradientParameters `protobuf:"bytes,3,opt,name=gradient_parameters,json=gradientParameters,proto3" json:"gradient_parameters,omitempty" validate:"required"` // @gotags: validate:"required"
	...
	DefaultConfig *ControllerDynamicConfig `protobuf:"bytes,5,opt,name=default_config,json=defaultConfig,proto3" json:"default_config,omitempty"`
}
...
func (x *GradientController) GetGradientParameters() *GradientParameters {
	if x != nil {
...
func (x *GradientParameters) Reset() {
	*x = GradientParameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *GradientParameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GradientParameters) ProtoMessage() {}

func (x *GradientParameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GradientParameters.ProtoReflect.Descriptor instead.
func (*GradientParameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{10}
}

func (x *GradientParameters) GetSlope() float64 {
	if x != nil {
		return x.Slope
	}
	return 0
...
func (x *GradientParameters) GetMinGradient() float64 {
	if x != nil {
...
func (x *GradientParameters) GetMaxGradient() float64 {
	if x != nil {
...
type EMA struct {
	...
	WarmupWindow *durationpb.Duration `protobuf:"bytes,4,opt,name=warmup_window,json=warmupWindow,proto3" json:"warmup_window,omitempty" default:"0s"` // @gotags: default:"0s"
...
type Scheduler struct {
	...
	SchedulerParameters *SchedulerParameters `protobuf:"bytes,2,opt,name=scheduler_parameters,json=schedulerParameters,proto3" json:"scheduler_parameters,omitempty" validate:"required"` // @gotags: validate:"required"
}
...
func (x *Scheduler) GetSchedulerParameters() *SchedulerParameters {
	if x != nil {
...
type SchedulerParameters struct {
	...
	// :::
	Workloads []*SchedulerParameters_Workload `protobuf:"bytes,1,rep,name=workloads,proto3" json:"workloads,omitempty" validate:"dive"` // @gotags: validate:"dive"
	// WorkloadParameters to be used if none of workloads specified in `workloads` match.
	DefaultWorkloadParameters *SchedulerParameters_WorkloadParameters `protobuf:"bytes,2,opt,name=default_workload_parameters,json=defaultWorkloadParameters,proto3" json:"default_workload_parameters,omitempty" validate:"required"` // @gotags: validate:"required"
...
func (x *SchedulerParameters) Reset() {
	*x = SchedulerParameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *SchedulerParameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulerParameters) ProtoMessage() {}

func (x *SchedulerParameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulerParameters.ProtoReflect.Descriptor instead.
func (*SchedulerParameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{19}
}

func (x *SchedulerParameters) GetWorkloads() []*SchedulerParameters_Workload {
	if x != nil {
		return x.Workloads
	}
	return nil
...
func (x *SchedulerParameters) GetDefaultWorkloadParameters() *SchedulerParameters_WorkloadParameters {
	if x != nil {
...
func (x *SchedulerParameters) GetAutoTokens() bool {
	if x != nil {
		return x.AutoTokens
	}
	return false
...
func (x *SchedulerParameters) GetTimeoutFactor() float64 {
	if x != nil {
...
func (x *SchedulerParameters) GetMaxTimeout() *durationpb.Duration {
	if x != nil {
		return x.MaxTimeout
	}
	return nil
...
type AIMDConcurrencyController struct {
	...
	// Scheduler parameters.
	SchedulerParameters *SchedulerParameters `protobuf:"bytes,4,opt,name=scheduler_parameters,json=schedulerParameters,proto3" json:"scheduler_parameters,omitempty" validate:"required"` // @gotags: validate:"required"
	// Gradient parameters for the controller. Defaults to:
	// * slope = -1
	// * min_gradient = 0.1
	// * max_gradient = 1
	GradientParameters *GradientParameters `protobuf:"bytes,5,opt,name=gradient_parameters,json=gradientParameters,proto3" json:"gradient_parameters,omitempty"`
	...
	// Configuration for embedded alerter.
	AlerterConfig *AlerterConfig `protobuf:"bytes,9,opt,name=alerter_config,json=alerterConfig,proto3" json:"alerter_config,omitempty"`
...
func (x *AIMDConcurrencyController) GetSchedulerParameters() *SchedulerParameters {
	if x != nil {
		return x.SchedulerParameters
	}
	return nil
...
func (x *AIMDConcurrencyController) GetGradientParameters() *GradientParameters {
	if x != nil {
		return x.GradientParameters
	}
	return nil
...
func (x *AIMDConcurrencyController) GetAlerterConfig() *AlerterConfig {
	if x != nil {
		return x.AlerterConfig
	}
	return nil
...
type SchedulerParameters_WorkloadParameters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SchedulerParameters_WorkloadParameters) Reset() {
	*x = SchedulerParameters_WorkloadParameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *SchedulerParameters_WorkloadParameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulerParameters_WorkloadParameters) ProtoMessage() {}

func (x *SchedulerParameters_WorkloadParameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[60]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulerParameters_WorkloadParameters.ProtoReflect.Descriptor instead.
func (*SchedulerParameters_WorkloadParameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{19, 0}
}

func (x *SchedulerParameters_WorkloadParameters) GetPriority() uint32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *SchedulerParameters_WorkloadParameters) GetTokens() uint64 {
	if x != nil {
		return x.Tokens
	}
	return 0
...
func (x *SchedulerParameters_WorkloadParameters) GetFairnessKey() string {
	if x != nil {
...
type SchedulerParameters_Workload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// WorkloadParameters associated with flows matching the label matcher.
	WorkloadParameters *SchedulerParameters_WorkloadParameters `protobuf:"bytes,1,opt,name=workload_parameters,json=workloadParameters,proto3" json:"workload_parameters,omitempty" validate:"required"` // @gotags: validate:"required"
...
func (x *SchedulerParameters_Workload) Reset() {
	*x = SchedulerParameters_Workload{}
	if protoimpl.UnsafeEnabled {
...
func (x *SchedulerParameters_Workload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulerParameters_Workload) ProtoMessage() {}

func (x *SchedulerParameters_Workload) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_policy_proto_msgTypes[61]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulerParameters_Workload.ProtoReflect.Descriptor instead.
func (*SchedulerParameters_Workload) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{19, 1}
}

func (x *SchedulerParameters_Workload) GetWorkloadParameters() *SchedulerParameters_WorkloadParameters {
	if x != nil {
...
func (x *SchedulerParameters_Workload) GetLabelMatcher() *LabelMatcher {
	if x != nil {
...
func (*Differentiator_Outs) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{35, 1}
}
...
func (*HorizontalPodScaler_ScaleReporter_Outs) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{36, 0, 0}
}
...
func (*HorizontalPodScaler_ScaleActuator_DynamicConfig) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{36, 1, 0}
}
...
func (*HorizontalPodScaler_ScaleActuator_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{36, 1, 1}
}
...
func (*PulseGenerator_Outs) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{37, 0}
}
...
func (*Holder_Outs) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_policy_proto_rawDescGZIP(), []int{38, 1}
}
...
func (x *AIMDConcurrencyController_Outs) GetDesiredConcurrency() *OutPort {
	if x != nil {
...
var file_aperture_policy_language_v1_policy_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc3, 0x0d, 0x0a,
	...
	,
	...
	0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
	0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	...
	0x6c, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x61, 0x70, 0x65, 0x72,
	0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x4f, 0x75, 0x74, 0x73, 0x52, 0x08,
	0x6f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x83, 0x01, 0x0a, 0x13, 0x67, 0x72, 0x61,
	0x64, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x72, 0x61, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72,
	...
	0x1a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52, 0x12, 0x67, 0x72, 0x61, 0x64,
	0x69, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x2c,
	...
	0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5b, 0x0a, 0x0e,
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x44, 0x79, 0x6e,
	0x61, 0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0d, 0x64, 0x65, 0x66, 0x61,
	0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x82, 0x03, 0x0a, 0x03, 0x49, 0x6e,
	...
	,
	...
	0x54, 0x0a, 0x0a, 0x65, 0x6d, 0x61, 0x5f, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x18, 0x03, 0x20,
	...
	0x61, 0x75, 0x6c, 0x74, 0x12, 0x04, 0x1a, 0x02, 0x35, 0x73, 0x52, 0x09, 0x65, 0x6d, 0x61, 0x57,
	0x69, 0x6e, 0x64, 0x6f, 0x77, 0x12, 0x5a, 0x0a, 0x0d, 0x77, 0x61, 0x72, 0x6d, 0x75, 0x70, 0x5f,
	...
	0x02, 0x30, 0x73, 0x52, 0x0c, 0x77, 0x61, 0x72, 0x6d, 0x75, 0x70, 0x57, 0x69, 0x6e, 0x64, 0x6f,
	...
	,
	...
	0x75, 0x74, 0x22, 0xd6, 0x03, 0x0a, 0x14, 0x41, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x65, 0x74, 0x69,
	0x63, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x50, 0x0a, 0x08, 0x69,
	0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e,
	0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	...
	0x2e, 0x49, 0x6e, 0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x53, 0x0a,
	...
	0x74, 0x73, 0x12, 0x5c, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x40, 0x92, 0x41, 0x3d, 0x82, 0x03, 0x3a, 0x0a, 0x0d, 0x78, 0x2d,
	0x67, 0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12, 0x29, 0x1a, 0x27, 0x6f,
	0x6e, 0x65, 0x6f, 0x66, 0x3d, 0x61, 0x64, 0x64, 0x20, 0x73, 0x75, 0x62, 0x20, 0x6d, 0x75, 0x6c,
	0x20, 0x64, 0x69, 0x76, 0x20, 0x78, 0x6f, 0x72, 0x20, 0x6c, 0x73, 0x68, 0x69, 0x66, 0x74, 0x20,
	0x72, 0x73, 0x68, 0x69, 0x66, 0x74, 0x52, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72,
	...
	0x6f, 0x72, 0x74, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xc8, 0x04, 0x0a, 0x07,
	...
	0x6f, 0x72, 0x74, 0x73, 0x12, 0x4f, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x33, 0x92, 0x41, 0x30, 0x82, 0x03, 0x2d, 0x0a, 0x0d,
	0x78, 0x2d, 0x67, 0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x1a,
	0x1a, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x3d, 0x67, 0x74, 0x20, 0x6c, 0x74, 0x20, 0x67, 0x74, 0x65,
	0x20, 0x6c, 0x74, 0x65, 0x20, 0x65, 0x71, 0x20, 0x6e, 0x65, 0x71, 0x52, 0x08, 0x6f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x50, 0x0a, 0x08, 0x74, 0x72, 0x75, 0x65, 0x5f, 0x66, 0x6f,
	...
	0x74, 0x72, 0x75, 0x65, 0x46, 0x6f, 0x72, 0x12, 0x52, 0x0a, 0x09, 0x66, 0x61, 0x6c, 0x73, 0x65,
	0x5f, 0x66, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f,
	...
	0x73, 0x52, 0x08, 0x66, 0x61, 0x6c, 0x73, 0x65, 0x46, 0x6f, 0x72, 0x1a, 0x73, 0x0a, 0x03, 0x49,
	0x6e, 0x73, 0x12, 0x35, 0x0a, 0x03, 0x6c, 0x68, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x50, 0x6f, 0x72, 0x74, 0x52, 0x03, 0x6c, 0x68, 0x73, 0x12, 0x35, 0x0a, 0x03, 0x72, 0x68, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x03, 0x72, 0x68, 0x73,
	...
	0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xa2, 0x03, 0x0a, 0x08, 0x53, 0x77, 0x69, 0x74, 0x63,
	0x68, 0x65, 0x72, 0x12, 0x44, 0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x73,
	...
	,
	...
	0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x75, 0x74, 0x50,
	0x6f, 0x72, 0x74, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xf1, 0x08, 0x0a, 0x0b,
	0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x12, 0x6a, 0x0a, 0x08, 0x69,
	...
	0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x73, 0x42, 0x21, 0x92, 0x41, 0x1e,
	0x82, 0x03, 0x1b, 0x0a, 0x0d, 0x78, 0x2d, 0x67, 0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x12, 0x0a, 0x1a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52, 0x07,
	0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x71, 0x0a, 0x0d, 0x66, 0x6c, 0x6f, 0x77, 0x5f,
	...
	0x6f, 0x77, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x68, 0x0a, 0x14, 0x6c, 0x69,
	...
	,
	...
	0x6e, 0x66, 0x69, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x61, 0x70, 0x65,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	...
	0x67, 0x1a, 0x94, 0x01, 0x0a, 0x08, 0x4c, 0x61, 0x7a, 0x79, 0x53, 0x79, 0x6e, 0x63, 0x12, 0x32,
	...
	,
	...
	,
	...
	0x77, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x67, 0x0a, 0x09, 0x73, 0x63, 0x68,
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x61,
	0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c,
	0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x72, 0x42, 0x21, 0x92, 0x41, 0x1e, 0x82, 0x03, 0x1b, 0x0a, 0x0d, 0x78, 0x2d,
	0x67, 0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x1a, 0x08, 0x72,
	0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52, 0x09, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0x99, 0x03, 0x0a, 0x09, 0x53,
	...
	0x74, 0x73, 0x12, 0x86, 0x01, 0x0a, 0x14, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72,
	...
	0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	0x65, 0x72, 0x73, 0x42, 0x21, 0x92, 0x41, 0x1e, 0x82, 0x03, 0x1b, 0x0a, 0x0d, 0x78, 0x2d, 0x67,
	0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x1a, 0x08, 0x72, 0x65,
	0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52, 0x13, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x1a, 0xb8, 0x01, 0x0a, 0x04,
	...
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x22, 0xe7, 0x07, 0x0a, 0x13, 0x53, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x57,
	...
	,
	...
	,
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x42,
	...
	0x65, 0x64, 0x52, 0x0c, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72,
	0x22, 0xb8, 0x03, 0x0a, 0x0c, 0x4c, 0x6f, 0x61, 0x64, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f,
	...
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x49,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5e, 0x0a, 0x0e, 0x64, 0x65, 0x66,
	...
	,
	...
	,
	...
	0x1a, 0x03, 0x31, 0x30, 0x73, 0x52, 0x12, 0x65, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x1a, 0x44, 0x0a, 0x04, 0x4f, 0x75, 0x74,
	...
	,
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x44, 0x79, 0x6e, 0x61,
	0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0d, 0x64, 0x65, 0x66, 0x61, 0x75,
	0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x65, 0x0a, 0x0d, 0x44, 0x79, 0x6e, 0x61,
	0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x54, 0x0a, 0x0f, 0x63, 0x6f, 0x6e,
	...
	0x0e, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x1a,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xcc, 0x02, 0x0a, 0x04, 0x53, 0x71, 0x72, 0x74, 0x12, 0x40,
	...
	,
	...
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x06, 0x6f, 0x75,
	0x74, 0x70, 0x75, 0x74, 0x22, 0xa3, 0x03, 0x0a, 0x0c, 0x45, 0x78, 0x74, 0x72, 0x61, 0x70, 0x6f,
	0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x48, 0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74,
	...
	0x4b, 0x0a, 0x09, 0x6f, 0x75, 0x74, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x70, 0x6f, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4f, 0x75,
	0x74, 0x73, 0x52, 0x08, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x74, 0x0a, 0x1a,
	...
	0x74, 0x12, 0x05, 0x1a, 0x03, 0x31, 0x30, 0x73, 0x52, 0x18, 0x6d, 0x61, 0x78, 0x45, 0x78, 0x74,
	...
	,
	...
	0x6e, 0x65, 0x6c, 0x73, 0x22, 0x88, 0x02, 0x0a, 0x07, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x6a, 0x65, 0x63, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x42, 0x21, 0x92, 0x41,
	0x1e, 0x82, 0x03, 0x1b, 0x0a, 0x0d, 0x78, 0x2d, 0x67, 0x6f, 0x2d, 0x76, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x12, 0x0a, 0x1a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x52,
	0x18, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x65, 0x0a, 0x0e, 0x73, 0x63, 0x61,
	0x6c, 0x65, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	,
	...
	0x65, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x1a, 0xac, 0x03, 0x0a, 0x0d, 0x53,
	0x63, 0x61, 0x6c, 0x65, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x5d, 0x0a, 0x08,
	0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x42,
	0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	,
	...
	0x1a, 0x02, 0x35, 0x73, 0x52, 0x07, 0x74, 0x72, 0x75, 0x65, 0x46, 0x6f, 0x72, 0x12, 0x52, 0x0a,
	...
	,
	...
	0x12, 0x04, 0x1a, 0x02, 0x35, 0x73, 0x52, 0x07, 0x68, 0x6f, 0x6c, 0x64, 0x46, 0x6f, 0x72, 0x1a,
	0x40, 0x0a, 0x03, 0x49, 0x6e, 0x73, 0x12, 0x39, 0x0a, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75,
	...
	0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x52,
	0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xf4, 0x03, 0x0a, 0x0d, 0x4e, 0x65, 0x73, 0x74,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x1a, 0x62, 0x0a, 0x0f, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x4d,
	...
	0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x06, 0x73,
	0x69, 0x67, 0x6e, 0x61, 0x6c, 0x22, 0xa1, 0x0c, 0x0a, 0x19, 0x41, 0x49, 0x4d, 0x44, 0x43, 0x6f,
	...
	0x6f, 0x72, 0x74, 0x73, 0x12, 0x71, 0x0a, 0x0d, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x6c,
	...
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x86, 0x01, 0x0a, 0x14, 0x73, 0x63, 0x68, 0x65,
	0x64, 0x75, 0x6c, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	...
	,
	...
	0x74, 0x1a, 0xa5, 0x03, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x57, 0x0a, 0x14, 0x61, 0x63,
	...
	,
	...
	,
	...
	0x61, 0x67, 0x65, 0x2f, 0x76, 0x31, 0x3b, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x76,
	0x31, 0xa2, 0x02, 0x03, 0x41, 0x50, 0x4c, 0xaa, 0x02, 0x1b, 0x41, 0x70, 0x65, 0x72, 0x74, 0x75,
	0x72, 0x65, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61,
	0x67, 0x65, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x1b, 0x41, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	...
	0x3a, 0x3a, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06,
...
var file_aperture_policy_language_v1_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 102)
var file_aperture_policy_language_v1_policy_proto_goTypes = []interface{}{
	...
	(*Integration)(nil),               // 6: aperture.policy.language.v1.Integration
	(*InPort)(nil),                    // 7: aperture.policy.language.v1.InPort
	(*OutPort)(nil),                   // 8: aperture.policy.language.v1.OutPort
	(*GradientController)(nil),        // 9: aperture.policy.language.v1.GradientController
	(*GradientParameters)(nil),        // 10: aperture.policy.language.v1.GradientParameters
	(*ControllerDynamicConfig)(nil),   // 11: aperture.policy.language.v1.ControllerDynamicConfig
	...
	(*SchedulerParameters)(nil),       // 19: aperture.policy.language.v1.SchedulerParameters
	(*LoadActuator)(nil),              // 20: aperture.policy.language.v1.LoadActuator
	(*PromQL)(nil),                    // 21: aperture.policy.language.v1.PromQL
	(*ConstantSignal)(nil),            // 22: aperture.policy.language.v1.ConstantSignal
	(*Variable)(nil),                  // 23: aperture.policy.language.v1.Variable
	(*Sqrt)(nil),                      // 24: aperture.policy.language.v1.Sqrt
	(*Extrapolator)(nil),              // 25: aperture.policy.language.v1.Extrapolator
	(*Max)(nil),                       // 26: aperture.policy.language.v1.Max
	(*Min)(nil),                       // 27: aperture.policy.language.v1.Min
	...
	(*FirstValid)(nil),                // 31: aperture.policy.language.v1.FirstValid
	(*AlerterConfig)(nil),             // 32: aperture.policy.language.v1.AlerterConfig
	(*Alerter)(nil),                   // 33: aperture.policy.language.v1.Alerter
	(*Integrator)(nil),                // 34: aperture.policy.language.v1.Integrator
	(*Differentiator)(nil),            // 35: aperture.policy.language.v1.Differentiator
	(*HorizontalPodScaler)(nil),       // 36: aperture.policy.language.v1.HorizontalPodScaler
	(*PulseGenerator)(nil),            // 37: aperture.policy.language.v1.PulseGenerator
	(*Holder)(nil),                    // 38: aperture.policy.language.v1.Holder
	(*NestedCircuit)(nil),             // 39: aperture.policy.language.v1.NestedCircuit
	(*NestedSignalIngress)(nil),       // 40: aperture.policy.language.v1.NestedSignalIngress
	(*NestedSignalEgress)(nil),        // 41: aperture.policy.language.v1.NestedSignalEgress
	(*AIMDConcurrencyController)(nil), // 42: aperture.policy.language.v1.AIMDConcurrencyController
	nil,                               // 43: aperture.policy.language.v1.Policies.PoliciesEntry
	nil,                               // 44: aperture.policy.language.v1.Resources.FluxMetersEntry
	...
	(*ArithmeticCombinator_Ins)(nil),  // 49: aperture.policy.language.v1.ArithmeticCombinator.Ins
	(*ArithmeticCombinator_Outs)(nil), // 50: aperture.policy.language.v1.ArithmeticCombinator.Outs
	(*Decider_Ins)(nil),               // 51: aperture.policy.language.v1.Decider.Ins
	(*Decider_Outs)(nil),              // 52: aperture.policy.language.v1.Decider.Outs
	(*Switcher_Ins)(nil),              // 53: aperture.policy.language.v1.Switcher.Ins
	(*Switcher_Outs)(nil),             // 54: aperture.policy.language.v1.Switcher.Outs
	(*RateLimiter_LazySync)(nil),      // 55: aperture.policy.language.v1.RateLimiter.LazySync
	(*RateLimiter_DynamicConfig)(nil), // 56: aperture.policy.language.v1.RateLimiter.DynamicConfig
	(*RateLimiter_Override)(nil),      // 57: aperture.policy.language.v1.RateLimiter.Override
	(*RateLimiter_Ins)(nil),           // 58: aperture.policy.language.v1.RateLimiter.Ins
	(*Scheduler_Outs)(nil),            // 59: aperture.policy.language.v1.Scheduler.Outs
	(*SchedulerParameters_WorkloadParameters)(nil),          // 60: aperture.policy.language.v1.SchedulerParameters.WorkloadParameters
	(*SchedulerParameters_Workload)(nil),                    // 61: aperture.policy.language.v1.SchedulerParameters.Workload
	(*LoadActuator_DynamicConfig)(nil),                      // 62: aperture.policy.language.v1.LoadActuator.DynamicConfig
	(*LoadActuator_Ins)(nil),                                // 63: aperture.policy.language.v1.LoadActuator.Ins
	(*PromQL_Outs)(nil),                                     // 64: aperture.policy.language.v1.PromQL.Outs
	(*Variable_DynamicConfig)(nil),                          // 65: aperture.policy.language.v1.Variable.DynamicConfig
	(*Variable_Outs)(nil),                                   // 66: aperture.policy.language.v1.Variable.Outs
	(*Sqrt_Ins)(nil),                                        // 67: aperture.policy.language.v1.Sqrt.Ins
	(*Sqrt_Outs)(nil),                                       // 68: aperture.policy.language.v1.Sqrt.Outs
	(*Extrapolator_Ins)(nil),                                // 69: aperture.policy.language.v1.Extrapolator.Ins
	(*Extrapolator_Outs)(nil),                               // 70: aperture.policy.language.v1.Extrapolator.Outs
	(*Max_Ins)(nil),                                         // 71: aperture.policy.language.v1.Max.Ins
	(*Max_Outs)(nil),                                        // 72: aperture.policy.language.v1.Max.Outs
	(*Min_Ins)(nil),                                         // 73: aperture.policy.language.v1.Min.Ins
	(*Min_Outs)(nil),                                        // 74: aperture.policy.language.v1.Min.Outs
	(*And_Ins)(nil),                                         // 75: aperture.policy.language.v1.And.Ins
	(*And_Outs)(nil),                                        // 76: aperture.policy.language.v1.And.Outs
	(*Or_Ins)(nil),                                          // 77: aperture.policy.language.v1.Or.Ins
	(*Or_Outs)(nil),                                         // 78: aperture.policy.language.v1.Or.Outs
	(*Inverter_Ins)(nil),                                    // 79: aperture.policy.language.v1.Inverter.Ins
	(*Inverter_Outs)(nil),                                   // 80: aperture.policy.language.v1.Inverter.Outs
	(*FirstValid_Ins)(nil),                                  // 81: aperture.policy.language.v1.FirstValid.Ins
	(*FirstValid_Outs)(nil),                                 // 82: aperture.policy.language.v1.FirstValid.Outs
	(*Alerter_Ins)(nil),                                     // 83: aperture.policy.language.v1.Alerter.Ins
	(*Integrator_Ins)(nil),                                  // 84: aperture.policy.language.v1.Integrator.Ins
	(*Integrator_Outs)(nil),                                 // 85: aperture.policy.language.v1.Integrator.Outs
	(*Differentiator_Ins)(nil),                              // 86: aperture.policy.language.v1.Differentiator.Ins
	(*Differentiator_Outs)(nil),                             // 87: aperture.policy.language.v1.Differentiator.Outs
	(*HorizontalPodScaler_ScaleReporter)(nil),               // 88: aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter
	(*HorizontalPodScaler_ScaleActuator)(nil),               // 89: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator
	(*HorizontalPodScaler_ScaleReporter_Outs)(nil),          // 90: aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter.Outs
	(*HorizontalPodScaler_ScaleActuator_DynamicConfig)(nil), // 91: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.DynamicConfig
	(*HorizontalPodScaler_ScaleActuator_Ins)(nil),           // 92: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.Ins
	(*PulseGenerator_Outs)(nil),                             // 93: aperture.policy.language.v1.PulseGenerator.Outs
	(*Holder_Ins)(nil),                                      // 94: aperture.policy.language.v1.Holder.Ins
	(*Holder_Outs)(nil),                                     // 95: aperture.policy.language.v1.Holder.Outs
	nil,                                                     // 96: aperture.policy.language.v1.NestedCircuit.InPortsMapEntry
	nil,                                                     // 97: aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry
	(*NestedSignalIngress_Outs)(nil),                        // 98: aperture.policy.language.v1.NestedSignalIngress.Outs
	(*NestedSignalEgress_Ins)(nil),                          // 99: aperture.policy.language.v1.NestedSignalEgress.Ins
	(*AIMDConcurrencyController_Ins)(nil),                   // 100: aperture.policy.language.v1.AIMDConcurrencyController.Ins
	(*AIMDConcurrencyController_Outs)(nil),                  // 101: aperture.policy.language.v1.AIMDConcurrencyController.Outs
	(*durationpb.Duration)(nil),                             // 102: google.protobuf.Duration
	(*Classifier)(nil),                                      // 103: aperture.policy.language.v1.Classifier
	(*FlowSelector)(nil),                                    // 104: aperture.policy.language.v1.FlowSelector
	(*KubernetesObjectSelector)(nil),                        // 105: aperture.policy.language.v1.KubernetesObjectSelector
	(*FluxMeter)(nil),                                       // 106: aperture.policy.language.v1.FluxMeter
	(*LabelMatcher)(nil),                                    // 107: aperture.policy.language.v1.LabelMatcher
...
var file_aperture_policy_language_v1_policy_proto_depIdxs = []int32{
	...
	43,  // 1: aperture.policy.language.v1.Policies.policies:type_name -> aperture.policy.language.v1.Policies.PoliciesEntry
	...
	102, // 4: aperture.policy.language.v1.Circuit.evaluation_interval:type_name -> google.protobuf.Duration
	5,   // 5: aperture.policy.language.v1.Circuit.components:type_name -> aperture.policy.language.v1.Component
	44,  // 6: aperture.policy.language.v1.Resources.flux_meters:type_name -> aperture.policy.language.v1.Resources.FluxMetersEntry
	103, // 7: aperture.policy.language.v1.Resources.classifiers:type_name -> aperture.policy.language.v1.Classifier
	9,   // 8: aperture.policy.language.v1.Component.gradient_controller:type_name -> aperture.policy.language.v1.GradientController
	...
	23,  // 13: aperture.policy.language.v1.Component.variable:type_name -> aperture.policy.language.v1.Variable
	24,  // 14: aperture.policy.language.v1.Component.sqrt:type_name -> aperture.policy.language.v1.Sqrt
	25,  // 15: aperture.policy.language.v1.Component.extrapolator:type_name -> aperture.policy.language.v1.Extrapolator
	26,  // 16: aperture.policy.language.v1.Component.max:type_name -> aperture.policy.language.v1.Max
	27,  // 17: aperture.policy.language.v1.Component.min:type_name -> aperture.policy.language.v1.Min
	31,  // 18: aperture.policy.language.v1.Component.first_valid:type_name -> aperture.policy.language.v1.FirstValid
	33,  // 19: aperture.policy.language.v1.Component.alerter:type_name -> aperture.policy.language.v1.Alerter
	34,  // 20: aperture.policy.language.v1.Component.integrator:type_name -> aperture.policy.language.v1.Integrator
	35,  // 21: aperture.policy.language.v1.Component.differentiator:type_name -> aperture.policy.language.v1.Differentiator
	28,  // 22: aperture.policy.language.v1.Component.and:type_name -> aperture.policy.language.v1.And
	29,  // 23: aperture.policy.language.v1.Component.or:type_name -> aperture.policy.language.v1.Or
	30,  // 24: aperture.policy.language.v1.Component.inverter:type_name -> aperture.policy.language.v1.Inverter
	37,  // 25: aperture.policy.language.v1.Component.pulse_generator:type_name -> aperture.policy.language.v1.PulseGenerator
	38,  // 26: aperture.policy.language.v1.Component.holder:type_name -> aperture.policy.language.v1.Holder
	39,  // 27: aperture.policy.language.v1.Component.nested_circuit:type_name -> aperture.policy.language.v1.NestedCircuit
	40,  // 28: aperture.policy.language.v1.Component.nested_signal_ingress:type_name -> aperture.policy.language.v1.NestedSignalIngress
	41,  // 29: aperture.policy.language.v1.Component.nested_signal_egress:type_name -> aperture.policy.language.v1.NestedSignalEgress
	6,   // 30: aperture.policy.language.v1.Component.integration:type_name -> aperture.policy.language.v1.Integration
	21,  // 31: aperture.policy.language.v1.Integration.promql:type_name -> aperture.policy.language.v1.PromQL
	16,  // 32: aperture.policy.language.v1.Integration.rate_limiter:type_name -> aperture.policy.language.v1.RateLimiter
	17,  // 33: aperture.policy.language.v1.Integration.concurrency_limiter:type_name -> aperture.policy.language.v1.ConcurrencyLimiter
	42,  // 34: aperture.policy.language.v1.Integration.aimd_concurrency_controller:type_name -> aperture.policy.language.v1.AIMDConcurrencyController
	36,  // 35: aperture.policy.language.v1.Integration.horizontal_pod_scaler:type_name -> aperture.policy.language.v1.HorizontalPodScaler
	22,  // 36: aperture.policy.language.v1.InPort.constant_signal:type_name -> aperture.policy.language.v1.ConstantSignal
	45,  // 37: aperture.policy.language.v1.GradientController.in_ports:type_name -> aperture.policy.language.v1.GradientController.Ins
	46,  // 38: aperture.policy.language.v1.GradientController.out_ports:type_name -> aperture.policy.language.v1.GradientController.Outs
	10,  // 39: aperture.policy.language.v1.GradientController.gradient_parameters:type_name -> aperture.policy.language.v1.GradientParameters
	11,  // 40: aperture.policy.language.v1.GradientController.default_config:type_name -> aperture.policy.language.v1.ControllerDynamicConfig
	47,  // 41: aperture.policy.language.v1.EMA.in_ports:type_name -> aperture.policy.language.v1.EMA.Ins
	48,  // 42: aperture.policy.language.v1.EMA.out_ports:type_name -> aperture.policy.language.v1.EMA.Outs
	102, // 43: aperture.policy.language.v1.EMA.ema_window:type_name -> google.protobuf.Duration
	102, // 44: aperture.policy.language.v1.EMA.warmup_window:type_name -> google.protobuf.Duration
	49,  // 45: aperture.policy.language.v1.ArithmeticCombinator.in_ports:type_name -> aperture.policy.language.v1.ArithmeticCombinator.Ins
	50,  // 46: aperture.policy.language.v1.ArithmeticCombinator.out_ports:type_name -> aperture.policy.language.v1.ArithmeticCombinator.Outs
	51,  // 47: aperture.policy.language.v1.Decider.in_ports:type_name -> aperture.policy.language.v1.Decider.Ins
	52,  // 48: aperture.policy.language.v1.Decider.out_ports:type_name -> aperture.policy.language.v1.Decider.Outs
	102, // 49: aperture.policy.language.v1.Decider.true_for:type_name -> google.protobuf.Duration
	102, // 50: aperture.policy.language.v1.Decider.false_for:type_name -> google.protobuf.Duration
	53,  // 51: aperture.policy.language.v1.Switcher.in_ports:type_name -> aperture.policy.language.v1.Switcher.Ins
	54,  // 52: aperture.policy.language.v1.Switcher.out_ports:type_name -> aperture.policy.language.v1.Switcher.Outs
	58,  // 53: aperture.policy.language.v1.RateLimiter.in_ports:type_name -> aperture.policy.language.v1.RateLimiter.Ins
	104, // 54: aperture.policy.language.v1.RateLimiter.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	102, // 55: aperture.policy.language.v1.RateLimiter.limit_reset_interval:type_name -> google.protobuf.Duration
	55,  // 56: aperture.policy.language.v1.RateLimiter.lazy_sync:type_name -> aperture.policy.language.v1.RateLimiter.LazySync
	56,  // 57: aperture.policy.language.v1.RateLimiter.default_config:type_name -> aperture.policy.language.v1.RateLimiter.DynamicConfig
	104, // 58: aperture.policy.language.v1.ConcurrencyLimiter.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	18,  // 59: aperture.policy.language.v1.ConcurrencyLimiter.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	20,  // 60: aperture.policy.language.v1.ConcurrencyLimiter.load_actuator:type_name -> aperture.policy.language.v1.LoadActuator
	59,  // 61: aperture.policy.language.v1.Scheduler.out_ports:type_name -> aperture.policy.language.v1.Scheduler.Outs
	19,  // 62: aperture.policy.language.v1.Scheduler.scheduler_parameters:type_name -> aperture.policy.language.v1.SchedulerParameters
	61,  // 63: aperture.policy.language.v1.SchedulerParameters.workloads:type_name -> aperture.policy.language.v1.SchedulerParameters.Workload
	60,  // 64: aperture.policy.language.v1.SchedulerParameters.default_workload_parameters:type_name -> aperture.policy.language.v1.SchedulerParameters.WorkloadParameters
	102, // 65: aperture.policy.language.v1.SchedulerParameters.max_timeout:type_name -> google.protobuf.Duration
	63,  // 66: aperture.policy.language.v1.LoadActuator.in_ports:type_name -> aperture.policy.language.v1.LoadActuator.Ins
	62,  // 67: aperture.policy.language.v1.LoadActuator.default_config:type_name -> aperture.policy.language.v1.LoadActuator.DynamicConfig
	32,  // 68: aperture.policy.language.v1.LoadActuator.alerter_config:type_name -> aperture.policy.language.v1.AlerterConfig
	64,  // 69: aperture.policy.language.v1.PromQL.out_ports:type_name -> aperture.policy.language.v1.PromQL.Outs
	102, // 70: aperture.policy.language.v1.PromQL.evaluation_interval:type_name -> google.protobuf.Duration
	66,  // 71: aperture.policy.language.v1.Variable.out_ports:type_name -> aperture.policy.language.v1.Variable.Outs
	65,  // 72: aperture.policy.language.v1.Variable.default_config:type_name -> aperture.policy.language.v1.Variable.DynamicConfig
	67,  // 73: aperture.policy.language.v1.Sqrt.in_ports:type_name -> aperture.policy.language.v1.Sqrt.Ins
	68,  // 74: aperture.policy.language.v1.Sqrt.out_ports:type_name -> aperture.policy.language.v1.Sqrt.Outs
	69,  // 75: aperture.policy.language.v1.Extrapolator.in_ports:type_name -> aperture.policy.language.v1.Extrapolator.Ins
	70,  // 76: aperture.policy.language.v1.Extrapolator.out_ports:type_name -> aperture.policy.language.v1.Extrapolator.Outs
	102, // 77: aperture.policy.language.v1.Extrapolator.max_extrapolation_interval:type_name -> google.protobuf.Duration
	71,  // 78: aperture.policy.language.v1.Max.in_ports:type_name -> aperture.policy.language.v1.Max.Ins
	72,  // 79: aperture.policy.language.v1.Max.out_ports:type_name -> aperture.policy.language.v1.Max.Outs
	73,  // 80: aperture.policy.language.v1.Min.in_ports:type_name -> aperture.policy.language.v1.Min.Ins
	74,  // 81: aperture.policy.language.v1.Min.out_ports:type_name -> aperture.policy.language.v1.Min.Outs
	75,  // 82: aperture.policy.language.v1.And.in_ports:type_name -> aperture.policy.language.v1.And.Ins
	76,  // 83: aperture.policy.language.v1.And.out_ports:type_name -> aperture.policy.language.v1.And.Outs
	77,  // 84: aperture.policy.language.v1.Or.in_ports:type_name -> aperture.policy.language.v1.Or.Ins
	78,  // 85: aperture.policy.language.v1.Or.out_ports:type_name -> aperture.policy.language.v1.Or.Outs
	79,  // 86: aperture.policy.language.v1.Inverter.in_ports:type_name -> aperture.policy.language.v1.Inverter.Ins
	80,  // 87: aperture.policy.language.v1.Inverter.out_ports:type_name -> aperture.policy.language.v1.Inverter.Outs
	81,  // 88: aperture.policy.language.v1.FirstValid.in_ports:type_name -> aperture.policy.language.v1.FirstValid.Ins
	82,  // 89: aperture.policy.language.v1.FirstValid.out_ports:type_name -> aperture.policy.language.v1.FirstValid.Outs
	102, // 90: aperture.policy.language.v1.AlerterConfig.resolve_timeout:type_name -> google.protobuf.Duration
	83,  // 91: aperture.policy.language.v1.Alerter.in_ports:type_name -> aperture.policy.language.v1.Alerter.Ins
	32,  // 92: aperture.policy.language.v1.Alerter.alerter_config:type_name -> aperture.policy.language.v1.AlerterConfig
	84,  // 93: aperture.policy.language.v1.Integrator.in_ports:type_name -> aperture.policy.language.v1.Integrator.Ins
	85,  // 94: aperture.policy.language.v1.Integrator.out_ports:type_name -> aperture.policy.language.v1.Integrator.Outs
	86,  // 95: aperture.policy.language.v1.Differentiator.in_ports:type_name -> aperture.policy.language.v1.Differentiator.Ins
	87,  // 96: aperture.policy.language.v1.Differentiator.out_ports:type_name -> aperture.policy.language.v1.Differentiator.Outs
	102, // 97: aperture.policy.language.v1.Differentiator.window:type_name -> google.protobuf.Duration
	105, // 98: aperture.policy.language.v1.HorizontalPodScaler.kubernetes_object_selector:type_name -> aperture.policy.language.v1.KubernetesObjectSelector
	88,  // 99: aperture.policy.language.v1.HorizontalPodScaler.scale_reporter:type_name -> aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter
	89,  // 100: aperture.policy.language.v1.HorizontalPodScaler.scale_actuator:type_name -> aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator
	93,  // 101: aperture.policy.language.v1.PulseGenerator.out_ports:type_name -> aperture.policy.language.v1.PulseGenerator.Outs
	102, // 102: aperture.policy.language.v1.PulseGenerator.true_for:type_name -> google.protobuf.Duration
	102, // 103: aperture.policy.language.v1.PulseGenerator.false_for:type_name -> google.protobuf.Duration
	94,  // 104: aperture.policy.language.v1.Holder.in_ports:type_name -> aperture.policy.language.v1.Holder.Ins
	95,  // 105: aperture.policy.language.v1.Holder.out_ports:type_name -> aperture.policy.language.v1.Holder.Outs
	102, // 106: aperture.policy.language.v1.Holder.hold_for:type_name -> google.protobuf.Duration
	96,  // 107: aperture.policy.language.v1.NestedCircuit.in_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.InPortsMapEntry
	97,  // 108: aperture.policy.language.v1.NestedCircuit.out_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry
	5,   // 109: aperture.policy.language.v1.NestedCircuit.components:type_name -> aperture.policy.language.v1.Component
	98,  // 110: aperture.policy.language.v1.NestedSignalIngress.out_ports:type_name -> aperture.policy.language.v1.NestedSignalIngress.Outs
	99,  // 111: aperture.policy.language.v1.NestedSignalEgress.in_ports:type_name -> aperture.policy.language.v1.NestedSignalEgress.Ins
	100, // 112: aperture.policy.language.v1.AIMDConcurrencyController.in_ports:type_name -> aperture.policy.language.v1.AIMDConcurrencyController.Ins
	101, // 113: aperture.policy.language.v1.AIMDConcurrencyController.out_ports:type_name -> aperture.policy.language.v1.AIMDConcurrencyController.Outs
	104, // 114: aperture.policy.language.v1.AIMDConcurrencyController.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	19,  // 115: aperture.policy.language.v1.AIMDConcurrencyController.scheduler_parameters:type_name -> aperture.policy.language.v1.SchedulerParameters
	10,  // 116: aperture.policy.language.v1.AIMDConcurrencyController.gradient_parameters:type_name -> aperture.policy.language.v1.GradientParameters
	32,  // 117: aperture.policy.language.v1.AIMDConcurrencyController.alerter_config:type_name -> aperture.policy.language.v1.AlerterConfig
	2,   // 118: aperture.policy.language.v1.Policies.PoliciesEntry.value:type_name -> aperture.policy.language.v1.Policy
	106, // 119: aperture.policy.language.v1.Resources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	7,   // 120: aperture.policy.language.v1.GradientController.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	7,   // 121: aperture.policy.language.v1.GradientController.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	7,   // 122: aperture.policy.language.v1.GradientController.Ins.optimize:type_name -> aperture.policy.language.v1.InPort
	7,   // 123: aperture.policy.language.v1.GradientController.Ins.max:type_name -> aperture.policy.language.v1.InPort
	7,   // 124: aperture.policy.language.v1.GradientController.Ins.min:type_name -> aperture.policy.language.v1.InPort
	7,   // 125: aperture.policy.language.v1.GradientController.Ins.control_variable:type_name -> aperture.policy.language.v1.InPort
	8,   // 126: aperture.policy.language.v1.GradientController.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 127: aperture.policy.language.v1.EMA.Ins.input:type_name -> aperture.policy.language.v1.InPort
	7,   // 128: aperture.policy.language.v1.EMA.Ins.max_envelope:type_name -> aperture.policy.language.v1.InPort
	7,   // 129: aperture.policy.language.v1.EMA.Ins.min_envelope:type_name -> aperture.policy.language.v1.InPort
	8,   // 130: aperture.policy.language.v1.EMA.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 131: aperture.policy.language.v1.ArithmeticCombinator.Ins.lhs:type_name -> aperture.policy.language.v1.InPort
	7,   // 132: aperture.policy.language.v1.ArithmeticCombinator.Ins.rhs:type_name -> aperture.policy.language.v1.InPort
	8,   // 133: aperture.policy.language.v1.ArithmeticCombinator.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 134: aperture.policy.language.v1.Decider.Ins.lhs:type_name -> aperture.policy.language.v1.InPort
	7,   // 135: aperture.policy.language.v1.Decider.Ins.rhs:type_name -> aperture.policy.language.v1.InPort
	8,   // 136: aperture.policy.language.v1.Decider.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 137: aperture.policy.language.v1.Switcher.Ins.on_true:type_name -> aperture.policy.language.v1.InPort
	7,   // 138: aperture.policy.language.v1.Switcher.Ins.on_false:type_name -> aperture.policy.language.v1.InPort
	7,   // 139: aperture.policy.language.v1.Switcher.Ins.switch:type_name -> aperture.policy.language.v1.InPort
	8,   // 140: aperture.policy.language.v1.Switcher.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	...
	7,   // 142: aperture.policy.language.v1.RateLimiter.Ins.limit:type_name -> aperture.policy.language.v1.InPort
	8,   // 143: aperture.policy.language.v1.Scheduler.Outs.accepted_concurrency:type_name -> aperture.policy.language.v1.OutPort
	8,   // 144: aperture.policy.language.v1.Scheduler.Outs.incoming_concurrency:type_name -> aperture.policy.language.v1.OutPort
	60,  // 145: aperture.policy.language.v1.SchedulerParameters.Workload.workload_parameters:type_name -> aperture.policy.language.v1.SchedulerParameters.WorkloadParameters
	107, // 146: aperture.policy.language.v1.SchedulerParameters.Workload.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	7,   // 147: aperture.policy.language.v1.LoadActuator.Ins.load_multiplier:type_name -> aperture.policy.language.v1.InPort
	8,   // 148: aperture.policy.language.v1.PromQL.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	22,  // 149: aperture.policy.language.v1.Variable.DynamicConfig.constant_signal:type_name -> aperture.policy.language.v1.ConstantSignal
	8,   // 150: aperture.policy.language.v1.Variable.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 151: aperture.policy.language.v1.Sqrt.Ins.input:type_name -> aperture.policy.language.v1.InPort
	8,   // 152: aperture.policy.language.v1.Sqrt.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 153: aperture.policy.language.v1.Extrapolator.Ins.input:type_name -> aperture.policy.language.v1.InPort
	8,   // 154: aperture.policy.language.v1.Extrapolator.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 155: aperture.policy.language.v1.Max.Ins.inputs:type_name -> aperture.policy.language.v1.InPort
	8,   // 156: aperture.policy.language.v1.Max.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 157: aperture.policy.language.v1.Min.Ins.inputs:type_name -> aperture.policy.language.v1.InPort
	8,   // 158: aperture.policy.language.v1.Min.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 159: aperture.policy.language.v1.And.Ins.inputs:type_name -> aperture.policy.language.v1.InPort
	8,   // 160: aperture.policy.language.v1.And.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 161: aperture.policy.language.v1.Or.Ins.inputs:type_name -> aperture.policy.language.v1.InPort
	8,   // 162: aperture.policy.language.v1.Or.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 163: aperture.policy.language.v1.Inverter.Ins.input:type_name -> aperture.policy.language.v1.InPort
	8,   // 164: aperture.policy.language.v1.Inverter.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 165: aperture.policy.language.v1.FirstValid.Ins.inputs:type_name -> aperture.policy.language.v1.InPort
	8,   // 166: aperture.policy.language.v1.FirstValid.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 167: aperture.policy.language.v1.Alerter.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	7,   // 168: aperture.policy.language.v1.Integrator.Ins.input:type_name -> aperture.policy.language.v1.InPort
	7,   // 169: aperture.policy.language.v1.Integrator.Ins.reset:type_name -> aperture.policy.language.v1.InPort
	7,   // 170: aperture.policy.language.v1.Integrator.Ins.min:type_name -> aperture.policy.language.v1.InPort
	7,   // 171: aperture.policy.language.v1.Integrator.Ins.max:type_name -> aperture.policy.language.v1.InPort
	8,   // 172: aperture.policy.language.v1.Integrator.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 173: aperture.policy.language.v1.Differentiator.Ins.input:type_name -> aperture.policy.language.v1.InPort
	8,   // 174: aperture.policy.language.v1.Differentiator.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	90,  // 175: aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter.out_ports:type_name -> aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter.Outs
	92,  // 176: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.in_ports:type_name -> aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.Ins
	91,  // 177: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.default_config:type_name -> aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.DynamicConfig
	8,   // 178: aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter.Outs.actual_replicas:type_name -> aperture.policy.language.v1.OutPort
	8,   // 179: aperture.policy.language.v1.HorizontalPodScaler.ScaleReporter.Outs.configured_replicas:type_name -> aperture.policy.language.v1.OutPort
	7,   // 180: aperture.policy.language.v1.HorizontalPodScaler.ScaleActuator.Ins.desired_replicas:type_name -> aperture.policy.language.v1.InPort
	8,   // 181: aperture.policy.language.v1.PulseGenerator.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 182: aperture.policy.language.v1.Holder.Ins.input:type_name -> aperture.policy.language.v1.InPort
	8,   // 183: aperture.policy.language.v1.Holder.Outs.output:type_name -> aperture.policy.language.v1.OutPort
	7,   // 184: aperture.policy.language.v1.NestedCircuit.InPortsMapEntry.value:type_name -> aperture.policy.language.v1.InPort
	8,   // 185: aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry.value:type_name -> aperture.policy.language.v1.OutPort
	8,   // 186: aperture.policy.language.v1.NestedSignalIngress.Outs.signal:type_name -> aperture.policy.language.v1.OutPort
	7,   // 187: aperture.policy.language.v1.NestedSignalEgress.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	7,   // 188: aperture.policy.language.v1.AIMDConcurrencyController.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	7,   // 189: aperture.policy.language.v1.AIMDConcurrencyController.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	8,   // 190: aperture.policy.language.v1.AIMDConcurrencyController.Outs.accepted_concurrency:type_name -> aperture.policy.language.v1.OutPort
	8,   // 191: aperture.policy.language.v1.AIMDConcurrencyController.Outs.incoming_concurrency:type_name -> aperture.policy.language.v1.OutPort
	8,   // 192: aperture.policy.language.v1.AIMDConcurrencyController.Outs.desired_concurrency:type_name -> aperture.policy.language.v1.OutPort
	8,   // 193: aperture.policy.language.v1.AIMDConcurrencyController.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	8,   // 194: aperture.policy.language.v1.AIMDConcurrencyController.Outs.load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	108, // 195: aperture.policy.language.v1.PolicyService.GetPolicies:input_type -> google.protobuf.Empty
	0,   // 196: aperture.policy.language.v1.PolicyService.GetPolicies:output_type -> aperture.policy.language.v1.GetPoliciesResponse
...
func file_aperture_policy_language_v1_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GradientParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulerParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[60].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulerParameters_WorkloadParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_policy_proto_msgTypes[61].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulerParameters_Workload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_aperture_policy_language_v1_policy_proto_msgTypes[5].OneofWrappers = []interface{}{
		...
		(*Component_Integration)(nil),
	}
	file_aperture_policy_language_v1_policy_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Integration_Promql)(nil),
		(*Integration_RateLimiter)(nil),
		(*Integration_ConcurrencyLimiter)(nil),
		(*Integration_AimdConcurrencyController)(nil),
		(*Integration_HorizontalPodScaler)(nil),
	}
	...
	file_aperture_policy_language_v1_policy_proto_msgTypes[22].OneofWrappers = []interface{}{
