...
var file_aperture_policy_language_v1_policy_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe5, 0x0e, 0x0a,
	...
	0x65, 0x73, 0x73, 0x12, 0x3a, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x64, 0x20, 0x01,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x97, 0x01, 0x0a, 0x0d, 0x50, 0x6f, 0x6c,
...
var file_aperture_policy_language_v1_policy_proto_goTypes = []interface{}{
	...
	(*Query)(nil),                // 35: aperture.policy.language.v1.Query
	(*FlowControl)(nil),          // 36: aperture.policy.language.v1.FlowControl
	(*AutoScale)(nil),            // 37: aperture.policy.language.v1.AutoScale
	(*FluxMeter)(nil),            // 38: aperture.policy.language.v1.FluxMeter
	(*InPort)(nil),               // 39: aperture.policy.language.v1.InPort
	(*OutPort)(nil),              // 40: aperture.policy.language.v1.OutPort
...
var file_aperture_policy_language_v1_policy_proto_depIdxs = []int32{
	...
	35, // 31: aperture.policy.language.v1.Component.query:type_name -> aperture.policy.language.v1.Query
	36, // 32: aperture.policy.language.v1.Component.flow_control:type_name -> aperture.policy.language.v1.FlowControl
	37, // 33: aperture.policy.language.v1.Component.auto_scale:type_name -> aperture.policy.language.v1.AutoScale
	9,  // 34: aperture.policy.language.v1.NestedCircuit.in_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.InPortsMapEntry
	10, // 35: aperture.policy.language.v1.NestedCircuit.out_ports_map:type_name -> aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry
	5,  // 36: aperture.policy.language.v1.NestedCircuit.components:type_name -> aperture.policy.language.v1.Component
	2,  // 37: aperture.policy.language.v1.Policies.PoliciesEntry.value:type_name -> aperture.policy.language.v1.Policy
	38, // 38: aperture.policy.language.v1.Resources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	39, // 39: aperture.policy.language.v1.NestedCircuit.InPortsMapEntry.value:type_name -> aperture.policy.language.v1.InPort
	40, // 40: aperture.policy.language.v1.NestedCircuit.OutPortsMapEntry.value:type_name -> aperture.policy.language.v1.OutPort
	41, // 41: aperture.policy.language.v1.PolicyService.GetPolicies:input_type -> google.protobuf.Empty
	0,  // 42: aperture.policy.language.v1.PolicyService.GetPolicies:output_type -> aperture.policy.language.v1.GetPoliciesResponse
