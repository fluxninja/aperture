...
// DeepCopyInto supports using FluxMeter_Buckets within kubernetes types, where deepcopy-gen is used.
func (in *FluxMeter_Buckets) DeepCopyInto(out *FluxMeter_Buckets) {
	p := proto.Clone(in).(*FluxMeter_Buckets)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FluxMeter_Buckets. Required by controller-gen.
func (in *FluxMeter_Buckets) DeepCopy() *FluxMeter_Buckets {
	if in == nil {
		return nil
	}
	out := new(FluxMeter_Buckets)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new FluxMeter_Buckets. Required by controller-gen.
func (in *FluxMeter_Buckets) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
