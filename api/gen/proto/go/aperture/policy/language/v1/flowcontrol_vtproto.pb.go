...
func (m *FlowControl_AiadLoadScheduler) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AiadLoadScheduler != nil {
		size, err := m.AiadLoadScheduler.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FlowControl_ConcurrencyScheduler) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ConcurrencyScheduler != nil {
		size, err := m.ConcurrencyScheduler.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ConcurrencyLimiter_Parameters) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MaxInflightDuration != nil {
		if vtmsg, ok := interface{}(m.MaxInflightDuration).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.MaxInflightDuration)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *ConcurrencyLimiter_Ins) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MaxConcurrency != nil {
		size, err := m.MaxConcurrency.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Scheduler) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FairnessLabelKey) > 0 {
		i -= len(m.FairnessLabelKey)
		copy(dAtA[i:], m.FairnessLabelKey)
		i = encodeVarint(dAtA, i, uint64(len(m.FairnessLabelKey)))
		i--
		dAtA[i] = 0x5a
	}
...
func (m *RangeDrivenLoadScheduler_Parameters) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HighThrottleThreshold != nil {
		size, err := m.HighThrottleThreshold.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.LowThrottleThreshold != nil {
		size, err := m.LowThrottleThreshold.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *AIADLoadScheduler_Parameters) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LoadMultiplierLinearDecrement != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.LoadMultiplierLinearDecrement))))
		i--
		dAtA[i] = 0x19
	}
	if m.MinLoadMultiplier != 0 {
		i -= 8
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.MinLoadMultiplier))))
		i--
		dAtA[i] = 0x11
	}
	if m.LoadScheduler != nil {
...
func (m *FlowControl_ConcurrencyScheduler) SizeVT() (n int) {
	...
	_ = l
	if m.ConcurrencyScheduler != nil {
		l = m.ConcurrencyScheduler.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	return n
}
...
func (m *ConcurrencyLimiter_Parameters) SizeVT() (n int) {
	...
	if m.MaxInflightDuration != nil {
		if size, ok := interface{}(m.MaxInflightDuration).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.MaxInflightDuration)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.MaxIdleTime != nil {
...
func (m *RangeDrivenLoadScheduler_Parameters) SizeVT() (n int) {
	...
	if m.LowThrottleThreshold != nil {
		l = m.LowThrottleThreshold.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	if m.HighThrottleThreshold != nil {
		l = m.HighThrottleThreshold.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	if m.Degree != 0 {
		n += 9
...
func (m *FlowControl) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiadLoadScheduler", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Component.(*FlowControl_AiadLoadScheduler); ok {
				if err := oneof.AiadLoadScheduler.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &AIADLoadScheduler{}
				...
				m.Component = &FlowControl_AiadLoadScheduler{AiadLoadScheduler: v}
			}
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
			...
			if oneof, ok := m.Component.(*FlowControl_ConcurrencyLimiter); ok {
				if err := oneof.ConcurrencyLimiter.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				...
				m.Component = &FlowControl_ConcurrencyLimiter{ConcurrencyLimiter: v}
			}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConcurrencyScheduler", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Component.(*FlowControl_ConcurrencyScheduler); ok {
				if err := oneof.ConcurrencyScheduler.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &ConcurrencyScheduler{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Component = &FlowControl_ConcurrencyScheduler{ConcurrencyScheduler: v}
			}
			iNdEx = postIndex
		case 1000:
			if wireType != 2 {
...
func (m *ConcurrencyScheduler) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyScheduler: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyScheduler: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.InPorts == nil {
				m.InPorts = &ConcurrencyLimiter_Ins{}
			}
		...
		case 3:
			...
			if m.ConcurrencyLimiter == nil {
				m.ConcurrencyLimiter = &ConcurrencyLimiter_Parameters{}
			}
		...
		case 5:
			...
			if m.OutPorts == nil {
				m.OutPorts = &ConcurrencyLimiter_Outs{}
			}
...
func (m *ConcurrencyLimiter_Parameters) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Parameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Parameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.MaxInflightDuration == nil {
				m.MaxInflightDuration = &durationpb.Duration{}
			}
			if unmarshal, ok := interface{}(m.MaxInflightDuration).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.MaxInflightDuration); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *ConcurrencyLimiter_RequestParameters) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyLimiter_RequestParameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyLimiter_RequestParameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ConcurrencyLimiter_Ins) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Ins: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Ins: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.MaxConcurrency == nil {
				m.MaxConcurrency = &InPort{}
			}
			if err := m.MaxConcurrency.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *ConcurrencyLimiter_Outs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Outs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyLimiter_Outs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ConcurrencyLimiter) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConcurrencyLimiter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConcurrencyLimiter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Parameters == nil {
				m.Parameters = &ConcurrencyLimiter_Parameters{}
			}
		...
		case 4:
			...
			if m.RequestParameters == nil {
				m.RequestParameters = &ConcurrencyLimiter_RequestParameters{}
			}
...
func (m *RateLimiter_Outs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RateLimiter_Outs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RateLimiter_Outs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Scheduler) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FairnessLabelKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FairnessLabelKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *AIMDLoadScheduler_Ins) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Ins: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Ins: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AIMDLoadScheduler_Outs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Outs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Outs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AIMDLoadScheduler_Parameters) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Parameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIMDLoadScheduler_Parameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AIMDLoadScheduler) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIMDLoadScheduler: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIMDLoadScheduler: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.InPorts == nil {
				m.InPorts = &AIMDLoadScheduler_Ins{}
			}
			if err := m.InPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 2:
			...
			if m.OutPorts == nil {
				m.OutPorts = &AIMDLoadScheduler_Outs{}
			}
			if err := m.OutPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 3:
			...
			if m.Parameters == nil {
				m.Parameters = &AIMDLoadScheduler_Parameters{}
			}
			if err := m.Parameters.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *RangeDrivenLoadScheduler_Ins) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Ins: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Ins: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RangeDrivenLoadScheduler_Outs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Outs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Outs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RangeDrivenLoadScheduler_Datapoint) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Datapoint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Datapoint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
...
func (m *RangeDrivenLoadScheduler_Parameters) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Parameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler_Parameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LowThrottleThreshold", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LowThrottleThreshold == nil {
				m.LowThrottleThreshold = &RangeDrivenLoadScheduler_Datapoint{}
			}
			if err := m.LowThrottleThreshold.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighThrottleThreshold", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.HighThrottleThreshold == nil {
				m.HighThrottleThreshold = &RangeDrivenLoadScheduler_Datapoint{}
			}
			if err := m.HighThrottleThreshold.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *RangeDrivenLoadScheduler) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RangeDrivenLoadScheduler: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.InPorts == nil {
				m.InPorts = &RangeDrivenLoadScheduler_Ins{}
			}
			if err := m.InPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 2:
			...
			if m.OutPorts == nil {
				m.OutPorts = &RangeDrivenLoadScheduler_Outs{}
			}
			if err := m.OutPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 3:
			...
			if m.Parameters == nil {
				m.Parameters = &RangeDrivenLoadScheduler_Parameters{}
			}
			if err := m.Parameters.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *AIADLoadScheduler_Ins) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIADLoadScheduler_Ins: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIADLoadScheduler_Ins: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AIADLoadScheduler_Outs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIADLoadScheduler_Outs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIADLoadScheduler_Outs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AIADLoadScheduler_Parameters) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIADLoadScheduler_Parameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIADLoadScheduler_Parameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinLoadMultiplier", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.MinLoadMultiplier = float64(math.Float64frombits(v))
		case 3:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field LoadMultiplierLinearDecrement", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.LoadMultiplierLinearDecrement = float64(math.Float64frombits(v))
		case 4:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxLoadMultiplier", wireType)
			}
...
func (m *AIADLoadScheduler) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIADLoadScheduler: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIADLoadScheduler: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.InPorts == nil {
				m.InPorts = &AIADLoadScheduler_Ins{}
			}
			if err := m.InPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 2:
			...
			if m.OutPorts == nil {
				m.OutPorts = &AIADLoadScheduler_Outs{}
			}
			if err := m.OutPorts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 3:
			...
			if m.Parameters == nil {
				m.Parameters = &AIADLoadScheduler_Parameters{}
			}
			if err := m.Parameters.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
