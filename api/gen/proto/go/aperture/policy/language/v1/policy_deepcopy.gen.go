...
// DeepCopyInto supports using PostPolicyRequest within kubernetes types, where deepcopy-gen is used.
func (in *PostPolicyRequest) DeepCopyInto(out *PostPolicyRequest) {
	p := proto.Clone(in).(*PostPolicyRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostPolicyRequest. Required by controller-gen.
func (in *PostPolicyRequest) DeepCopy() *PostPolicyRequest {
	if in == nil {
		return nil
	}
	out := new(PostPolicyRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PostPolicyRequest. Required by controller-gen.
func (in *PostPolicyRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PostPolicyRequest_PolicyRequest within kubernetes types, where deepcopy-gen is used.
func (in *PostPolicyRequest_PolicyRequest) DeepCopyInto(out *PostPolicyRequest_PolicyRequest) {
	p := proto.Clone(in).(*PostPolicyRequest_PolicyRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostPolicyRequest_PolicyRequest. Required by controller-gen.
func (in *PostPolicyRequest_PolicyRequest) DeepCopy() *PostPolicyRequest_PolicyRequest {
	if in == nil {
		return nil
	}
	out := new(PostPolicyRequest_PolicyRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PostPolicyRequest_PolicyRequest. Required by controller-gen.
func (in *PostPolicyRequest_PolicyRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
