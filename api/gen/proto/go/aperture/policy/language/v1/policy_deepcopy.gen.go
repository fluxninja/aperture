...
// DeepCopyInto supports using LoadActuatorAlerter within kubernetes types, where deepcopy-gen is used.
func (in *LoadActuatorAlerter) DeepCopyInto(out *LoadActuatorAlerter) {
	p := proto.Clone(in).(*LoadActuatorAlerter)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadActuatorAlerter. Required by controller-gen.
func (in *LoadActuatorAlerter) DeepCopy() *LoadActuatorAlerter {
	if in == nil {
		return nil
	}
	out := new(LoadActuatorAlerter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadActuatorAlerter. Required by controller-gen.
func (in *LoadActuatorAlerter) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
