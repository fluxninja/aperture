...
// DeepCopyInto supports using ConstantValue within kubernetes types, where deepcopy-gen is used.
func (in *ConstantValue) DeepCopyInto(out *ConstantValue) {
	p := proto.Clone(in).(*ConstantValue)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConstantValue. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConstantValue. Required by controller-gen.
func (in *ConstantValue) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
