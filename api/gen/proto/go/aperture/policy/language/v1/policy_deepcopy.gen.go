...
// DeepCopyInto supports using Not within kubernetes types, where deepcopy-gen is used.
func (in *Not) DeepCopyInto(out *Not) {
	p := proto.Clone(in).(*Not)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Not. Required by controller-gen.
func (in *Not) DeepCopy() *Not {
	if in == nil {
		return nil
	}
	out := new(Not)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Not. Required by controller-gen.
func (in *Not) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using Not_Ins within kubernetes types, where deepcopy-gen is used.
func (in *Not_Ins) DeepCopyInto(out *Not_Ins) {
	p := proto.Clone(in).(*Not_Ins)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Not_Ins. Required by controller-gen.
func (in *Not_Ins) DeepCopy() *Not_Ins {
	if in == nil {
		return nil
	}
	out := new(Not_Ins)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Not_Ins. Required by controller-gen.
func (in *Not_Ins) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using Not_Outs within kubernetes types, where deepcopy-gen is used.
func (in *Not_Outs) DeepCopyInto(out *Not_Outs) {
	p := proto.Clone(in).(*Not_Outs)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Not_Outs. Required by controller-gen.
func (in *Not_Outs) DeepCopy() *Not_Outs {
	if in == nil {
		return nil
	}
	out := new(Not_Outs)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Not_Outs. Required by controller-gen.
func (in *Not_Outs) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
