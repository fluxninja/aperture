...
func (in *UpsertPolicyRequest) DeepCopyInto(out *UpsertPolicyRequest) {
	p := proto.Clone(in).(*UpsertPolicyRequest)
	*out = *p
}
...
func (in *PostDynamicConfigRequest) DeepCopyInto(out *PostDynamicConfigRequest) {
	p := proto.Clone(in).(*PostDynamicConfigRequest)
	*out = *p
}
...
func (in *PostDynamicConfigRequest) DeepCopy() *PostDynamicConfigRequest {
	if in == nil {
		return nil
	}
	out := new(PostDynamicConfigRequest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PolicyMetadata) DeepCopyInto(out *PolicyMetadata) {
	p := proto.Clone(in).(*PolicyMetadata)
	*out = *p
}
