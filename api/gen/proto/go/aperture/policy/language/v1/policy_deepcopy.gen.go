...
// DeepCopyInto supports using ConcurrencyActuator within kubernetes types, where deepcopy-gen is used.
func (in *ConcurrencyActuator) DeepCopyInto(out *ConcurrencyActuator) {
	p := proto.Clone(in).(*ConcurrencyActuator)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyActuator. Required by controller-gen.
func (in *ConcurrencyActuator) DeepCopy() *ConcurrencyActuator {
	if in == nil {
		return nil
	}
	out := new(ConcurrencyActuator)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyActuator. Required by controller-gen.
func (in *ConcurrencyActuator) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using ConcurrencyActuator_Ins within kubernetes types, where deepcopy-gen is used.
func (in *ConcurrencyActuator_Ins) DeepCopyInto(out *ConcurrencyActuator_Ins) {
	p := proto.Clone(in).(*ConcurrencyActuator_Ins)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyActuator_Ins. Required by controller-gen.
func (in *ConcurrencyActuator_Ins) DeepCopy() *ConcurrencyActuator_Ins {
	if in == nil {
		return nil
	}
	out := new(ConcurrencyActuator_Ins)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyActuator_Ins. Required by controller-gen.
func (in *ConcurrencyActuator_Ins) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
