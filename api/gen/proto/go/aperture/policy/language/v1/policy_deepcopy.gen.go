...
// DeepCopyInto supports using KubernetesPodAutoscaler within kubernetes types, where deepcopy-gen is used.
func (in *KubernetesPodAutoscaler) DeepCopyInto(out *KubernetesPodAutoscaler) {
	p := proto.Clone(in).(*KubernetesPodAutoscaler)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler. Required by controller-gen.
func (in *KubernetesPodAutoscaler) DeepCopy() *KubernetesPodAutoscaler {
	if in == nil {
		return nil
	}
	out := new(KubernetesPodAutoscaler)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler. Required by controller-gen.
func (in *KubernetesPodAutoscaler) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using KubernetesPodAutoscaler_Ins within kubernetes types, where deepcopy-gen is used.
func (in *KubernetesPodAutoscaler_Ins) DeepCopyInto(out *KubernetesPodAutoscaler_Ins) {
	p := proto.Clone(in).(*KubernetesPodAutoscaler_Ins)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler_Ins. Required by controller-gen.
func (in *KubernetesPodAutoscaler_Ins) DeepCopy() *KubernetesPodAutoscaler_Ins {
	if in == nil {
		return nil
	}
	out := new(KubernetesPodAutoscaler_Ins)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler_Ins. Required by controller-gen.
func (in *KubernetesPodAutoscaler_Ins) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using KubernetesPodAutoscaler_Outs within kubernetes types, where deepcopy-gen is used.
func (in *KubernetesPodAutoscaler_Outs) DeepCopyInto(out *KubernetesPodAutoscaler_Outs) {
	p := proto.Clone(in).(*KubernetesPodAutoscaler_Outs)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler_Outs. Required by controller-gen.
func (in *KubernetesPodAutoscaler_Outs) DeepCopy() *KubernetesPodAutoscaler_Outs {
	if in == nil {
		return nil
	}
	out := new(KubernetesPodAutoscaler_Outs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesPodAutoscaler_Outs. Required by controller-gen.
func (in *KubernetesPodAutoscaler_Outs) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
