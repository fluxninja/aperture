...
// DeepCopyInto supports using PatchDynamicConfigsRequest within kubernetes types, where deepcopy-gen is used.
func (in *PatchDynamicConfigsRequest) DeepCopyInto(out *PatchDynamicConfigsRequest) {
	p := proto.Clone(in).(*PatchDynamicConfigsRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PatchDynamicConfigsRequest. Required by controller-gen.
func (in *PatchDynamicConfigsRequest) DeepCopy() *PatchDynamicConfigsRequest {
	if in == nil {
		return nil
	}
	out := new(PatchDynamicConfigsRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PatchDynamicConfigsRequest. Required by controller-gen.
func (in *PatchDynamicConfigsRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PatchDynamicConfigsRequest_DynamicConfigRequest within kubernetes types, where deepcopy-gen is used.
func (in *PatchDynamicConfigsRequest_DynamicConfigRequest) DeepCopyInto(out *PatchDynamicConfigsRequest_DynamicConfigRequest) {
	p := proto.Clone(in).(*PatchDynamicConfigsRequest_DynamicConfigRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PatchDynamicConfigsRequest_DynamicConfigRequest. Required by controller-gen.
func (in *PatchDynamicConfigsRequest_DynamicConfigRequest) DeepCopy() *PatchDynamicConfigsRequest_DynamicConfigRequest {
	if in == nil {
		return nil
	}
	out := new(PatchDynamicConfigsRequest_DynamicConfigRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PatchDynamicConfigsRequest_DynamicConfigRequest. Required by controller-gen.
func (in *PatchDynamicConfigsRequest_DynamicConfigRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
...
// DeepCopyInto supports using PostPoliciesResponse within kubernetes types, where deepcopy-gen is used.
func (in *PostPoliciesResponse) DeepCopyInto(out *PostPoliciesResponse) {
	p := proto.Clone(in).(*PostPoliciesResponse)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostPoliciesResponse. Required by controller-gen.
func (in *PostPoliciesResponse) DeepCopy() *PostPoliciesResponse {
	if in == nil {
		return nil
	}
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PostPoliciesResponse. Required by controller-gen.
func (in *PostPoliciesResponse) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
