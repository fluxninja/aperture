...
// DeepCopyInto supports using PodAutoscaler_ScaleReporter within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscaler_ScaleReporter) DeepCopyInto(out *PodAutoscaler_ScaleReporter) {
	p := proto.Clone(in).(*PodAutoscaler_ScaleReporter)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleReporter. Required by controller-gen.
func (in *PodAutoscaler_ScaleReporter) DeepCopy() *PodAutoscaler_ScaleReporter {
	if in == nil {
		return nil
	}
	out := new(PodAutoscaler_ScaleReporter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleReporter. Required by controller-gen.
func (in *PodAutoscaler_ScaleReporter) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PodAutoscaler_ScaleReporter_Outs within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscaler_ScaleReporter_Outs) DeepCopyInto(out *PodAutoscaler_ScaleReporter_Outs) {
	p := proto.Clone(in).(*PodAutoscaler_ScaleReporter_Outs)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleReporter_Outs. Required by controller-gen.
func (in *PodAutoscaler_ScaleReporter_Outs) DeepCopy() *PodAutoscaler_ScaleReporter_Outs {
	if in == nil {
		return nil
	}
	out := new(PodAutoscaler_ScaleReporter_Outs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleReporter_Outs. Required by controller-gen.
func (in *PodAutoscaler_ScaleReporter_Outs) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PodAutoscaler_ScaleActuator within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscaler_ScaleActuator) DeepCopyInto(out *PodAutoscaler_ScaleActuator) {
	p := proto.Clone(in).(*PodAutoscaler_ScaleActuator)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator) DeepCopy() *PodAutoscaler_ScaleActuator {
	if in == nil {
		return nil
	}
	out := new(PodAutoscaler_ScaleActuator)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PodAutoscaler_ScaleActuator_DynamicConfig within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscaler_ScaleActuator_DynamicConfig) DeepCopyInto(out *PodAutoscaler_ScaleActuator_DynamicConfig) {
	p := proto.Clone(in).(*PodAutoscaler_ScaleActuator_DynamicConfig)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator_DynamicConfig. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator_DynamicConfig) DeepCopy() *PodAutoscaler_ScaleActuator_DynamicConfig {
	if in == nil {
		return nil
	}
	out := new(PodAutoscaler_ScaleActuator_DynamicConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator_DynamicConfig. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator_DynamicConfig) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PodAutoscaler_ScaleActuator_Ins within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscaler_ScaleActuator_Ins) DeepCopyInto(out *PodAutoscaler_ScaleActuator_Ins) {
	p := proto.Clone(in).(*PodAutoscaler_ScaleActuator_Ins)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator_Ins. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator_Ins) DeepCopy() *PodAutoscaler_ScaleActuator_Ins {
	if in == nil {
		return nil
	}
	out := new(PodAutoscaler_ScaleActuator_Ins)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscaler_ScaleActuator_Ins. Required by controller-gen.
func (in *PodAutoscaler_ScaleActuator_Ins) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
