...
var file_aperture_policy_language_v1_flowcontrol_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0xdd, 0x04, 0x0a, 0x07, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x12, 0x43,
	0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x1a, 0xd8,
...
var file_aperture_policy_language_v1_flowcontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_aperture_policy_language_v1_flowcontrol_proto_goTypes = []interface{}{
	...
	(v1.StatusCode)(0),                    // 48: aperture.flowcontrol.check.v1.StatusCode
	(*LabelMatcher)(nil),                  // 49: aperture.policy.language.v1.LabelMatcher
	(*InPort)(nil),                        // 50: aperture.policy.language.v1.InPort
	(*OutPort)(nil),                       // 51: aperture.policy.language.v1.OutPort
	(*GradientController_Parameters)(nil), // 52: aperture.policy.language.v1.GradientController.Parameters
...
var file_aperture_policy_language_v1_flowcontrol_proto_depIdxs = []int32{
	...
	47, // 22: aperture.policy.language.v1.Scheduler.decision_deadline_margin:type_name -> google.protobuf.Duration
	48, // 23: aperture.policy.language.v1.Scheduler.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	30, // 24: aperture.policy.language.v1.AdaptiveLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Ins
	31, // 25: aperture.policy.language.v1.AdaptiveLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Outs
	...
	33, // 27: aperture.policy.language.v1.Sampler.in_ports:type_name -> aperture.policy.language.v1.Sampler.Ins
	32, // 28: aperture.policy.language.v1.Sampler.parameters:type_name -> aperture.policy.language.v1.Sampler.Parameters
	35, // 29: aperture.policy.language.v1.LoadRamp.in_ports:type_name -> aperture.policy.language.v1.LoadRamp.Ins
	36, // 30: aperture.policy.language.v1.LoadRamp.out_ports:type_name -> aperture.policy.language.v1.LoadRamp.Outs
	34, // 31: aperture.policy.language.v1.LoadRamp.parameters:type_name -> aperture.policy.language.v1.LoadRamp.Parameters
	38, // 32: aperture.policy.language.v1.FluxMeter.static_buckets:type_name -> aperture.policy.language.v1.FluxMeter.StaticBuckets
	39, // 33: aperture.policy.language.v1.FluxMeter.linear_buckets:type_name -> aperture.policy.language.v1.FluxMeter.LinearBuckets
	40, // 34: aperture.policy.language.v1.FluxMeter.exponential_buckets:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	41, // 35: aperture.policy.language.v1.FluxMeter.exponential_buckets_range:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	18, // 36: aperture.policy.language.v1.FluxMeter.selectors:type_name -> aperture.policy.language.v1.Selector
	42, // 37: aperture.policy.language.v1.Classifier.rules:type_name -> aperture.policy.language.v1.Classifier.RulesEntry
	12, // 38: aperture.policy.language.v1.Classifier.rego:type_name -> aperture.policy.language.v1.Rego
	18, // 39: aperture.policy.language.v1.Classifier.selectors:type_name -> aperture.policy.language.v1.Selector
	13, // 40: aperture.policy.language.v1.Rule.extractor:type_name -> aperture.policy.language.v1.Extractor
	44, // 41: aperture.policy.language.v1.Rego.labels:type_name -> aperture.policy.language.v1.Rego.LabelsEntry
	14, // 42: aperture.policy.language.v1.Extractor.json:type_name -> aperture.policy.language.v1.JSONExtractor
	15, // 43: aperture.policy.language.v1.Extractor.address:type_name -> aperture.policy.language.v1.AddressExtractor
	16, // 44: aperture.policy.language.v1.Extractor.jwt:type_name -> aperture.policy.language.v1.JWTExtractor
	17, // 45: aperture.policy.language.v1.Extractor.path_templates:type_name -> aperture.policy.language.v1.PathTemplateMatcher
	45, // 46: aperture.policy.language.v1.PathTemplateMatcher.template_values:type_name -> aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	49, // 47: aperture.policy.language.v1.Selector.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	9,  // 48: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	47, // 49: aperture.policy.language.v1.RateLimiter.Parameters.interval:type_name -> google.protobuf.Duration
	47, // 50: aperture.policy.language.v1.RateLimiter.Parameters.max_idle_time:type_name -> google.protobuf.Duration
	23, // 51: aperture.policy.language.v1.RateLimiter.Parameters.lazy_sync:type_name -> aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	48, // 52: aperture.policy.language.v1.RateLimiter.RequestParameters.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	50, // 53: aperture.policy.language.v1.RateLimiter.Ins.bucket_capacity:type_name -> aperture.policy.language.v1.InPort
	50, // 54: aperture.policy.language.v1.RateLimiter.Ins.fill_amount:type_name -> aperture.policy.language.v1.InPort
	50, // 55: aperture.policy.language.v1.RateLimiter.Ins.pass_through:type_name -> aperture.policy.language.v1.InPort
	5,  // 56: aperture.policy.language.v1.LoadScheduler.Parameters.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	18, // 57: aperture.policy.language.v1.LoadScheduler.Parameters.selectors:type_name -> aperture.policy.language.v1.Selector
	50, // 58: aperture.policy.language.v1.LoadScheduler.Ins.load_multiplier:type_name -> aperture.policy.language.v1.InPort
	51, // 59: aperture.policy.language.v1.LoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	...
	49, // 61: aperture.policy.language.v1.Scheduler.Workload.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	47, // 62: aperture.policy.language.v1.Scheduler.Workload.Parameters.queue_timeout:type_name -> google.protobuf.Duration
	24, // 63: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	52, // 64: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.gradient:type_name -> aperture.policy.language.v1.GradientController.Parameters
	53, // 65: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.alerter:type_name -> aperture.policy.language.v1.Alerter.Parameters
	50, // 66: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	50, // 67: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	50, // 68: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.overload_confirmation:type_name -> aperture.policy.language.v1.InPort
	51, // 69: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	51, // 70: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	51, // 71: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	18, // 72: aperture.policy.language.v1.Sampler.Parameters.selectors:type_name -> aperture.policy.language.v1.Selector
	48, // 73: aperture.policy.language.v1.Sampler.Parameters.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	50, // 74: aperture.policy.language.v1.Sampler.Ins.accept_percentage:type_name -> aperture.policy.language.v1.InPort
	32, // 75: aperture.policy.language.v1.LoadRamp.Parameters.sampler:type_name -> aperture.policy.language.v1.Sampler.Parameters
	37, // 76: aperture.policy.language.v1.LoadRamp.Parameters.steps:type_name -> aperture.policy.language.v1.LoadRamp.Parameters.Step
	50, // 77: aperture.policy.language.v1.LoadRamp.Ins.forward:type_name -> aperture.policy.language.v1.InPort
	50, // 78: aperture.policy.language.v1.LoadRamp.Ins.backward:type_name -> aperture.policy.language.v1.InPort
	50, // 79: aperture.policy.language.v1.LoadRamp.Ins.reset:type_name -> aperture.policy.language.v1.InPort
	51, // 80: aperture.policy.language.v1.LoadRamp.Outs.accept_percentage:type_name -> aperture.policy.language.v1.OutPort
	51, // 81: aperture.policy.language.v1.LoadRamp.Outs.at_start:type_name -> aperture.policy.language.v1.OutPort
	51, // 82: aperture.policy.language.v1.LoadRamp.Outs.at_end:type_name -> aperture.policy.language.v1.OutPort
	47, // 83: aperture.policy.language.v1.LoadRamp.Parameters.Step.duration:type_name -> google.protobuf.Duration
	48, // 84: aperture.policy.language.v1.LoadRamp.Parameters.Step.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	11, // 85: aperture.policy.language.v1.Classifier.RulesEntry.value:type_name -> aperture.policy.language.v1.Rule
	43, // 86: aperture.policy.language.v1.Rego.LabelsEntry.value:type_name -> aperture.policy.language.v1.Rego.LabelProperties
