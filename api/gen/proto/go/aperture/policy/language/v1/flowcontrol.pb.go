...
type RateLimiter struct {
	...
	TokensLabelKey string `protobuf:"bytes,4,opt,name=tokens_label_key,json=tokensLabelKey,proto3" json:"tokens_label_key,omitempty"`
}
...
func (x *RateLimiter) GetTokensLabelKey() string {
	if x != nil {
...
// The _Adaptive Load Scheduler_ adjusts the accepted token rate based on the application health signals and the provided throttling strategy.
// Deprecated: v3.0.0. Use _AIMD Load Scheduler_ OR _Range Load Scheduler_ instead.
type AdaptiveLoadScheduler struct {
	...
	// Types that are assignable to ThrottlingStrategy:
	//
	//	*AdaptiveLoadScheduler_AimdThrottlingStrategy
	//	*AdaptiveLoadScheduler_RangeThrottlingStrategy_
	ThrottlingStrategy isAdaptiveLoadScheduler_ThrottlingStrategy `protobuf_oneof:"throttling_strategy"`
	// Decides whether to run the load scheduler in dry-run mode. In dry run mode the scheduler acts as pass through to all flow and does not queue flows.
	// It is useful for observing the behavior of load scheduler without disrupting any real traffic.
	DryRun bool `protobuf:"varint,6,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"`
	// Configuration key for setting dry run mode through dynamic configuration.
...
func (m *AdaptiveLoadScheduler) GetThrottlingStrategy() isAdaptiveLoadScheduler_ThrottlingStrategy {
	if m != nil {
		return m.ThrottlingStrategy
	}
	return nil
}

func (x *AdaptiveLoadScheduler) GetAimdThrottlingStrategy() *AdaptiveLoadScheduler_AIMDThrottlingStrategy {
	if x, ok := x.GetThrottlingStrategy().(*AdaptiveLoadScheduler_AimdThrottlingStrategy); ok {
		return x.AimdThrottlingStrategy
	}
	return nil
}

func (x *AdaptiveLoadScheduler) GetRangeThrottlingStrategy() *AdaptiveLoadScheduler_RangeThrottlingStrategy {
	if x, ok := x.GetThrottlingStrategy().(*AdaptiveLoadScheduler_RangeThrottlingStrategy_); ok {
		return x.RangeThrottlingStrategy
	}
	return nil
}
...
type isAdaptiveLoadScheduler_ThrottlingStrategy interface {
	isAdaptiveLoadScheduler_ThrottlingStrategy()
}
...
func (*AdaptiveLoadScheduler_AimdThrottlingStrategy) isAdaptiveLoadScheduler_ThrottlingStrategy() {}

func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_) isAdaptiveLoadScheduler_ThrottlingStrategy() {}
...
type RateLimiter_Parameters struct {
	...
	DeniedResponseStatusCode v1.StatusCode `protobuf:"varint,7,opt,name=denied_response_status_code,json=deniedResponseStatusCode,proto3,enum=aperture.flowcontrol.check.v1.StatusCode" json:"denied_response_status_code,omitempty"`
}
...
func (x *RateLimiter_Parameters) GetDeniedResponseStatusCode() v1.StatusCode {
	if x != nil {
		return x.DeniedResponseStatusCode
	}
	return v1.StatusCode(0)
...
type RangeDrivenLoadScheduler_Parameters struct {
	...
	LowWatermark *RangeDrivenLoadScheduler_Datapoint `protobuf:"bytes,2,opt,name=low_watermark,json=lowWatermark,proto3" json:"low_watermark,omitempty" validate:"required"` // @gotags: validate:"required"
	// Ending data-point of the throttling range
	HighWatermark *RangeDrivenLoadScheduler_Datapoint `protobuf:"bytes,3,opt,name=high_watermark,json=highWatermark,proto3" json:"high_watermark,omitempty" validate:"required"` // @gotags: validate:"required"
...
func (x *RangeDrivenLoadScheduler_Parameters) GetLowWatermark() *RangeDrivenLoadScheduler_Datapoint {
	if x != nil {
...
func (x *RangeDrivenLoadScheduler_Parameters) GetHighWatermark() *RangeDrivenLoadScheduler_Datapoint {
	if x != nil {
...
// _AIMD Throttling Strategy_ uses a Gradient Controller to throttle the token rate based on the deviation of the signal from the setpoint.
// It takes a signal and setpoint as inputs and reduces token rate proportionally (or any arbitrary power) based on deviation of the signal from setpoint.
// During recovery, it increases the token rate linearly until the system is not overloaded.
type AdaptiveLoadScheduler_AIMDThrottlingStrategy struct {
	state         protoimpl.MessageState
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) Reset() {
	*x = AdaptiveLoadScheduler_AIMDThrottlingStrategy{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_AIMDThrottlingStrategy) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_AIMDThrottlingStrategy.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_AIMDThrottlingStrategy) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 1}
}

func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) GetInPorts() *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins {
	if x != nil {
		return x.InPorts
	}
	return nil
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) GetGradient() *GradientController_Parameters {
	if x != nil {
		return x.Gradient
	}
	return nil
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) GetMaxLoadMultiplier() float64 {
	if x != nil {
		return x.MaxLoadMultiplier
	}
	return 0
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy) GetLoadMultiplierLinearIncrement() float64 {
	if x != nil {
		return x.LoadMultiplierLinearIncrement
	}
	return 0
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy) Reset() {
	*x = AdaptiveLoadScheduler_RangeThrottlingStrategy{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_RangeThrottlingStrategy) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_RangeThrottlingStrategy.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_RangeThrottlingStrategy) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 2}
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy) GetInPorts() *AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins {
	if x != nil {
		return x.InPorts
	}
	return nil
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy) GetParameters() *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (*AdaptiveLoadScheduler_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 3}
}
...
func (*AdaptiveLoadScheduler_Outs) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 4}
}
...
// Input ports for the _AIMD Throttling Strategy_.
type AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) Reset() {
	*x = AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 1, 0}
}

func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) GetSignal() *InPort {
	if x != nil {
		return x.Signal
	}
	return nil
...
func (x *AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins) GetSetpoint() *InPort {
	if x != nil {
		return x.Setpoint
	}
	return nil
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) Reset() {
	*x = AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 2, 0}
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins) GetSignal() *InPort {
	if x != nil {
		return x.Signal
	}
	return nil
...
type AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// degree=2: quadratic
	// degree=3: cubic
	Degree float64 `protobuf:"fixed64,3,opt,name=degree,proto3" json:"degree,omitempty" validate:"required"` // @gotags: validate:"required"
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) Reset() {
	*x = AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 2, 1}
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) GetStart() *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) GetEnd() *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters) GetDegree() float64 {
	if x != nil {
		return x.Degree
	}
	return 0
...
type AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Threshold      float64 `protobuf:"fixed64,1,opt,name=threshold,proto3" json:"threshold,omitempty" validate:"gte=0,lte=1"`                                 // @gotags: validate:"gte=0,lte=1"
	LoadMultiplier float64 `protobuf:"fixed64,2,opt,name=load_multiplier,json=loadMultiplier,proto3" json:"load_multiplier,omitempty" validate:"gte=0,lte=1"` // @gotags: validate:"gte=0,lte=1"
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) Reset() {
	*x = AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) ProtoMessage() {}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint.ProtoReflect.Descriptor instead.
func (*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{8, 2, 1, 0}
}

func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint) GetLoadMultiplier() float64 {
	if x != nil {
		return x.LoadMultiplier
	}
	return 0
...
func (*LoadRamp_Parameters_Step) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{10, 0, 0}
}
...
func (*FluxMeter_ExponentialBucketsRange) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{11, 3}
}
...
var file_aperture_policy_language_v1_flowcontrol_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x02, 0x0a, 0x14, 0x46, 0x6c, 0x6f, 0x77,
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	0x12, 0x62, 0x0a, 0x0b, 0x66, 0x6c, 0x75, 0x78, 0x5f, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x41, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	...
	0x65, 0x72, 0x52, 0x0b, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x1a,
	0x65, 0x0a, 0x0f, 0x46, 0x6c, 0x75, 0x78, 0x4d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x45, 0x6e, 0x74,
	...
	0x31, 0x2e, 0x46, 0x6c, 0x75, 0x78, 0x4d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x99, 0x06, 0x0a, 0x0b, 0x46, 0x6c, 0x6f, 0x77, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x12, 0x56, 0x0a, 0x0f, 0x71, 0x75, 0x6f, 0x74, 0x61, 0x5f,
	...
	0x6f, 0x74, 0x61, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0e,
	0x71, 0x75, 0x6f, 0x74, 0x61, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x4d,
	...
	,
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x48, 0x00, 0x52, 0x15, 0x61, 0x64, 0x61, 0x70, 0x74,
	0x69, 0x76, 0x65, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72,
	0x12, 0x40, 0x0a, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28,
	...
	0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x48, 0x00, 0x52, 0x07, 0x73, 0x61, 0x6d, 0x70, 0x6c,
	0x65, 0x72, 0x12, 0x44, 0x0a, 0x09, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x72, 0x61, 0x6d, 0x70, 0x18,
	...
	,
	...
	,
	...
	0x72, 0x2e, 0x49, 0x6e, 0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x43,
	...
	0x6f, 0x72, 0x73, 0x12, 0x56, 0x0a, 0x0c, 0x72, 0x61, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x6d, 0x69,
	0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x61, 0x70, 0x65, 0x72,
	0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69,
	0x74, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x0b,
	0x72, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x12, 0x44, 0x0a, 0x09, 0x73,
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26,
	...
	0x72, 0x22, 0xd9, 0x07, 0x0a, 0x0b, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65,
	0x72, 0x12, 0x47, 0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20,
	...
	0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x53, 0x0a, 0x0a, 0x70, 0x61,
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33,
	0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x74, 0x6f, 0x72, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x5f, 0x6c,
	0x61, 0x62, 0x65, 0x6c, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4b, 0x65, 0x79, 0x1a, 0xd8,
	...
	0x78, 0x49, 0x64, 0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x59, 0x0a, 0x09, 0x6c, 0x61, 0x7a,
	0x79, 0x5f, 0x73, 0x79, 0x6e, 0x63, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x61,
	...
	,
	...
	0x52, 0x07, 0x6e, 0x75, 0x6d, 0x53, 0x79, 0x6e, 0x63, 0x1a, 0xe1, 0x01, 0x0a, 0x03, 0x49, 0x6e,
	0x73, 0x12, 0x4c, 0x0a, 0x0f, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x63, 0x61, 0x70, 0x61,
	0x63, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65,
	...
	0x44, 0x0a, 0x0b, 0x66, 0x69, 0x6c, 0x6c, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x6c, 0x41,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x46, 0x0a, 0x0c, 0x70, 0x61, 0x73, 0x73, 0x5f, 0x74, 0x68,
	0x72, 0x6f, 0x75, 0x67, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70,
	...
	,
	...
	0x6f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x55, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x61,
	0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c,
	...
	,
	...
	0x65, 0x72, 0x52, 0x09, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x43, 0x0a,
	...
	0x72, 0x73, 0x1a, 0x53, 0x0a, 0x03, 0x49, 0x6e, 0x73, 0x12, 0x4c, 0x0a, 0x0f, 0x6c, 0x6f, 0x61,
	...
	0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x1a, 0x66, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12,
	...
	0x64, 0x4c, 0x6f, 0x61, 0x64, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x22,
	0xc7, 0x06, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x4d, 0x0a,
	...
	0x64, 0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x12, 0x7a, 0x0a, 0x1b,
	0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x58, 0x0a, 0x15, 0x6f, 0x76, 0x65, 0x72, 0x6c,
	0x6f, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x14, 0x6f, 0x76, 0x65,
	0x72, 0x6c, 0x6f, 0x61, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x1a, 0x8b, 0x02, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x45, 0x0a, 0x0b, 0x69, 0x73,
	...
	0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x4f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x16, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x64, 0x4c, 0x6f, 0x61, 0x64, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x1a,
	0x86, 0x03, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x5c,
	...
	0x65, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x0d, 0x6c,
	0x6f, 0x61, 0x64, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x56, 0x0a, 0x08,
	0x67, 0x72, 0x61, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a,
	0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x08, 0x67, 0x72, 0x61, 0x64,
	0x69, 0x65, 0x6e, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x6d, 0x61, 0x78, 0x5f, 0x6c, 0x6f, 0x61, 0x64,
	0x5f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x1d,
	0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x4c, 0x69,
	0x6e, 0x65, 0x61, 0x72, 0x49, 0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x49, 0x0a,
	0x07, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f,
	0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	,
	...
	0x6c, 0x12, 0x58, 0x0a, 0x15, 0x6f, 0x76, 0x65, 0x72, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x63, 0x6f,
	...
	,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x07, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x65, 0x72,
	0x22, 0x89, 0x15, 0x0a, 0x15, 0x41, 0x64, 0x61, 0x70, 0x74, 0x69, 0x76, 0x65, 0x4c, 0x6f, 0x61,
	...
	,
	...
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x56, 0x0a, 0x08, 0x67, 0x72, 0x61, 0x64,
	0x69, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x61, 0x70, 0x65,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x08, 0x67, 0x72, 0x61, 0x64, 0x69, 0x65, 0x6e,
	0x74, 0x12, 0x2e, 0x0a, 0x13, 0x6d, 0x61, 0x78, 0x5f, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x6d, 0x75,
	0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x11,
	...
	,
	...
	0x52, 0x61, 0x6e, 0x67, 0x65, 0x54, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x69, 0x6e, 0x67, 0x53,
	0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x73, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x42,
	...
	,
	...
	0x70, 0x6c, 0x69, 0x65, 0x72, 0x42, 0x15, 0x0a, 0x13, 0x74, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c,
	0x69, 0x6e, 0x67, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0xe7, 0x04, 0x0a,
	0x07, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x12, 0x43, 0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70,
	0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x61, 0x70, 0x65,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72,
	0x2e, 0x49, 0x6e, 0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x4f, 0x0a,
	...
	0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	...
	0x61, 0x62, 0x65, 0x6c, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1f, 0x70, 0x61, 0x73, 0x73, 0x54, 0x68, 0x72,
	0x6f, 0x75, 0x67, 0x68, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x1a, 0xe2, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x72,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0xa7, 0x09, 0x0a, 0x08, 0x4c, 0x6f, 0x61, 0x64, 0x52,
	0x61, 0x6d, 0x70, 0x12, 0x44, 0x0a, 0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x61, 0x6d, 0x70, 0x2e, 0x49, 0x6e, 0x73,
	...
	0x61, 0x6d, 0x70, 0x2e, 0x4f, 0x75, 0x74, 0x73, 0x52, 0x08, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x72,
	0x74, 0x73, 0x12, 0x50, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	...
	,
	...
	0x73, 0x74, 0x65, 0x70, 0x73, 0x1a, 0xeb, 0x01, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70, 0x12, 0x38,
	0x0a, 0x18, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x5f,
	0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01,
	0x52, 0x16, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x50, 0x65,
	0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x75, 0x72, 0x61,
	...
	,
	...
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52,
	0x05, 0x72, 0x65, 0x73, 0x65, 0x74, 0x1a, 0xd7, 0x01, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12,
	...
	,
	...
	,
	...
	0x1a, 0x58, 0x0a, 0x12, 0x45, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x42,
	0x75, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06,
	0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x66, 0x61,
	0x63, 0x74, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x53, 0x0a, 0x17, 0x45, 0x78,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x1a, 0x41, 0x0a, 0x13, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0xba, 0x01, 0x0a, 0x08, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	0x42, 0xb0, 0x02, 0x0a, 0x33, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x75, 0x78, 0x6e, 0x69, 0x6e,
	0x6a, 0x61, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2e, 0x61, 0x70, 0x65,
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x10, 0x46, 0x6c, 0x6f, 0x77, 0x63, 0x6f,
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x58, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x6c, 0x75, 0x78, 0x6e, 0x69, 0x6e,
	0x6a, 0x61, 0x2f, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2f, 0x76, 0x32, 0x2f, 0x61,
...
var file_aperture_policy_language_v1_flowcontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_aperture_policy_language_v1_flowcontrol_proto_goTypes = []interface{}{
	...
	(*AdaptiveLoadScheduler)(nil),                             // 8: aperture.policy.language.v1.AdaptiveLoadScheduler
	(*Sampler)(nil),                                           // 9: aperture.policy.language.v1.Sampler
	(*LoadRamp)(nil),                                          // 10: aperture.policy.language.v1.LoadRamp
	(*FluxMeter)(nil),                                         // 11: aperture.policy.language.v1.FluxMeter
	(*Classifier)(nil),                                        // 12: aperture.policy.language.v1.Classifier
	(*Rule)(nil),                                              // 13: aperture.policy.language.v1.Rule
	(*Rego)(nil),                                              // 14: aperture.policy.language.v1.Rego
	(*Extractor)(nil),                                         // 15: aperture.policy.language.v1.Extractor
	(*JSONExtractor)(nil),                                     // 16: aperture.policy.language.v1.JSONExtractor
	(*AddressExtractor)(nil),                                  // 17: aperture.policy.language.v1.AddressExtractor
	(*JWTExtractor)(nil),                                      // 18: aperture.policy.language.v1.JWTExtractor
	(*PathTemplateMatcher)(nil),                               // 19: aperture.policy.language.v1.PathTemplateMatcher
	(*Selector)(nil),                                          // 20: aperture.policy.language.v1.Selector
	nil,                                                       // 21: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	(*RateLimiter_Parameters)(nil),                            // 22: aperture.policy.language.v1.RateLimiter.Parameters
	(*RateLimiter_Ins)(nil),                                   // 23: aperture.policy.language.v1.RateLimiter.Ins
	(*RateLimiter_Parameters_LazySync)(nil),                   // 24: aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	(*LoadScheduler_Parameters)(nil),                          // 25: aperture.policy.language.v1.LoadScheduler.Parameters
	(*LoadScheduler_Ins)(nil),                                 // 26: aperture.policy.language.v1.LoadScheduler.Ins
	(*LoadScheduler_Outs)(nil),                                // 27: aperture.policy.language.v1.LoadScheduler.Outs
	(*Scheduler_Workload)(nil),                                // 28: aperture.policy.language.v1.Scheduler.Workload
	(*Scheduler_Workload_Parameters)(nil),                     // 29: aperture.policy.language.v1.Scheduler.Workload.Parameters
	(*AIMDLoadScheduler_Ins)(nil),                             // 30: aperture.policy.language.v1.AIMDLoadScheduler.Ins
	(*AIMDLoadScheduler_Outs)(nil),                            // 31: aperture.policy.language.v1.AIMDLoadScheduler.Outs
	(*AIMDLoadScheduler_Parameters)(nil),                      // 32: aperture.policy.language.v1.AIMDLoadScheduler.Parameters
	(*RangeDrivenLoadScheduler_Ins)(nil),                      // 33: aperture.policy.language.v1.RangeDrivenLoadScheduler.Ins
	(*RangeDrivenLoadScheduler_Outs)(nil),                     // 34: aperture.policy.language.v1.RangeDrivenLoadScheduler.Outs
	(*RangeDrivenLoadScheduler_Datapoint)(nil),                // 35: aperture.policy.language.v1.RangeDrivenLoadScheduler.Datapoint
	(*RangeDrivenLoadScheduler_Parameters)(nil),               // 36: aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters
	(*AdaptiveLoadScheduler_Parameters)(nil),                  // 37: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters
	(*AdaptiveLoadScheduler_AIMDThrottlingStrategy)(nil),      // 38: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy
	(*AdaptiveLoadScheduler_RangeThrottlingStrategy)(nil),     // 39: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy
	...
	(*AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins)(nil),  // 42: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.Ins
	(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins)(nil), // 43: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Ins
	(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters)(nil),           // 44: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters
	(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint)(nil), // 45: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters.Datapoint
	(*Sampler_Parameters)(nil),                // 46: aperture.policy.language.v1.Sampler.Parameters
	(*Sampler_Ins)(nil),                       // 47: aperture.policy.language.v1.Sampler.Ins
	(*LoadRamp_Parameters)(nil),               // 48: aperture.policy.language.v1.LoadRamp.Parameters
	(*LoadRamp_Ins)(nil),                      // 49: aperture.policy.language.v1.LoadRamp.Ins
	(*LoadRamp_Outs)(nil),                     // 50: aperture.policy.language.v1.LoadRamp.Outs
	(*LoadRamp_Parameters_Step)(nil),          // 51: aperture.policy.language.v1.LoadRamp.Parameters.Step
	(*FluxMeter_StaticBuckets)(nil),           // 52: aperture.policy.language.v1.FluxMeter.StaticBuckets
	(*FluxMeter_LinearBuckets)(nil),           // 53: aperture.policy.language.v1.FluxMeter.LinearBuckets
	(*FluxMeter_ExponentialBuckets)(nil),      // 54: aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	(*FluxMeter_ExponentialBucketsRange)(nil), // 55: aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	nil,                                   // 56: aperture.policy.language.v1.Classifier.RulesEntry
	(*Rego_LabelProperties)(nil),          // 57: aperture.policy.language.v1.Rego.LabelProperties
	nil,                                   // 58: aperture.policy.language.v1.Rego.LabelsEntry
	nil,                                   // 59: aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	(*anypb.Any)(nil),                     // 60: google.protobuf.Any
	(*durationpb.Duration)(nil),           // 61: google.protobuf.Duration
	(v1.StatusCode)(0),                    // 62: aperture.flowcontrol.check.v1.StatusCode
	(*LabelMatcher)(nil),                  // 63: aperture.policy.language.v1.LabelMatcher
	(*InPort)(nil),                        // 64: aperture.policy.language.v1.InPort
	(*OutPort)(nil),                       // 65: aperture.policy.language.v1.OutPort
	(*GradientController_Parameters)(nil), // 66: aperture.policy.language.v1.GradientController.Parameters
	(*Alerter_Parameters)(nil),            // 67: aperture.policy.language.v1.Alerter.Parameters
}
var file_aperture_policy_language_v1_flowcontrol_proto_depIdxs = []int32{
	21,  // 0: aperture.policy.language.v1.FlowControlResources.flux_meters:type_name -> aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	12,  // 1: aperture.policy.language.v1.FlowControlResources.classifiers:type_name -> aperture.policy.language.v1.Classifier
	...
	8,   // 5: aperture.policy.language.v1.FlowControl.adaptive_load_scheduler:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler
	9,   // 6: aperture.policy.language.v1.FlowControl.sampler:type_name -> aperture.policy.language.v1.Sampler
	10,  // 7: aperture.policy.language.v1.FlowControl.load_ramp:type_name -> aperture.policy.language.v1.LoadRamp
	...
	60,  // 10: aperture.policy.language.v1.FlowControl.private:type_name -> google.protobuf.Any
	23,  // 11: aperture.policy.language.v1.QuotaScheduler.in_ports:type_name -> aperture.policy.language.v1.RateLimiter.Ins
	20,  // 12: aperture.policy.language.v1.QuotaScheduler.selectors:type_name -> aperture.policy.language.v1.Selector
	22,  // 13: aperture.policy.language.v1.QuotaScheduler.rate_limiter:type_name -> aperture.policy.language.v1.RateLimiter.Parameters
	5,   // 14: aperture.policy.language.v1.QuotaScheduler.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	23,  // 15: aperture.policy.language.v1.RateLimiter.in_ports:type_name -> aperture.policy.language.v1.RateLimiter.Ins
	22,  // 16: aperture.policy.language.v1.RateLimiter.parameters:type_name -> aperture.policy.language.v1.RateLimiter.Parameters
	20,  // 17: aperture.policy.language.v1.RateLimiter.selectors:type_name -> aperture.policy.language.v1.Selector
	26,  // 18: aperture.policy.language.v1.LoadScheduler.in_ports:type_name -> aperture.policy.language.v1.LoadScheduler.Ins
	27,  // 19: aperture.policy.language.v1.LoadScheduler.out_ports:type_name -> aperture.policy.language.v1.LoadScheduler.Outs
	25,  // 20: aperture.policy.language.v1.LoadScheduler.parameters:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	28,  // 21: aperture.policy.language.v1.Scheduler.workloads:type_name -> aperture.policy.language.v1.Scheduler.Workload
	29,  // 22: aperture.policy.language.v1.Scheduler.default_workload_parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	61,  // 23: aperture.policy.language.v1.Scheduler.decision_deadline_margin:type_name -> google.protobuf.Duration
	62,  // 24: aperture.policy.language.v1.Scheduler.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	30,  // 25: aperture.policy.language.v1.AIMDLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.AIMDLoadScheduler.Ins
	31,  // 26: aperture.policy.language.v1.AIMDLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.AIMDLoadScheduler.Outs
	32,  // 27: aperture.policy.language.v1.AIMDLoadScheduler.parameters:type_name -> aperture.policy.language.v1.AIMDLoadScheduler.Parameters
	33,  // 28: aperture.policy.language.v1.RangeDrivenLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.RangeDrivenLoadScheduler.Ins
	34,  // 29: aperture.policy.language.v1.RangeDrivenLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.RangeDrivenLoadScheduler.Outs
	36,  // 30: aperture.policy.language.v1.RangeDrivenLoadScheduler.parameters:type_name -> aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters
	40,  // 31: aperture.policy.language.v1.AdaptiveLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Ins
	41,  // 32: aperture.policy.language.v1.AdaptiveLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Outs
	37,  // 33: aperture.policy.language.v1.AdaptiveLoadScheduler.parameters:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters
	38,  // 34: aperture.policy.language.v1.AdaptiveLoadScheduler.aimd_throttling_strategy:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy
	39,  // 35: aperture.policy.language.v1.AdaptiveLoadScheduler.range_throttling_strategy:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy
	47,  // 36: aperture.policy.language.v1.Sampler.in_ports:type_name -> aperture.policy.language.v1.Sampler.Ins
	46,  // 37: aperture.policy.language.v1.Sampler.parameters:type_name -> aperture.policy.language.v1.Sampler.Parameters
	49,  // 38: aperture.policy.language.v1.LoadRamp.in_ports:type_name -> aperture.policy.language.v1.LoadRamp.Ins
	50,  // 39: aperture.policy.language.v1.LoadRamp.out_ports:type_name -> aperture.policy.language.v1.LoadRamp.Outs
	48,  // 40: aperture.policy.language.v1.LoadRamp.parameters:type_name -> aperture.policy.language.v1.LoadRamp.Parameters
	52,  // 41: aperture.policy.language.v1.FluxMeter.static_buckets:type_name -> aperture.policy.language.v1.FluxMeter.StaticBuckets
	53,  // 42: aperture.policy.language.v1.FluxMeter.linear_buckets:type_name -> aperture.policy.language.v1.FluxMeter.LinearBuckets
	54,  // 43: aperture.policy.language.v1.FluxMeter.exponential_buckets:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	55,  // 44: aperture.policy.language.v1.FluxMeter.exponential_buckets_range:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	20,  // 45: aperture.policy.language.v1.FluxMeter.selectors:type_name -> aperture.policy.language.v1.Selector
	56,  // 46: aperture.policy.language.v1.Classifier.rules:type_name -> aperture.policy.language.v1.Classifier.RulesEntry
	14,  // 47: aperture.policy.language.v1.Classifier.rego:type_name -> aperture.policy.language.v1.Rego
	20,  // 48: aperture.policy.language.v1.Classifier.selectors:type_name -> aperture.policy.language.v1.Selector
	15,  // 49: aperture.policy.language.v1.Rule.extractor:type_name -> aperture.policy.language.v1.Extractor
	58,  // 50: aperture.policy.language.v1.Rego.labels:type_name -> aperture.policy.language.v1.Rego.LabelsEntry
	16,  // 51: aperture.policy.language.v1.Extractor.json:type_name -> aperture.policy.language.v1.JSONExtractor
	17,  // 52: aperture.policy.language.v1.Extractor.address:type_name -> aperture.policy.language.v1.AddressExtractor
	18,  // 53: aperture.policy.language.v1.Extractor.jwt:type_name -> aperture.policy.language.v1.JWTExtractor
	19,  // 54: aperture.policy.language.v1.Extractor.path_templates:type_name -> aperture.policy.language.v1.PathTemplateMatcher
	59,  // 55: aperture.policy.language.v1.PathTemplateMatcher.template_values:type_name -> aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	63,  // 56: aperture.policy.language.v1.Selector.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	11,  // 57: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	61,  // 58: aperture.policy.language.v1.RateLimiter.Parameters.interval:type_name -> google.protobuf.Duration
	61,  // 59: aperture.policy.language.v1.RateLimiter.Parameters.max_idle_time:type_name -> google.protobuf.Duration
	24,  // 60: aperture.policy.language.v1.RateLimiter.Parameters.lazy_sync:type_name -> aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	62,  // 61: aperture.policy.language.v1.RateLimiter.Parameters.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	64,  // 62: aperture.policy.language.v1.RateLimiter.Ins.bucket_capacity:type_name -> aperture.policy.language.v1.InPort
	64,  // 63: aperture.policy.language.v1.RateLimiter.Ins.fill_amount:type_name -> aperture.policy.language.v1.InPort
	64,  // 64: aperture.policy.language.v1.RateLimiter.Ins.pass_through:type_name -> aperture.policy.language.v1.InPort
	5,   // 65: aperture.policy.language.v1.LoadScheduler.Parameters.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	20,  // 66: aperture.policy.language.v1.LoadScheduler.Parameters.selectors:type_name -> aperture.policy.language.v1.Selector
	64,  // 67: aperture.policy.language.v1.LoadScheduler.Ins.load_multiplier:type_name -> aperture.policy.language.v1.InPort
	65,  // 68: aperture.policy.language.v1.LoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	29,  // 69: aperture.policy.language.v1.Scheduler.Workload.parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	63,  // 70: aperture.policy.language.v1.Scheduler.Workload.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	61,  // 71: aperture.policy.language.v1.Scheduler.Workload.Parameters.queue_timeout:type_name -> google.protobuf.Duration
	64,  // 72: aperture.policy.language.v1.AIMDLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	64,  // 73: aperture.policy.language.v1.AIMDLoadScheduler.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	64,  // 74: aperture.policy.language.v1.AIMDLoadScheduler.Ins.overload_confirmation:type_name -> aperture.policy.language.v1.InPort
	65,  // 75: aperture.policy.language.v1.AIMDLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	65,  // 76: aperture.policy.language.v1.AIMDLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	65,  // 77: aperture.policy.language.v1.AIMDLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	25,  // 78: aperture.policy.language.v1.AIMDLoadScheduler.Parameters.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	66,  // 79: aperture.policy.language.v1.AIMDLoadScheduler.Parameters.gradient:type_name -> aperture.policy.language.v1.GradientController.Parameters
	67,  // 80: aperture.policy.language.v1.AIMDLoadScheduler.Parameters.alerter:type_name -> aperture.policy.language.v1.Alerter.Parameters
	64,  // 81: aperture.policy.language.v1.RangeDrivenLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	64,  // 82: aperture.policy.language.v1.RangeDrivenLoadScheduler.Ins.overload_confirmation:type_name -> aperture.policy.language.v1.InPort
	65,  // 83: aperture.policy.language.v1.RangeDrivenLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	65,  // 84: aperture.policy.language.v1.RangeDrivenLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	65,  // 85: aperture.policy.language.v1.RangeDrivenLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	25,  // 86: aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	35,  // 87: aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters.low_watermark:type_name -> aperture.policy.language.v1.RangeDrivenLoadScheduler.Datapoint
	35,  // 88: aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters.high_watermark:type_name -> aperture.policy.language.v1.RangeDrivenLoadScheduler.Datapoint
	67,  // 89: aperture.policy.language.v1.RangeDrivenLoadScheduler.Parameters.alerter:type_name -> aperture.policy.language.v1.Alerter.Parameters
	25,  // 90: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	66,  // 91: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.gradient:type_name -> aperture.policy.language.v1.GradientController.Parameters
	67,  // 92: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.alerter:type_name -> aperture.policy.language.v1.Alerter.Parameters
	42,  // 93: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.Ins
	66,  // 94: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.gradient:type_name -> aperture.policy.language.v1.GradientController.Parameters
	43,  // 95: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Ins
	44,  // 96: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.parameters:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters
	64,  // 97: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	64,  // 98: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	64,  // 99: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.overload_confirmation:type_name -> aperture.policy.language.v1.InPort
	65,  // 100: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	65,  // 101: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	65,  // 102: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	64,  // 103: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	64,  // 104: aperture.policy.language.v1.AdaptiveLoadScheduler.AIMDThrottlingStrategy.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	64,  // 105: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	45,  // 106: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters.start:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters.Datapoint
	45,  // 107: aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters.end:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.RangeThrottlingStrategy.Parameters.Datapoint
	20,  // 108: aperture.policy.language.v1.Sampler.Parameters.selectors:type_name -> aperture.policy.language.v1.Selector
	62,  // 109: aperture.policy.language.v1.Sampler.Parameters.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	64,  // 110: aperture.policy.language.v1.Sampler.Ins.accept_percentage:type_name -> aperture.policy.language.v1.InPort
	46,  // 111: aperture.policy.language.v1.LoadRamp.Parameters.sampler:type_name -> aperture.policy.language.v1.Sampler.Parameters
	51,  // 112: aperture.policy.language.v1.LoadRamp.Parameters.steps:type_name -> aperture.policy.language.v1.LoadRamp.Parameters.Step
	64,  // 113: aperture.policy.language.v1.LoadRamp.Ins.forward:type_name -> aperture.policy.language.v1.InPort
	64,  // 114: aperture.policy.language.v1.LoadRamp.Ins.backward:type_name -> aperture.policy.language.v1.InPort
	64,  // 115: aperture.policy.language.v1.LoadRamp.Ins.reset:type_name -> aperture.policy.language.v1.InPort
	65,  // 116: aperture.policy.language.v1.LoadRamp.Outs.accept_percentage:type_name -> aperture.policy.language.v1.OutPort
	65,  // 117: aperture.policy.language.v1.LoadRamp.Outs.at_start:type_name -> aperture.policy.language.v1.OutPort
	65,  // 118: aperture.policy.language.v1.LoadRamp.Outs.at_end:type_name -> aperture.policy.language.v1.OutPort
	61,  // 119: aperture.policy.language.v1.LoadRamp.Parameters.Step.duration:type_name -> google.protobuf.Duration
	62,  // 120: aperture.policy.language.v1.LoadRamp.Parameters.Step.denied_response_status_code:type_name -> aperture.flowcontrol.check.v1.StatusCode
	13,  // 121: aperture.policy.language.v1.Classifier.RulesEntry.value:type_name -> aperture.policy.language.v1.Rule
	57,  // 122: aperture.policy.language.v1.Rego.LabelsEntry.value:type_name -> aperture.policy.language.v1.Rego.LabelProperties
...
func file_aperture_policy_language_v1_flowcontrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_AIMDThrottlingStrategy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_RangeThrottlingStrategy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_AIMDThrottlingStrategy_Ins); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Ins); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdaptiveLoadScheduler_RangeThrottlingStrategy_Parameters_Datapoint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*AdaptiveLoadScheduler_AimdThrottlingStrategy)(nil),
		(*AdaptiveLoadScheduler_RangeThrottlingStrategy_)(nil),
	}
