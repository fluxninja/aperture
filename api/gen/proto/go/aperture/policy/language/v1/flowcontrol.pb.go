...
type FluxMeter struct {
	...
	Selectors *Selectors `protobuf:"bytes,7,opt,name=selectors,proto3" json:"selectors,omitempty" validate:"required"` // @gotags: validate:"required"
}
...
type Classifier struct {
	...
	Selectors *Selectors `protobuf:"bytes,4,opt,name=selectors,proto3" json:"selectors,omitempty" validate:"required"` // @gotags: validate:"required"
}
...
type RateLimiter struct {
	...
	// Deprecated 1.8.0: Use `selectors` instead. The `selectors` will be ignored if `flow_selector` is set.
	FlowSelector *FlowSelector `protobuf:"bytes,2,opt,name=flow_selector,json=flowSelector,proto3" json:"flow_selector,omitempty"`
	...
	// Selectors for the component.
	Selectors *Selectors `protobuf:"bytes,6,opt,name=selectors,proto3" json:"selectors,omitempty" validate:"required"` // @gotags: validate:"required"
}
...
type AdaptiveLoadScheduler struct {
	...
	// Deprecated 1.8.0: Use `selectors` instead. The `selectors` will be ignored if `flow_selector` is set.
	FlowSelector *FlowSelector `protobuf:"bytes,3,opt,name=flow_selector,json=flowSelector,proto3" json:"flow_selector,omitempty"`
	// Scheduler parameters.
	...
	// Selectors for the component.
	Selectors *Selectors `protobuf:"bytes,11,opt,name=selectors,proto3" json:"selectors,omitempty"`
}
...
type FlowRegulator_Parameters struct {
	...
	// Selectors for the component.
	Selectors *Selectors `protobuf:"bytes,3,opt,name=selectors,proto3" json:"selectors,omitempty"`
}
