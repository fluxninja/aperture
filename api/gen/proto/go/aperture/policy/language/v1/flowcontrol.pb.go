...
type FlowControl struct {
	...
	//	*FlowControl_FlowScheduler
	//	*FlowControl_AdaptiveFlowScheduler
	//	*FlowControl_LoadRegulator
...
func (x *FlowControl) GetFlowScheduler() *LoadScheduler {
	if x, ok := x.GetComponent().(*FlowControl_FlowScheduler); ok {
		return x.FlowScheduler
	}
	return nil
}

func (x *FlowControl) GetAdaptiveFlowScheduler() *AdaptiveLoadScheduler {
	if x, ok := x.GetComponent().(*FlowControl_AdaptiveFlowScheduler); ok {
		return x.AdaptiveFlowScheduler
	}
	return nil
}

func (x *FlowControl) GetLoadRegulator() *LoadRegulator {
	if x, ok := x.GetComponent().(*FlowControl_LoadRegulator); ok {
...
type FlowControl_FlowScheduler struct {
	...
	FlowScheduler *LoadScheduler `protobuf:"bytes,7,opt,name=flow_scheduler,json=flowScheduler,proto3,oneof"`
}

type FlowControl_AdaptiveFlowScheduler struct {
	...
	AdaptiveFlowScheduler *AdaptiveLoadScheduler `protobuf:"bytes,8,opt,name=adaptive_flow_scheduler,json=adaptiveFlowScheduler,proto3,oneof"`
}

type FlowControl_LoadRegulator struct {
	...
	LoadRegulator *LoadRegulator `protobuf:"bytes,9,opt,name=load_regulator,json=loadRegulator,proto3,oneof"`
}
...
func (*FlowControl_FlowScheduler) isFlowControl_Component() {}

func (*FlowControl_AdaptiveFlowScheduler) isFlowControl_Component() {}

func (*FlowControl_LoadRegulator) isFlowControl_Component() {}
...
type LoadScheduler struct {
	...
	// Types that are assignable to ActuationStrategy:
	//
	//	*LoadScheduler_LoadActuator
	ActuationStrategy isLoadScheduler_ActuationStrategy `protobuf_oneof:"actuation_strategy"`
}
...
func (m *LoadScheduler) GetActuationStrategy() isLoadScheduler_ActuationStrategy {
	if m != nil {
		return m.ActuationStrategy
	}
	return nil
...
func (x *LoadScheduler) GetLoadActuator() *LoadActuator {
	if x, ok := x.GetActuationStrategy().(*LoadScheduler_LoadActuator); ok {
		return x.LoadActuator
	}
	return nil
}

type isLoadScheduler_ActuationStrategy interface {
	isLoadScheduler_ActuationStrategy()
}

type LoadScheduler_LoadActuator struct {
	// Actuator based on limiting the accepted token rate at incoming token rate * load multiplier.
	LoadActuator *LoadActuator `protobuf:"bytes,3,opt,name=load_actuator,json=loadActuator,proto3,oneof"`
}

func (*LoadScheduler_LoadActuator) isLoadScheduler_ActuationStrategy() {}
...
func (x *AdaptiveLoadScheduler) GetDefaultConfig() *LoadActuator_DynamicConfig {
	if x != nil {
		return x.DefaultConfig
	}
	return nil
...
type LoadRegulator struct {
	...
	InPorts *LoadRegulator_Ins `protobuf:"bytes,1,opt,name=in_ports,json=inPorts,proto3" json:"in_ports,omitempty"`
	// Parameters for the _Load Regulator_.
	Parameters *LoadRegulator_Parameters `protobuf:"bytes,2,opt,name=parameters,proto3" json:"parameters,omitempty"`
	// Configuration key for DynamicConfig.
	DynamicConfigKey string `protobuf:"bytes,3,opt,name=dynamic_config_key,json=dynamicConfigKey,proto3" json:"dynamic_config_key,omitempty"`
	// Default configuration.
	DefaultConfig *LoadRegulator_DynamicConfig `protobuf:"bytes,4,opt,name=default_config,json=defaultConfig,proto3" json:"default_config,omitempty"`
}

func (x *LoadRegulator) Reset() {
	*x = LoadRegulator{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadRegulator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadRegulator) ProtoMessage() {}

func (x *LoadRegulator) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadRegulator.ProtoReflect.Descriptor instead.
func (*LoadRegulator) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{22}
}

func (x *LoadRegulator) GetInPorts() *LoadRegulator_Ins {
	if x != nil {
		return x.InPorts
	}
	return nil
...
func (x *LoadRegulator) GetParameters() *LoadRegulator_Parameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *LoadRegulator) GetDynamicConfigKey() string {
	if x != nil {
		return x.DynamicConfigKey
	}
	return ""
...
func (x *LoadRegulator) GetDefaultConfig() *LoadRegulator_DynamicConfig {
	if x != nil {
		return x.DefaultConfig
	}
	return nil
...
type LoadShaper struct {
	...
	DynamicConfigKey string `protobuf:"bytes,9,opt,name=dynamic_config_key,json=dynamicConfigKey,proto3" json:"dynamic_config_key,omitempty"`
	// Default configuration.
	DefaultConfig *LoadRegulator_DynamicConfig `protobuf:"bytes,10,opt,name=default_config,json=defaultConfig,proto3" json:"default_config,omitempty"`
}
...
func (x *LoadShaper) GetDefaultConfig() *LoadRegulator_DynamicConfig {
	if x != nil {
		return x.DefaultConfig
	}
	return nil
...
type LoadRegulator_DynamicConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LoadRegulator_DynamicConfig) Reset() {
	*x = LoadRegulator_DynamicConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadRegulator_DynamicConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadRegulator_DynamicConfig) ProtoMessage() {}

func (x *LoadRegulator_DynamicConfig) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadRegulator_DynamicConfig.ProtoReflect.Descriptor instead.
func (*LoadRegulator_DynamicConfig) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{22, 0}
}

func (x *LoadRegulator_DynamicConfig) GetEnableLabelValues() []string {
	if x != nil {
		return x.EnableLabelValues
	}
	return nil
...
type LoadRegulator_Parameters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LoadRegulator_Parameters) Reset() {
	*x = LoadRegulator_Parameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadRegulator_Parameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadRegulator_Parameters) ProtoMessage() {}

func (x *LoadRegulator_Parameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadRegulator_Parameters.ProtoReflect.Descriptor instead.
func (*LoadRegulator_Parameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{22, 1}
}

func (x *LoadRegulator_Parameters) GetFlowSelector() *FlowSelector {
	if x != nil {
		return x.FlowSelector
	}
	return nil
...
func (x *LoadRegulator_Parameters) GetLabelKey() string {
	if x != nil {
		return x.LabelKey
	}
	return ""
...
func (x *LoadRegulator_Ins) Reset() {
	*x = LoadRegulator_Ins{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoadRegulator_Ins) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadRegulator_Ins) ProtoMessage() {}

func (x *LoadRegulator_Ins) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadRegulator_Ins.ProtoReflect.Descriptor instead.
func (*LoadRegulator_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{22, 2}
}

func (x *LoadRegulator_Ins) GetAcceptPercentage() *InPort {
	if x != nil {
		return x.AcceptPercentage
	}
	return nil
...
type LoadShaper_Parameters struct {
	...
	LoadRegulatorParameters *LoadRegulator_Parameters `protobuf:"bytes,3,opt,name=load_regulator_parameters,json=loadRegulatorParameters,proto3" json:"load_regulator_parameters,omitempty"`
}
...
func (x *LoadShaper_Parameters) GetLoadRegulatorParameters() *LoadRegulator_Parameters {
	if x != nil {
		return x.LoadRegulatorParameters
	}
	return nil
}
...
var file_aperture_policy_language_v1_flowcontrol_proto_rawDesc = []byte{
	...
	0xdf, 0x06, 0x0a, 0x0b, 0x46, 0x6c, 0x6f, 0x77, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x12,
	...
	0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72,
	0x48, 0x00, 0x52, 0x0d, 0x66, 0x6c, 0x6f, 0x77, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x72, 0x12, 0x6c, 0x0a, 0x17, 0x61, 0x64, 0x61, 0x70, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x66, 0x6c,
	0x6f, 0x77, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01,
	...
	,
	...
	0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x4e, 0x0a, 0x0d, 0x66, 0x6c,
	...
	0x6f, 0x77, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x53, 0x0a, 0x0a, 0x70, 0x61,
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33,
	0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x61, 0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5d, 0x0a,
	0x0e, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	...
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xbc, 0x02, 0x0a,
	0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x4b, 0x0a, 0x14, 0x6c,
	...
	,
	...
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x73, 0x1a, 0x40, 0x0a, 0x03, 0x49, 0x6e, 0x73, 0x12,
	...
	0x6f, 0x72, 0x74, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x92, 0x02, 0x0a, 0x12, 0x43,
	...
	0x72, 0x12, 0x44, 0x0a, 0x09, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x18, 0x02,
	...
	0x8d, 0x02, 0x0a, 0x0d, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x72, 0x12, 0x4e, 0x0a, 0x0d, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74,
	0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x6c, 0x6f, 0x77, 0x53, 0x65, 0x6c, 0x65, 0x63,
	...
	0x64, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f, 0x72, 0x42, 0x14, 0x0a, 0x12, 0x61, 0x63, 0x74,
	0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22,
	0x8a, 0x0a, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x48, 0x0a,
	...
	0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x51, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x61, 0x70,
	0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x9b, 0x02, 0x0a, 0x08, 0x57,
	0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x5a, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x61, 0x70,
	0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61,
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
	...
	0x65, 0x72, 0x73, 0x12, 0x4e, 0x0a, 0x0d, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x5f, 0x6d, 0x61, 0x74,
	...
	0x68, 0x65, 0x72, 0x1a, 0x63, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72,
	...
	0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x61, 0x69, 0x72, 0x6e, 0x65, 0x73,
	0x73, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x66, 0x61, 0x69,
	0x72, 0x6e, 0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x1a, 0xda, 0x03, 0x0a, 0x0a, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x4d, 0x0a, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c,
	...
	0x65, 0x6c, 0x4b, 0x65, 0x79, 0x1a, 0xe4, 0x02, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12, 0x57,
	0x0a, 0x14, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x6e, 0x63, 0x75,
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61,
	0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c,
	...
	0x12, 0x54, 0x0a, 0x13, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x5f, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e,
	...
	0x6f, 0x72, 0x74, 0x52, 0x11, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x52, 0x61, 0x74, 0x65, 0x12, 0x54, 0x0a, 0x13, 0x69, 0x6e, 0x63, 0x6f, 0x6d, 0x69,
	0x6e, 0x67, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x11, 0x69, 0x6e, 0x63, 0x6f, 0x6d,
	0x69, 0x6e, 0x67, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x61, 0x74, 0x65, 0x22, 0xe5, 0x02, 0x0a,
	...
	0x6c, 0x69, 0x65, 0x72, 0x22, 0xc9, 0x0b, 0x0a, 0x15, 0x41, 0x64, 0x61, 0x70, 0x74, 0x69, 0x76,
	...
	0x67, 0x1a, 0xc2, 0x01, 0x0a, 0x03, 0x49, 0x6e, 0x73, 0x12, 0x3b, 0x0a, 0x06, 0x73, 0x69, 0x67,
	...
	0x65, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x3d, 0x0a, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74,
	0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x07, 0x65,
	0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x1a, 0xb7, 0x03, 0x0a, 0x04, 0x4f, 0x75, 0x74, 0x73, 0x12,
	...
	,
	...
	0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x58, 0x0a, 0x09, 0x6f, 0x75, 0x74, 0x5f, 0x70, 0x6f, 0x72,
	0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74,
	0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	...
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x6c, 0x6f, 0x77, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x52, 0x0c, 0x66, 0x6c, 0x6f, 0x77, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12,
	0x64, 0x0a, 0x14, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e,
	0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e,
	...
	0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x6b, 0x0a, 0x13, 0x67, 0x72, 0x61, 0x64, 0x69, 0x65, 0x6e,
	...
	0x6c, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x12,
	0x67, 0x72, 0x61, 0x64, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x73, 0x12, 0x2e, 0x0a, 0x13, 0x6d, 0x61, 0x78, 0x5f, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x6d,
	...
	0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x52, 0x1d, 0x6c, 0x6f,
	0x61, 0x64, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x4c, 0x69, 0x6e, 0x65,
	0x61, 0x72, 0x49, 0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x5e, 0x0a, 0x12, 0x61,
	0x6c, 0x65, 0x72, 0x74, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72,
	0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75,
	0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61,
	...
	0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x64,
	...
	0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xc2, 0x01, 0x0a, 0x03, 0x49, 0x6e,
	...
	0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x22, 0xd5,
	0x04, 0x0a, 0x0d, 0x46, 0x6c, 0x6f, 0x77, 0x52, 0x65, 0x67, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
	...
	0x65, 0x73, 0x1a, 0x79, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x4b, 0x65, 0x79, 0x1a, 0x57, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0xd5, 0x04, 0x0a, 0x0d, 0x4c, 0x6f, 0x61, 0x64, 0x52,
	...
	0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e,
	0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x67,
	...
	0x63, 0x65, 0x70, 0x74, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x22, 0xdc,
	0x09, 0x0a, 0x0a, 0x4c, 0x6f, 0x61, 0x64, 0x53, 0x68, 0x61, 0x70, 0x65, 0x72, 0x12, 0x46, 0x0a,
	0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x66, 0x69, 0x67, 0x1a, 0xba, 0x03, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	...
	,
	...
	0x52, 0x05, 0x72, 0x65, 0x73, 0x65, 0x74, 0x42, 0xad, 0x02, 0x0a, 0x33, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_aperture_policy_language_v1_flowcontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_aperture_policy_language_v1_flowcontrol_proto_goTypes = []interface{}{
	...
	(*LoadRegulator)(nil),                     // 22: aperture.policy.language.v1.LoadRegulator
	...
	nil,                                       // 25: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	(*FluxMeter_StaticBuckets)(nil),           // 26: aperture.policy.language.v1.FluxMeter.StaticBuckets
	(*FluxMeter_LinearBuckets)(nil),           // 27: aperture.policy.language.v1.FluxMeter.LinearBuckets
	(*FluxMeter_ExponentialBuckets)(nil),      // 28: aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	(*FluxMeter_ExponentialBucketsRange)(nil), // 29: aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	nil,                                         // 30: aperture.policy.language.v1.Classifier.RulesEntry
	(*Rule_Rego)(nil),                           // 31: aperture.policy.language.v1.Rule.Rego
	(*Rego_LabelProperties)(nil),                // 32: aperture.policy.language.v1.Rego.LabelProperties
	nil,                                         // 33: aperture.policy.language.v1.Rego.LabelsEntry
	nil,                                         // 34: aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	(*RateLimiter_Parameters)(nil),              // 35: aperture.policy.language.v1.RateLimiter.Parameters
	(*RateLimiter_Override)(nil),                // 36: aperture.policy.language.v1.RateLimiter.Override
	(*RateLimiter_DynamicConfig)(nil),           // 37: aperture.policy.language.v1.RateLimiter.DynamicConfig
	(*RateLimiter_Ins)(nil),                     // 38: aperture.policy.language.v1.RateLimiter.Ins
	(*RateLimiter_Parameters_LazySync)(nil),     // 39: aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	(*Scheduler_Workload)(nil),                  // 40: aperture.policy.language.v1.Scheduler.Workload
	(*Scheduler_Parameters)(nil),                // 41: aperture.policy.language.v1.Scheduler.Parameters
	(*Scheduler_Outs)(nil),                      // 42: aperture.policy.language.v1.Scheduler.Outs
	(*Scheduler_Workload_Parameters)(nil),       // 43: aperture.policy.language.v1.Scheduler.Workload.Parameters
	(*LoadActuator_DynamicConfig)(nil),          // 44: aperture.policy.language.v1.LoadActuator.DynamicConfig
	(*LoadActuator_Ins)(nil),                    // 45: aperture.policy.language.v1.LoadActuator.Ins
	(*AdaptiveLoadScheduler_Ins)(nil),           // 46: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins
	(*AdaptiveLoadScheduler_Outs)(nil),          // 47: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs
	(*AIMDConcurrencyController_Ins)(nil),       // 48: aperture.policy.language.v1.AIMDConcurrencyController.Ins
	(*AIMDConcurrencyController_Outs)(nil),      // 49: aperture.policy.language.v1.AIMDConcurrencyController.Outs
	(*FlowRegulator_DynamicConfig)(nil),         // 50: aperture.policy.language.v1.FlowRegulator.DynamicConfig
	(*FlowRegulator_Parameters)(nil),            // 51: aperture.policy.language.v1.FlowRegulator.Parameters
	(*FlowRegulator_Ins)(nil),                   // 52: aperture.policy.language.v1.FlowRegulator.Ins
	(*LoadRegulator_DynamicConfig)(nil),         // 53: aperture.policy.language.v1.LoadRegulator.DynamicConfig
	(*LoadRegulator_Parameters)(nil),            // 54: aperture.policy.language.v1.LoadRegulator.Parameters
	(*LoadRegulator_Ins)(nil),                   // 55: aperture.policy.language.v1.LoadRegulator.Ins
	(*LoadShaper_Parameters)(nil),               // 56: aperture.policy.language.v1.LoadShaper.Parameters
	(*LoadShaper_Ins)(nil),                      // 57: aperture.policy.language.v1.LoadShaper.Ins
	(*LoadShaper_Outs)(nil),                     // 58: aperture.policy.language.v1.LoadShaper.Outs
	(*LoadShaper_Parameters_Step)(nil),          // 59: aperture.policy.language.v1.LoadShaper.Parameters.Step
	(*LoadShaperSeries_LoadShaperInstance)(nil), // 60: aperture.policy.language.v1.LoadShaperSeries.LoadShaperInstance
	(*LoadShaperSeries_Parameters)(nil),         // 61: aperture.policy.language.v1.LoadShaperSeries.Parameters
	(*LoadShaperSeries_Ins)(nil),                // 62: aperture.policy.language.v1.LoadShaperSeries.Ins
	(*LabelMatcher)(nil),                        // 63: aperture.policy.language.v1.LabelMatcher
	(*GradientController_Parameters)(nil),       // 64: aperture.policy.language.v1.GradientController.Parameters
	(*Alerter_Parameters)(nil),                  // 65: aperture.policy.language.v1.Alerter.Parameters
	(*durationpb.Duration)(nil),                 // 66: google.protobuf.Duration
	(*InPort)(nil),                              // 67: aperture.policy.language.v1.InPort
	(*OutPort)(nil),                             // 68: aperture.policy.language.v1.OutPort
}
var file_aperture_policy_language_v1_flowcontrol_proto_depIdxs = []int32{
	...
	63,  // 2: aperture.policy.language.v1.FlowMatcher.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	25,  // 3: aperture.policy.language.v1.FlowControlResources.flux_meters:type_name -> aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	...
	26,  // 6: aperture.policy.language.v1.FluxMeter.static_buckets:type_name -> aperture.policy.language.v1.FluxMeter.StaticBuckets
	27,  // 7: aperture.policy.language.v1.FluxMeter.linear_buckets:type_name -> aperture.policy.language.v1.FluxMeter.LinearBuckets
	28,  // 8: aperture.policy.language.v1.FluxMeter.exponential_buckets:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	29,  // 9: aperture.policy.language.v1.FluxMeter.exponential_buckets_range:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	0,   // 10: aperture.policy.language.v1.Classifier.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	30,  // 11: aperture.policy.language.v1.Classifier.rules:type_name -> aperture.policy.language.v1.Classifier.RulesEntry
	...
	31,  // 14: aperture.policy.language.v1.Rule.rego:type_name -> aperture.policy.language.v1.Rule.Rego
	33,  // 15: aperture.policy.language.v1.Rego.labels:type_name -> aperture.policy.language.v1.Rego.LabelsEntry
	...
	34,  // 20: aperture.policy.language.v1.PathTemplateMatcher.template_values:type_name -> aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	...
	16,  // 27: aperture.policy.language.v1.FlowControl.flow_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler
	19,  // 28: aperture.policy.language.v1.FlowControl.adaptive_flow_scheduler:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler
	22,  // 29: aperture.policy.language.v1.FlowControl.load_regulator:type_name -> aperture.policy.language.v1.LoadRegulator
	38,  // 30: aperture.policy.language.v1.RateLimiter.in_ports:type_name -> aperture.policy.language.v1.RateLimiter.Ins
	0,   // 31: aperture.policy.language.v1.RateLimiter.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	35,  // 32: aperture.policy.language.v1.RateLimiter.parameters:type_name -> aperture.policy.language.v1.RateLimiter.Parameters
	37,  // 33: aperture.policy.language.v1.RateLimiter.default_config:type_name -> aperture.policy.language.v1.RateLimiter.DynamicConfig
	0,   // 34: aperture.policy.language.v1.ConcurrencyLimiter.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	17,  // 35: aperture.policy.language.v1.ConcurrencyLimiter.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	18,  // 36: aperture.policy.language.v1.ConcurrencyLimiter.load_actuator:type_name -> aperture.policy.language.v1.LoadActuator
	0,   // 37: aperture.policy.language.v1.LoadScheduler.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	17,  // 38: aperture.policy.language.v1.LoadScheduler.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	18,  // 39: aperture.policy.language.v1.LoadScheduler.load_actuator:type_name -> aperture.policy.language.v1.LoadActuator
	42,  // 40: aperture.policy.language.v1.Scheduler.out_ports:type_name -> aperture.policy.language.v1.Scheduler.Outs
	41,  // 41: aperture.policy.language.v1.Scheduler.parameters:type_name -> aperture.policy.language.v1.Scheduler.Parameters
	45,  // 42: aperture.policy.language.v1.LoadActuator.in_ports:type_name -> aperture.policy.language.v1.LoadActuator.Ins
	44,  // 43: aperture.policy.language.v1.LoadActuator.default_config:type_name -> aperture.policy.language.v1.LoadActuator.DynamicConfig
	46,  // 44: aperture.policy.language.v1.AdaptiveLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Ins
	47,  // 45: aperture.policy.language.v1.AdaptiveLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Outs
	0,   // 46: aperture.policy.language.v1.AdaptiveLoadScheduler.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	41,  // 47: aperture.policy.language.v1.AdaptiveLoadScheduler.scheduler_parameters:type_name -> aperture.policy.language.v1.Scheduler.Parameters
	64,  // 48: aperture.policy.language.v1.AdaptiveLoadScheduler.gradient_parameters:type_name -> aperture.policy.language.v1.GradientController.Parameters
	65,  // 49: aperture.policy.language.v1.AdaptiveLoadScheduler.alerter_parameters:type_name -> aperture.policy.language.v1.Alerter.Parameters
	44,  // 50: aperture.policy.language.v1.AdaptiveLoadScheduler.default_config:type_name -> aperture.policy.language.v1.LoadActuator.DynamicConfig
	48,  // 51: aperture.policy.language.v1.AIMDConcurrencyController.in_ports:type_name -> aperture.policy.language.v1.AIMDConcurrencyController.Ins
	49,  // 52: aperture.policy.language.v1.AIMDConcurrencyController.out_ports:type_name -> aperture.policy.language.v1.AIMDConcurrencyController.Outs
	0,   // 53: aperture.policy.language.v1.AIMDConcurrencyController.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	41,  // 54: aperture.policy.language.v1.AIMDConcurrencyController.scheduler_parameters:type_name -> aperture.policy.language.v1.Scheduler.Parameters
	64,  // 55: aperture.policy.language.v1.AIMDConcurrencyController.gradient_parameters:type_name -> aperture.policy.language.v1.GradientController.Parameters
	65,  // 56: aperture.policy.language.v1.AIMDConcurrencyController.alerter_parameters:type_name -> aperture.policy.language.v1.Alerter.Parameters
	44,  // 57: aperture.policy.language.v1.AIMDConcurrencyController.default_config:type_name -> aperture.policy.language.v1.LoadActuator.DynamicConfig
	52,  // 58: aperture.policy.language.v1.FlowRegulator.in_ports:type_name -> aperture.policy.language.v1.FlowRegulator.Ins
	51,  // 59: aperture.policy.language.v1.FlowRegulator.parameters:type_name -> aperture.policy.language.v1.FlowRegulator.Parameters
	50,  // 60: aperture.policy.language.v1.FlowRegulator.default_config:type_name -> aperture.policy.language.v1.FlowRegulator.DynamicConfig
	55,  // 61: aperture.policy.language.v1.LoadRegulator.in_ports:type_name -> aperture.policy.language.v1.LoadRegulator.Ins
	54,  // 62: aperture.policy.language.v1.LoadRegulator.parameters:type_name -> aperture.policy.language.v1.LoadRegulator.Parameters
	53,  // 63: aperture.policy.language.v1.LoadRegulator.default_config:type_name -> aperture.policy.language.v1.LoadRegulator.DynamicConfig
	57,  // 64: aperture.policy.language.v1.LoadShaper.in_ports:type_name -> aperture.policy.language.v1.LoadShaper.Ins
	58,  // 65: aperture.policy.language.v1.LoadShaper.out_ports:type_name -> aperture.policy.language.v1.LoadShaper.Outs
	56,  // 66: aperture.policy.language.v1.LoadShaper.parameters:type_name -> aperture.policy.language.v1.LoadShaper.Parameters
	53,  // 67: aperture.policy.language.v1.LoadShaper.default_config:type_name -> aperture.policy.language.v1.LoadRegulator.DynamicConfig
	62,  // 68: aperture.policy.language.v1.LoadShaperSeries.in_ports:type_name -> aperture.policy.language.v1.LoadShaperSeries.Ins
	61,  // 69: aperture.policy.language.v1.LoadShaperSeries.parameters:type_name -> aperture.policy.language.v1.LoadShaperSeries.Parameters
	4,   // 70: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	6,   // 71: aperture.policy.language.v1.Classifier.RulesEntry.value:type_name -> aperture.policy.language.v1.Rule
	32,  // 72: aperture.policy.language.v1.Rego.LabelsEntry.value:type_name -> aperture.policy.language.v1.Rego.LabelProperties
	66,  // 73: aperture.policy.language.v1.RateLimiter.Parameters.limit_reset_interval:type_name -> google.protobuf.Duration
	39,  // 74: aperture.policy.language.v1.RateLimiter.Parameters.lazy_sync:type_name -> aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	36,  // 75: aperture.policy.language.v1.RateLimiter.DynamicConfig.overrides:type_name -> aperture.policy.language.v1.RateLimiter.Override
	67,  // 76: aperture.policy.language.v1.RateLimiter.Ins.limit:type_name -> aperture.policy.language.v1.InPort
	43,  // 77: aperture.policy.language.v1.Scheduler.Workload.parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	63,  // 78: aperture.policy.language.v1.Scheduler.Workload.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	40,  // 79: aperture.policy.language.v1.Scheduler.Parameters.workloads:type_name -> aperture.policy.language.v1.Scheduler.Workload
	43,  // 80: aperture.policy.language.v1.Scheduler.Parameters.default_workload_parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	66,  // 81: aperture.policy.language.v1.Scheduler.Parameters.max_timeout:type_name -> google.protobuf.Duration
	66,  // 82: aperture.policy.language.v1.Scheduler.Parameters.decision_deadline_margin:type_name -> google.protobuf.Duration
	68,  // 83: aperture.policy.language.v1.Scheduler.Outs.accepted_concurrency:type_name -> aperture.policy.language.v1.OutPort
	68,  // 84: aperture.policy.language.v1.Scheduler.Outs.incoming_concurrency:type_name -> aperture.policy.language.v1.OutPort
	68,  // 85: aperture.policy.language.v1.Scheduler.Outs.accepted_token_rate:type_name -> aperture.policy.language.v1.OutPort
	68,  // 86: aperture.policy.language.v1.Scheduler.Outs.incoming_token_rate:type_name -> aperture.policy.language.v1.OutPort
	67,  // 87: aperture.policy.language.v1.LoadActuator.Ins.load_multiplier:type_name -> aperture.policy.language.v1.InPort
	67,  // 88: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	67,  // 89: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	67,  // 90: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.enabled:type_name -> aperture.policy.language.v1.InPort
	68,  // 91: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	68,  // 92: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	68,  // 93: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	68,  // 94: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.accepted_token_rate:type_name -> aperture.policy.language.v1.OutPort
	68,  // 95: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.incoming_token_rate:type_name -> aperture.policy.language.v1.OutPort
	67,  // 96: aperture.policy.language.v1.AIMDConcurrencyController.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	67,  // 97: aperture.policy.language.v1.AIMDConcurrencyController.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	67,  // 98: aperture.policy.language.v1.AIMDConcurrencyController.Ins.enabled:type_name -> aperture.policy.language.v1.InPort
	68,  // 99: aperture.policy.language.v1.AIMDConcurrencyController.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	68,  // 100: aperture.policy.language.v1.AIMDConcurrencyController.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	68,  // 101: aperture.policy.language.v1.AIMDConcurrencyController.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	68,  // 102: aperture.policy.language.v1.AIMDConcurrencyController.Outs.accepted_concurrency:type_name -> aperture.policy.language.v1.OutPort
	68,  // 103: aperture.policy.language.v1.AIMDConcurrencyController.Outs.incoming_concurrency:type_name -> aperture.policy.language.v1.OutPort
	0,   // 104: aperture.policy.language.v1.FlowRegulator.Parameters.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	67,  // 105: aperture.policy.language.v1.FlowRegulator.Ins.accept_percentage:type_name -> aperture.policy.language.v1.InPort
	0,   // 106: aperture.policy.language.v1.LoadRegulator.Parameters.flow_selector:type_name -> aperture.policy.language.v1.FlowSelector
	67,  // 107: aperture.policy.language.v1.LoadRegulator.Ins.accept_percentage:type_name -> aperture.policy.language.v1.InPort
	51,  // 108: aperture.policy.language.v1.LoadShaper.Parameters.flow_regulator_parameters:type_name -> aperture.policy.language.v1.FlowRegulator.Parameters
	59,  // 109: aperture.policy.language.v1.LoadShaper.Parameters.steps:type_name -> aperture.policy.language.v1.LoadShaper.Parameters.Step
	54,  // 110: aperture.policy.language.v1.LoadShaper.Parameters.load_regulator_parameters:type_name -> aperture.policy.language.v1.LoadRegulator.Parameters
	67,  // 111: aperture.policy.language.v1.LoadShaper.Ins.forward:type_name -> aperture.policy.language.v1.InPort
	67,  // 112: aperture.policy.language.v1.LoadShaper.Ins.backward:type_name -> aperture.policy.language.v1.InPort
	67,  // 113: aperture.policy.language.v1.LoadShaper.Ins.reset:type_name -> aperture.policy.language.v1.InPort
	68,  // 114: aperture.policy.language.v1.LoadShaper.Outs.accept_percentage:type_name -> aperture.policy.language.v1.OutPort
	68,  // 115: aperture.policy.language.v1.LoadShaper.Outs.at_start:type_name -> aperture.policy.language.v1.OutPort
	68,  // 116: aperture.policy.language.v1.LoadShaper.Outs.at_end:type_name -> aperture.policy.language.v1.OutPort
	66,  // 117: aperture.policy.language.v1.LoadShaper.Parameters.Step.duration:type_name -> google.protobuf.Duration
	56,  // 118: aperture.policy.language.v1.LoadShaperSeries.LoadShaperInstance.load_shaper:type_name -> aperture.policy.language.v1.LoadShaper.Parameters
	58,  // 119: aperture.policy.language.v1.LoadShaperSeries.LoadShaperInstance.out_ports:type_name -> aperture.policy.language.v1.LoadShaper.Outs
	60,  // 120: aperture.policy.language.v1.LoadShaperSeries.Parameters.load_shapers:type_name -> aperture.policy.language.v1.LoadShaperSeries.LoadShaperInstance
	67,  // 121: aperture.policy.language.v1.LoadShaperSeries.Ins.forward:type_name -> aperture.policy.language.v1.InPort
	67,  // 122: aperture.policy.language.v1.LoadShaperSeries.Ins.backward:type_name -> aperture.policy.language.v1.InPort
	67,  // 123: aperture.policy.language.v1.LoadShaperSeries.Ins.reset:type_name -> aperture.policy.language.v1.InPort
...
func file_aperture_policy_language_v1_flowcontrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadRegulator_DynamicConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadRegulator_Parameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadRegulator_Ins); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[13].OneofWrappers = []interface{}{
		...
		(*FlowControl_FlowScheduler)(nil),
		(*FlowControl_AdaptiveFlowScheduler)(nil),
		(*FlowControl_LoadRegulator)(nil),
	}
	...
	file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*LoadScheduler_LoadActuator)(nil),
	}
	type x struct{}
