...
type FlowControl struct {
	...
	//	*FlowControl_LeakyBucketRateLimiter
...
func (x *FlowControl) GetLeakyBucketRateLimiter() *LeakyBucketRateLimiter {
	if x, ok := x.GetComponent().(*FlowControl_LeakyBucketRateLimiter); ok {
		return x.LeakyBucketRateLimiter
	}
	return nil
}
...
type FlowControl_LeakyBucketRateLimiter struct {
	// _Leaky Bucket Rate Limiter_ provides service protection by applying rate limits using the leaky bucket algorithm.
	LeakyBucketRateLimiter *LeakyBucketRateLimiter `protobuf:"bytes,2,opt,name=leaky_bucket_rate_limiter,json=leakyBucketRateLimiter,proto3,oneof"`
}
...
func (*FlowControl_LeakyBucketRateLimiter) isFlowControl_Component() {}
...
// :::
//
// RateLimiting is done on per-label-value (`label_key`) basis and it uses the _Leaky Bucket Algorithm_.
//
// This algorithm lets your app make an unlimited amount of requests in infrequent bursts over time.
...
type LeakyBucketRateLimiter struct {
	...
	// Input ports for the RateLimiter component
	InPorts *LeakyBucketRateLimiter_Ins `protobuf:"bytes,1,opt,name=in_ports,json=inPorts,proto3" json:"in_ports,omitempty" validate:"required"` // @gotags: validate:"required"
	// Parameters for the RateLimiter component
	Parameters *LeakyBucketRateLimiter_Parameters `protobuf:"bytes,2,opt,name=parameters,proto3" json:"parameters,omitempty" validate:"required"` // @gotags: validate:"required"
	// Selectors for the component.
...
func (x *LeakyBucketRateLimiter) Reset() {
	*x = LeakyBucketRateLimiter{}
	if protoimpl.UnsafeEnabled {
...
func (x *LeakyBucketRateLimiter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeakyBucketRateLimiter) ProtoMessage() {}

func (x *LeakyBucketRateLimiter) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeakyBucketRateLimiter.ProtoReflect.Descriptor instead.
...
func (x *LeakyBucketRateLimiter) GetInPorts() *LeakyBucketRateLimiter_Ins {
	if x != nil {
		return x.InPorts
	}
	return nil
...
func (x *LeakyBucketRateLimiter) GetParameters() *LeakyBucketRateLimiter_Parameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *LeakyBucketRateLimiter) GetSelectors() []*Selector {
	if x != nil {
		return x.Selectors
	}
	return nil
...
type RateLimiter_Override struct {
	...
	// Number of flows allowed per `limit_reset_interval` for the given label value. Negative value means no limit.
	Limit float64 `protobuf:"fixed64,2,opt,name=limit,proto3" json:"limit,omitempty" validate:"required"` // @gotags: validate:"required"
}
...
func (x *RateLimiter_Override) GetLimit() float64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type LeakyBucketRateLimiter_Parameters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// have a _user_ flow
	// label set up, set `label_key: "user"`.
	LabelKey string `protobuf:"bytes,1,opt,name=label_key,json=labelKey,proto3" json:"label_key,omitempty" validate:"required"` // @gotags: validate:"required"
	// Flow label key that will be used to override the number of tokens
	// for this request.
	// This is an optional parameter and takes highest precedence
	// when assigning tokens to a request.
	...
	// Max idle time before leaky bucket state for a label is removed.
...
func (x *LeakyBucketRateLimiter_Parameters) Reset() {
	*x = LeakyBucketRateLimiter_Parameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *LeakyBucketRateLimiter_Parameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeakyBucketRateLimiter_Parameters) ProtoMessage() {}

func (x *LeakyBucketRateLimiter_Parameters) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeakyBucketRateLimiter_Parameters.ProtoReflect.Descriptor instead.
func (*LeakyBucketRateLimiter_Parameters) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{13, 0}
}

func (x *LeakyBucketRateLimiter_Parameters) GetLabelKey() string {
	if x != nil {
		return x.LabelKey
	}
	return ""
...
func (x *LeakyBucketRateLimiter_Parameters) GetTokensLabelKey() string {
	if x != nil {
		return x.TokensLabelKey
	}
	return ""
...
func (x *LeakyBucketRateLimiter_Parameters) GetMaxIdleTime() *durationpb.Duration {
	if x != nil {
...
type LeakyBucketRateLimiter_Ins struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Capacity of the bucket. If this capacity is negative, then the bucket is unbounded
	...
	LeakAmount *InPort `protobuf:"bytes,2,opt,name=leak_amount,json=leakAmount,proto3" json:"leak_amount,omitempty" validate:"required"` // @gotags: validate:"required"
	// Leak interval in ms.
	LeakIntervalMs *InPort `protobuf:"bytes,3,opt,name=leak_interval_ms,json=leakIntervalMs,proto3" json:"leak_interval_ms,omitempty" validate:"required"` // @gotags: validate:"required"
}

func (x *LeakyBucketRateLimiter_Ins) Reset() {
	*x = LeakyBucketRateLimiter_Ins{}
	if protoimpl.UnsafeEnabled {
...
func (x *LeakyBucketRateLimiter_Ins) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeakyBucketRateLimiter_Ins) ProtoMessage() {}

func (x *LeakyBucketRateLimiter_Ins) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeakyBucketRateLimiter_Ins.ProtoReflect.Descriptor instead.
func (*LeakyBucketRateLimiter_Ins) Descriptor() ([]byte, []int) {
	return file_aperture_policy_language_v1_flowcontrol_proto_rawDescGZIP(), []int{13, 1}
}

func (x *LeakyBucketRateLimiter_Ins) GetBucketCapacity() *InPort {
	if x != nil {
...
func (x *LeakyBucketRateLimiter_Ins) GetLeakAmount() *InPort {
	if x != nil {
		return x.LeakAmount
	}
	return nil
...
func (x *LeakyBucketRateLimiter_Ins) GetLeakIntervalMs() *InPort {
	if x != nil {
		return x.LeakIntervalMs
	}
	return nil
}
...
func (x *LoadScheduler_Ins) GetPassThrough() *InPort {
	if x != nil {
...
var file_aperture_policy_language_v1_flowcontrol_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xb8, 0x05, 0x0a, 0x0b, 0x46, 0x6c, 0x6f, 0x77, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x73, 0x52, 0x07, 0x69,
	0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x53, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65,
	...
	0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5d, 0x0a, 0x0e, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x43, 0x0a, 0x09, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x61, 0x70,
	0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61,
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x52, 0x09, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x1a, 0xbc, 0x02,
	...
	0x63, 0x12, 0x28, 0x0a, 0x10, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x5f, 0x6c, 0x61, 0x62, 0x65,
	0x6c, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4b, 0x65, 0x79, 0x1a, 0x3f, 0x0a, 0x08, 0x4c,
	...
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x6e, 0x75, 0x6d, 0x53, 0x79, 0x6e, 0x63, 0x1a, 0x41, 0x0a, 0x08,
	...
	0x61, 0x62, 0x65, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d,
	0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x1a,
	...
	0x6d, 0x69, 0x74, 0x22, 0x91, 0x05, 0x0a, 0x16, 0x4c, 0x65, 0x61, 0x6b, 0x79, 0x42, 0x75, 0x63,
	0x6b, 0x65, 0x74, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x65, 0x72, 0x12, 0x52,
	...
	0x65, 0x61, 0x6b, 0x79, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69,
	0x6d, 0x69, 0x74, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x73, 0x52, 0x07, 0x69, 0x6e, 0x50, 0x6f, 0x72,
	0x74, 0x73, 0x12, 0x5e, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x65, 0x61, 0x6b, 0x79, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74,
	...
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x1a, 0x92, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61,
	...
	0x4b, 0x65, 0x79, 0x12, 0x28, 0x0a, 0x10, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x5f, 0x6c, 0x61,
	0x62, 0x65, 0x6c, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4b, 0x65, 0x79, 0x12, 0x3d, 0x0a,
	0x0d, 0x6d, 0x61, 0x78, 0x5f, 0x69, 0x64, 0x6c, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0b, 0x6d, 0x61, 0x78, 0x49, 0x64, 0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x1a, 0xe8, 0x01, 0x0a,
	...
	0x74, 0x79, 0x12, 0x44, 0x0a, 0x0b, 0x6c, 0x65, 0x61, 0x6b, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75,
	0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61,
	0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x0a, 0x6c, 0x65,
	0x61, 0x6b, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x4d, 0x0a, 0x10, 0x6c, 0x65, 0x61, 0x6b,
	...
	0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x0e, 0x6c, 0x65, 0x61, 0x6b, 0x49, 0x6e, 0x74,
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x4d, 0x73, 0x22, 0x9b, 0x07, 0x0a, 0x0d, 0x4c, 0x6f, 0x61, 0x64,
	...
	0x67, 0x12, 0x55, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65,
	0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	...
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x1a, 0xda, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x41, 0x0a, 0x1d, 0x77, 0x6f, 0x72, 0x6b, 0x6c,
	0x6f, 0x61, 0x64, 0x5f, 0x6c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x62, 0x61, 0x73, 0x65,
	0x64, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1a,
	0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x4c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x42,
	0x61, 0x73, 0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x44, 0x0a, 0x09, 0x73, 0x63,
	...
	0x63, 0x74, 0x6f, 0x72, 0x73, 0x1a, 0x28, 0x0a, 0x0d, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63,
	...
	0x9b, 0x01, 0x0a, 0x03, 0x49, 0x6e, 0x73, 0x12, 0x4c, 0x0a, 0x0f, 0x6c, 0x6f, 0x61, 0x64, 0x5f,
	...
	0x70, 0x6c, 0x69, 0x65, 0x72, 0x12, 0x46, 0x0a, 0x0c, 0x70, 0x61, 0x73, 0x73, 0x5f, 0x74, 0x68,
	0x72, 0x6f, 0x75, 0x67, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70,
	0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61,
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74,
	0x52, 0x0b, 0x70, 0x61, 0x73, 0x73, 0x54, 0x68, 0x72, 0x6f, 0x75, 0x67, 0x68, 0x1a, 0x66, 0x0a,
	...
	0x70, 0x6c, 0x69, 0x65, 0x72, 0x22, 0xf3, 0x04, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4b, 0x65, 0x79, 0x1a, 0x9b, 0x02,
	...
	0x66, 0x61, 0x69, 0x72, 0x6e, 0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x22, 0xa5, 0x0a, 0x0a, 0x15,
	...
	0x4f, 0x75, 0x74, 0x73, 0x52, 0x08, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x5d,
	...
	0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5f, 0x0a, 0x0e, 0x64,
	...
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x86, 0x03, 0x0a,
	...
	0x69, 0x65, 0x72, 0x22, 0xba, 0x04, 0x0a, 0x09, 0x52, 0x65, 0x67, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	...
	0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x1a, 0x6e, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x22, 0xb9, 0x08, 0x0a, 0x08, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x61, 0x6d, 0x70, 0x12, 0x44, 0x0a,
	0x08, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x64, 0x79, 0x6e, 0x61,
	0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x5b, 0x0a, 0x0e,
	0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e,
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e,
	...
	,
	...
	0x05, 0x73, 0x74, 0x65, 0x70, 0x73, 0x1a, 0x77, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70, 0x12, 0x38,
	...
	0x74, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x61, 0x74, 0x45, 0x6e, 0x64, 0x22, 0x8f, 0x05, 0x0a,
	0x0e, 0x4c, 0x6f, 0x61, 0x64, 0x52, 0x61, 0x6d, 0x70, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73, 0x12,
	...
	,
	...
	0x1a, 0x69, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x5b,
	0x0a, 0x0a, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x72, 0x61, 0x6d, 0x70, 0x73, 0x18, 0x01, 0x20, 0x03,
	...
	0x52, 0x09, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x61, 0x6d, 0x70, 0x73, 0x1a, 0xc0, 0x01, 0x0a, 0x03,
	...
	0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x70, 0x65, 0x72, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31,
	0x2e, 0x49, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x72, 0x65, 0x73, 0x65, 0x74, 0x42, 0xb0,
...
var file_aperture_policy_language_v1_flowcontrol_proto_goTypes = []interface{}{
	...
	(*LeakyBucketRateLimiter)(nil),            // 13: aperture.policy.language.v1.LeakyBucketRateLimiter
	(*LoadScheduler)(nil),                     // 14: aperture.policy.language.v1.LoadScheduler
	(*Scheduler)(nil),                         // 15: aperture.policy.language.v1.Scheduler
	(*AdaptiveLoadScheduler)(nil),             // 16: aperture.policy.language.v1.AdaptiveLoadScheduler
	(*Regulator)(nil),                         // 17: aperture.policy.language.v1.Regulator
	(*LoadRamp)(nil),                          // 18: aperture.policy.language.v1.LoadRamp
	(*LoadRampSeries)(nil),                    // 19: aperture.policy.language.v1.LoadRampSeries
	nil,                                       // 20: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	(*FluxMeter_StaticBuckets)(nil),           // 21: aperture.policy.language.v1.FluxMeter.StaticBuckets
	(*FluxMeter_LinearBuckets)(nil),           // 22: aperture.policy.language.v1.FluxMeter.LinearBuckets
	(*FluxMeter_ExponentialBuckets)(nil),      // 23: aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	(*FluxMeter_ExponentialBucketsRange)(nil), // 24: aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	nil,                                     // 25: aperture.policy.language.v1.Classifier.RulesEntry
	...
	(*LeakyBucketRateLimiter_Parameters)(nil), // 34: aperture.policy.language.v1.LeakyBucketRateLimiter.Parameters
	(*LeakyBucketRateLimiter_Ins)(nil),        // 35: aperture.policy.language.v1.LeakyBucketRateLimiter.Ins
...
var file_aperture_policy_language_v1_flowcontrol_proto_depIdxs = []int32{
	...
	20, // 1: aperture.policy.language.v1.FlowControlResources.flux_meters:type_name -> aperture.policy.language.v1.FlowControlResources.FluxMetersEntry
	3,  // 2: aperture.policy.language.v1.FlowControlResources.classifiers:type_name -> aperture.policy.language.v1.Classifier
	21, // 3: aperture.policy.language.v1.FluxMeter.static_buckets:type_name -> aperture.policy.language.v1.FluxMeter.StaticBuckets
	22, // 4: aperture.policy.language.v1.FluxMeter.linear_buckets:type_name -> aperture.policy.language.v1.FluxMeter.LinearBuckets
	23, // 5: aperture.policy.language.v1.FluxMeter.exponential_buckets:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBuckets
	24, // 6: aperture.policy.language.v1.FluxMeter.exponential_buckets_range:type_name -> aperture.policy.language.v1.FluxMeter.ExponentialBucketsRange
	0,  // 7: aperture.policy.language.v1.FluxMeter.selectors:type_name -> aperture.policy.language.v1.Selector
	25, // 8: aperture.policy.language.v1.Classifier.rules:type_name -> aperture.policy.language.v1.Classifier.RulesEntry
	...
	27, // 12: aperture.policy.language.v1.Rego.labels:type_name -> aperture.policy.language.v1.Rego.LabelsEntry
	...
	28, // 17: aperture.policy.language.v1.PathTemplateMatcher.template_values:type_name -> aperture.policy.language.v1.PathTemplateMatcher.TemplateValuesEntry
	12, // 18: aperture.policy.language.v1.FlowControl.rate_limiter:type_name -> aperture.policy.language.v1.RateLimiter
	13, // 19: aperture.policy.language.v1.FlowControl.leaky_bucket_rate_limiter:type_name -> aperture.policy.language.v1.LeakyBucketRateLimiter
	14, // 20: aperture.policy.language.v1.FlowControl.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler
	16, // 21: aperture.policy.language.v1.FlowControl.adaptive_load_scheduler:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler
	17, // 22: aperture.policy.language.v1.FlowControl.regulator:type_name -> aperture.policy.language.v1.Regulator
	18, // 23: aperture.policy.language.v1.FlowControl.load_ramp:type_name -> aperture.policy.language.v1.LoadRamp
	19, // 24: aperture.policy.language.v1.FlowControl.load_ramp_series:type_name -> aperture.policy.language.v1.LoadRampSeries
	56, // 25: aperture.policy.language.v1.FlowControl.private:type_name -> google.protobuf.Any
	32, // 26: aperture.policy.language.v1.RateLimiter.in_ports:type_name -> aperture.policy.language.v1.RateLimiter.Ins
	29, // 27: aperture.policy.language.v1.RateLimiter.parameters:type_name -> aperture.policy.language.v1.RateLimiter.Parameters
	31, // 28: aperture.policy.language.v1.RateLimiter.default_config:type_name -> aperture.policy.language.v1.RateLimiter.DynamicConfig
	0,  // 29: aperture.policy.language.v1.RateLimiter.selectors:type_name -> aperture.policy.language.v1.Selector
	35, // 30: aperture.policy.language.v1.LeakyBucketRateLimiter.in_ports:type_name -> aperture.policy.language.v1.LeakyBucketRateLimiter.Ins
	34, // 31: aperture.policy.language.v1.LeakyBucketRateLimiter.parameters:type_name -> aperture.policy.language.v1.LeakyBucketRateLimiter.Parameters
	0,  // 32: aperture.policy.language.v1.LeakyBucketRateLimiter.selectors:type_name -> aperture.policy.language.v1.Selector
	38, // 33: aperture.policy.language.v1.LoadScheduler.in_ports:type_name -> aperture.policy.language.v1.LoadScheduler.Ins
	39, // 34: aperture.policy.language.v1.LoadScheduler.out_ports:type_name -> aperture.policy.language.v1.LoadScheduler.Outs
	37, // 35: aperture.policy.language.v1.LoadScheduler.default_config:type_name -> aperture.policy.language.v1.LoadScheduler.DynamicConfig
	36, // 36: aperture.policy.language.v1.LoadScheduler.parameters:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	40, // 37: aperture.policy.language.v1.Scheduler.workloads:type_name -> aperture.policy.language.v1.Scheduler.Workload
	41, // 38: aperture.policy.language.v1.Scheduler.default_workload_parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	57, // 39: aperture.policy.language.v1.Scheduler.decision_deadline_margin:type_name -> google.protobuf.Duration
	43, // 40: aperture.policy.language.v1.AdaptiveLoadScheduler.in_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Ins
	44, // 41: aperture.policy.language.v1.AdaptiveLoadScheduler.out_ports:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Outs
	42, // 42: aperture.policy.language.v1.AdaptiveLoadScheduler.parameters:type_name -> aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters
	37, // 43: aperture.policy.language.v1.AdaptiveLoadScheduler.default_config:type_name -> aperture.policy.language.v1.LoadScheduler.DynamicConfig
	47, // 44: aperture.policy.language.v1.Regulator.in_ports:type_name -> aperture.policy.language.v1.Regulator.Ins
	46, // 45: aperture.policy.language.v1.Regulator.parameters:type_name -> aperture.policy.language.v1.Regulator.Parameters
	45, // 46: aperture.policy.language.v1.Regulator.default_config:type_name -> aperture.policy.language.v1.Regulator.DynamicConfig
	49, // 47: aperture.policy.language.v1.LoadRamp.in_ports:type_name -> aperture.policy.language.v1.LoadRamp.Ins
	50, // 48: aperture.policy.language.v1.LoadRamp.out_ports:type_name -> aperture.policy.language.v1.LoadRamp.Outs
	48, // 49: aperture.policy.language.v1.LoadRamp.parameters:type_name -> aperture.policy.language.v1.LoadRamp.Parameters
	45, // 50: aperture.policy.language.v1.LoadRamp.default_config:type_name -> aperture.policy.language.v1.Regulator.DynamicConfig
	54, // 51: aperture.policy.language.v1.LoadRampSeries.in_ports:type_name -> aperture.policy.language.v1.LoadRampSeries.Ins
	53, // 52: aperture.policy.language.v1.LoadRampSeries.parameters:type_name -> aperture.policy.language.v1.LoadRampSeries.Parameters
	2,  // 53: aperture.policy.language.v1.FlowControlResources.FluxMetersEntry.value:type_name -> aperture.policy.language.v1.FluxMeter
	4,  // 54: aperture.policy.language.v1.Classifier.RulesEntry.value:type_name -> aperture.policy.language.v1.Rule
	26, // 55: aperture.policy.language.v1.Rego.LabelsEntry.value:type_name -> aperture.policy.language.v1.Rego.LabelProperties
	57, // 56: aperture.policy.language.v1.RateLimiter.Parameters.limit_reset_interval:type_name -> google.protobuf.Duration
	33, // 57: aperture.policy.language.v1.RateLimiter.Parameters.lazy_sync:type_name -> aperture.policy.language.v1.RateLimiter.Parameters.LazySync
	30, // 58: aperture.policy.language.v1.RateLimiter.DynamicConfig.overrides:type_name -> aperture.policy.language.v1.RateLimiter.Override
	58, // 59: aperture.policy.language.v1.RateLimiter.Ins.limit:type_name -> aperture.policy.language.v1.InPort
	57, // 60: aperture.policy.language.v1.LeakyBucketRateLimiter.Parameters.max_idle_time:type_name -> google.protobuf.Duration
	58, // 61: aperture.policy.language.v1.LeakyBucketRateLimiter.Ins.bucket_capacity:type_name -> aperture.policy.language.v1.InPort
	58, // 62: aperture.policy.language.v1.LeakyBucketRateLimiter.Ins.leak_amount:type_name -> aperture.policy.language.v1.InPort
	58, // 63: aperture.policy.language.v1.LeakyBucketRateLimiter.Ins.leak_interval_ms:type_name -> aperture.policy.language.v1.InPort
	15, // 64: aperture.policy.language.v1.LoadScheduler.Parameters.scheduler:type_name -> aperture.policy.language.v1.Scheduler
	0,  // 65: aperture.policy.language.v1.LoadScheduler.Parameters.selectors:type_name -> aperture.policy.language.v1.Selector
	58, // 66: aperture.policy.language.v1.LoadScheduler.Ins.load_multiplier:type_name -> aperture.policy.language.v1.InPort
	58, // 67: aperture.policy.language.v1.LoadScheduler.Ins.pass_through:type_name -> aperture.policy.language.v1.InPort
	59, // 68: aperture.policy.language.v1.LoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	41, // 69: aperture.policy.language.v1.Scheduler.Workload.parameters:type_name -> aperture.policy.language.v1.Scheduler.Workload.Parameters
	55, // 70: aperture.policy.language.v1.Scheduler.Workload.label_matcher:type_name -> aperture.policy.language.v1.LabelMatcher
	36, // 71: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.load_scheduler:type_name -> aperture.policy.language.v1.LoadScheduler.Parameters
	60, // 72: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.gradient:type_name -> aperture.policy.language.v1.GradientController.Parameters
	61, // 73: aperture.policy.language.v1.AdaptiveLoadScheduler.Parameters.alerter:type_name -> aperture.policy.language.v1.Alerter.Parameters
	58, // 74: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.signal:type_name -> aperture.policy.language.v1.InPort
	58, // 75: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.setpoint:type_name -> aperture.policy.language.v1.InPort
	58, // 76: aperture.policy.language.v1.AdaptiveLoadScheduler.Ins.overload_confirmation:type_name -> aperture.policy.language.v1.InPort
	59, // 77: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.is_overload:type_name -> aperture.policy.language.v1.OutPort
	59, // 78: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.desired_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	59, // 79: aperture.policy.language.v1.AdaptiveLoadScheduler.Outs.observed_load_multiplier:type_name -> aperture.policy.language.v1.OutPort
	...
	46, // 82: aperture.policy.language.v1.LoadRamp.Parameters.regulator:type_name -> aperture.policy.language.v1.Regulator.Parameters
...
func file_aperture_policy_language_v1_flowcontrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LeakyBucketRateLimiter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LeakyBucketRateLimiter_Parameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LeakyBucketRateLimiter_Ins); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_aperture_policy_language_v1_flowcontrol_proto_msgTypes[11].OneofWrappers = []interface{}{
		...
		(*FlowControl_LeakyBucketRateLimiter)(nil),
