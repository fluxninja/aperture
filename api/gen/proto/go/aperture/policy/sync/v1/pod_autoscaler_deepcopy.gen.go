...
// DeepCopyInto supports using PodAutoscalerWrapper within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscalerWrapper) DeepCopyInto(out *PodAutoscalerWrapper) {
	p := proto.Clone(in).(*PodAutoscalerWrapper)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscalerWrapper. Required by controller-gen.
func (in *PodAutoscalerWrapper) DeepCopy() *PodAutoscalerWrapper {
	if in == nil {
		return nil
	}
	out := new(PodAutoscalerWrapper)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscalerWrapper. Required by controller-gen.
func (in *PodAutoscalerWrapper) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using PodAutoscalerDynamicConfigWrapper within kubernetes types, where deepcopy-gen is used.
func (in *PodAutoscalerDynamicConfigWrapper) DeepCopyInto(out *PodAutoscalerDynamicConfigWrapper) {
	p := proto.Clone(in).(*PodAutoscalerDynamicConfigWrapper)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscalerDynamicConfigWrapper. Required by controller-gen.
func (in *PodAutoscalerDynamicConfigWrapper) DeepCopy() *PodAutoscalerDynamicConfigWrapper {
	if in == nil {
		return nil
	}
	out := new(PodAutoscalerDynamicConfigWrapper)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PodAutoscalerDynamicConfigWrapper. Required by controller-gen.
func (in *PodAutoscalerDynamicConfigWrapper) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
