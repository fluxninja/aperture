...
type PodAutoscalerWrapper struct {
	...
	PodAutoscaler    *v1.PodAutoscaler `protobuf:"bytes,2,opt,name=pod_autoscaler,json=podAutoscaler,proto3" json:"pod_autoscaler,omitempty"`
}

func (x *PodAutoscalerWrapper) Reset() {
	*x = PodAutoscalerWrapper{}
...
func (x *PodAutoscalerWrapper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PodAutoscalerWrapper) ProtoMessage() {}

func (x *PodAutoscalerWrapper) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_sync_v1_pod_autoscaler_proto_msgTypes[0]
...
// Deprecated: Use PodAutoscalerWrapper.ProtoReflect.Descriptor instead.
func (*PodAutoscalerWrapper) Descriptor() ([]byte, []int) {
	return file_aperture_policy_sync_v1_pod_autoscaler_proto_rawDescGZIP(), []int{0}
}

func (x *PodAutoscalerWrapper) GetCommonAttributes() *CommonAttributes {
	if x != nil {
...
func (x *PodAutoscalerWrapper) GetPodAutoscaler() *v1.PodAutoscaler {
	if x != nil {
...
type PodAutoscalerDynamicConfigWrapper struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// CommonAttributes
	CommonAttributes *CommonAttributes `protobuf:"bytes,1,opt,name=common_attributes,json=commonAttributes,proto3" json:"common_attributes,omitempty"`
	// PodAutoscalerDynamicConfig is the dynamic configuration for the pod autoscaler.
	PodAutoscalerDynamicConfig *v1.PodAutoscaler_ScaleActuator_DynamicConfig `protobuf:"bytes,2,opt,name=pod_autoscaler_dynamic_config,json=podAutoscalerDynamicConfig,proto3" json:"pod_autoscaler_dynamic_config,omitempty"`
}

func (x *PodAutoscalerDynamicConfigWrapper) Reset() {
	*x = PodAutoscalerDynamicConfigWrapper{}
	if protoimpl.UnsafeEnabled {
...
func (x *PodAutoscalerDynamicConfigWrapper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PodAutoscalerDynamicConfigWrapper) ProtoMessage() {}

func (x *PodAutoscalerDynamicConfigWrapper) ProtoReflect() protoreflect.Message {
	mi := &file_aperture_policy_sync_v1_pod_autoscaler_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PodAutoscalerDynamicConfigWrapper.ProtoReflect.Descriptor instead.
func (*PodAutoscalerDynamicConfigWrapper) Descriptor() ([]byte, []int) {
	return file_aperture_policy_sync_v1_pod_autoscaler_proto_rawDescGZIP(), []int{1}
}

func (x *PodAutoscalerDynamicConfigWrapper) GetCommonAttributes() *CommonAttributes {
	if x != nil {
		return x.CommonAttributes
	}
	return nil
...
func (x *PodAutoscalerDynamicConfigWrapper) GetPodAutoscalerDynamicConfig() *v1.PodAutoscaler_ScaleActuator_DynamicConfig {
	if x != nil {
		return x.PodAutoscalerDynamicConfig
	}
	return nil
}
...
var file_aperture_policy_sync_v1_pod_autoscaler_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xc1, 0x01, 0x0a, 0x14, 0x50, 0x6f, 0x64, 0x41, 0x75, 0x74, 0x6f, 0x73, 0x63,
	0x61, 0x6c, 0x65, 0x72, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x12, 0x56, 0x0a, 0x11, 0x63,
	...
	0x74, 0x65, 0x73, 0x12, 0x51, 0x0a, 0x0e, 0x70, 0x6f, 0x64, 0x5f, 0x61, 0x75, 0x74, 0x6f, 0x73,
	0x63, 0x61, 0x6c, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x61, 0x70,
	...
	0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x52, 0x0d, 0x70, 0x6f, 0x64, 0x41, 0x75, 0x74, 0x6f,
	0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x22, 0x87, 0x02, 0x0a, 0x21, 0x50, 0x6f, 0x64, 0x41, 0x75,
	0x74, 0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x12, 0x56, 0x0a, 0x11,
	...
	0x75, 0x74, 0x65, 0x73, 0x12, 0x89, 0x01, 0x0a, 0x1d, 0x70, 0x6f, 0x64, 0x5f, 0x61, 0x75, 0x74,
	0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x5f, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x46, 0x2e, 0x61,
	...
	0x74, 0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x2e, 0x53, 0x63, 0x61, 0x6c, 0x65, 0x41, 0x63,
	0x74, 0x75, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x52, 0x1a, 0x70, 0x6f, 0x64, 0x41, 0x75, 0x74, 0x6f, 0x73, 0x63, 0x61,
	0x6c, 0x65, 0x72, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x22, 0xb5, 0x01, 0x0a, 0x12, 0x53, 0x63, 0x61, 0x6c, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x47, 0x0a, 0x0c, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x73, 0x79, 0x6e, 0x63, 0x2e, 0x76,
	0x31, 0x42, 0x12, 0x50, 0x6f, 0x64, 0x41, 0x75, 0x74, 0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72,
...
var file_aperture_policy_sync_v1_pod_autoscaler_proto_goTypes = []interface{}{
	(*PodAutoscalerWrapper)(nil),                         // 0: aperture.policy.sync.v1.PodAutoscalerWrapper
	(*PodAutoscalerDynamicConfigWrapper)(nil),            // 1: aperture.policy.sync.v1.PodAutoscalerDynamicConfigWrapper
	...
	(*v1.PodAutoscaler)(nil),                             // 7: aperture.policy.language.v1.PodAutoscaler
	(*v1.PodAutoscaler_ScaleActuator_DynamicConfig)(nil), // 8: aperture.policy.language.v1.PodAutoscaler.ScaleActuator.DynamicConfig
}
var file_aperture_policy_sync_v1_pod_autoscaler_proto_depIdxs = []int32{
	6, // 0: aperture.policy.sync.v1.PodAutoscalerWrapper.common_attributes:type_name -> aperture.policy.sync.v1.CommonAttributes
	7, // 1: aperture.policy.sync.v1.PodAutoscalerWrapper.pod_autoscaler:type_name -> aperture.policy.language.v1.PodAutoscaler
	6, // 2: aperture.policy.sync.v1.PodAutoscalerDynamicConfigWrapper.common_attributes:type_name -> aperture.policy.sync.v1.CommonAttributes
	8, // 3: aperture.policy.sync.v1.PodAutoscalerDynamicConfigWrapper.pod_autoscaler_dynamic_config:type_name -> aperture.policy.language.v1.PodAutoscaler.ScaleActuator.DynamicConfig
...
func file_aperture_policy_sync_v1_pod_autoscaler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aperture_policy_sync_v1_pod_autoscaler_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PodAutoscalerWrapper); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_aperture_policy_sync_v1_pod_autoscaler_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PodAutoscalerDynamicConfigWrapper); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
