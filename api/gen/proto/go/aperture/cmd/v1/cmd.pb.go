...
type ListAutoScaleControlPointsAgentResponse struct {
	...
	AgentGroup             uint32                                 `protobuf:"varint,2,opt,name=agent_group,json=agentGroup,proto3" json:"agent_group,omitempty"`
}
...
func (x *ListAutoScaleControlPointsAgentResponse) GetAgentGroup() uint32 {
	if x != nil {
		return x.AgentGroup
	}
	return 0
...
var file_aperture_cmd_v1_cmd_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x0a, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x22, 0xc7,
