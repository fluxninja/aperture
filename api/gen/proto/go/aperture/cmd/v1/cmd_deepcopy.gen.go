...
// DeepCopyInto supports using ListFlowControlControlPointsRequest within kubernetes types, where deepcopy-gen is used.
func (in *ListFlowControlControlPointsRequest) DeepCopyInto(out *ListFlowControlControlPointsRequest) {
	p := proto.Clone(in).(*ListFlowControlControlPointsRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsRequest. Required by controller-gen.
func (in *ListFlowControlControlPointsRequest) DeepCopy() *ListFlowControlControlPointsRequest {
	if in == nil {
		return nil
	}
	out := new(ListFlowControlControlPointsRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsRequest. Required by controller-gen.
func (in *ListFlowControlControlPointsRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using ListFlowControlControlPointsAgentResponse within kubernetes types, where deepcopy-gen is used.
func (in *ListFlowControlControlPointsAgentResponse) DeepCopyInto(out *ListFlowControlControlPointsAgentResponse) {
	p := proto.Clone(in).(*ListFlowControlControlPointsAgentResponse)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsAgentResponse. Required by controller-gen.
func (in *ListFlowControlControlPointsAgentResponse) DeepCopy() *ListFlowControlControlPointsAgentResponse {
	if in == nil {
		return nil
	}
	out := new(ListFlowControlControlPointsAgentResponse)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsAgentResponse. Required by controller-gen.
func (in *ListFlowControlControlPointsAgentResponse) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using ListFlowControlControlPointsControllerResponse within kubernetes types, where deepcopy-gen is used.
func (in *ListFlowControlControlPointsControllerResponse) DeepCopyInto(out *ListFlowControlControlPointsControllerResponse) {
	p := proto.Clone(in).(*ListFlowControlControlPointsControllerResponse)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsControllerResponse. Required by controller-gen.
func (in *ListFlowControlControlPointsControllerResponse) DeepCopy() *ListFlowControlControlPointsControllerResponse {
	if in == nil {
		return nil
	}
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ListFlowControlControlPointsControllerResponse. Required by controller-gen.
func (in *ListFlowControlControlPointsControllerResponse) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
...
// DeepCopyInto supports using GlobalFlowControlControlPoint within kubernetes types, where deepcopy-gen is used.
func (in *GlobalFlowControlControlPoint) DeepCopyInto(out *GlobalFlowControlControlPoint) {
	p := proto.Clone(in).(*GlobalFlowControlControlPoint)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalFlowControlControlPoint. Required by controller-gen.
func (in *GlobalFlowControlControlPoint) DeepCopy() *GlobalFlowControlControlPoint {
	if in == nil {
		return nil
	}
	out := new(GlobalFlowControlControlPoint)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new GlobalFlowControlControlPoint. Required by controller-gen.
func (in *GlobalFlowControlControlPoint) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
