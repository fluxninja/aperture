...
// DeepCopyInto supports using Status_Error within kubernetes types, where deepcopy-gen is used.
func (in *Status_Error) DeepCopyInto(out *Status_Error) {
	p := proto.Clone(in).(*Status_Error)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Status_Error. Required by controller-gen.
func (in *Status_Error) DeepCopy() *Status_Error {
	if in == nil {
		return nil
	}
	out := new(Status_Error)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new Status_Error. Required by controller-gen.
func (in *Status_Error) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
