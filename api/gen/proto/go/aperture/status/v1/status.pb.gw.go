...
func RegisterStatusServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StatusServiceServer) error {
	...
	mux.Handle("GET", pattern_StatusService_GetGroupStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aperture.status.v1.StatusService/GetGroupStatus", runtime.WithHTTPPathPattern("/v1/status/{path=**}"))
		if err != nil {
...
func RegisterStatusServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StatusServiceClient) error {
	...
	mux.Handle("GET", pattern_StatusService_GetGroupStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aperture.status.v1.StatusService/GetGroupStatus", runtime.WithHTTPPathPattern("/v1/status/{path=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
