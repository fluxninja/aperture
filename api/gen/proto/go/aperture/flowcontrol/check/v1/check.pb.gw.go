...
/*
Package checkv1 is a reverse proxy.
...
var (
	filter_FlowControlService_Check_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_FlowControlService_Check_0(ctx context.Context, marshaler runtime.Marshaler, client FlowControlServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FlowControlService_Check_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_FlowControlService_Check_0(ctx context.Context, marshaler runtime.Marshaler, server FlowControlServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CheckRequest
	var metadata runtime.ServerMetadata
...
func RegisterFlowControlServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FlowControlServiceServer) error {
	...
	mux.Handle("POST", pattern_FlowControlService_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aperture.flowcontrol.check.v1.FlowControlService/Check", runtime.WithHTTPPathPattern("/v1/flowcontrol/check"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FlowControlService_Check_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_FlowControlService_Check_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFlowControlServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FlowControlServiceClient) error {
	...
	mux.Handle("POST", pattern_FlowControlService_Check_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aperture.flowcontrol.check.v1.FlowControlService/Check", runtime.WithHTTPPathPattern("/v1/flowcontrol/check"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FlowControlService_Check_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_FlowControlService_Check_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "flowcontrol", "check"}, ""))
)

var (
	forward_FlowControlService_Check_0 = runtime.ForwardResponseMessage
)
