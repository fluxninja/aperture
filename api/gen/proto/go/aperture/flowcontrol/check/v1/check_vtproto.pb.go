...
func (m *CheckRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CacheLookupRequest != nil {
		size, err := m.CacheLookupRequest.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CheckResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CacheLookupResponse != nil {
		size, err := m.CacheLookupResponse.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CacheUpsertRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ResultCacheEntry != nil {
		size, err := m.ResultCacheEntry.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CacheUpsertResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ResultCacheResponse != nil {
		size, err := m.ResultCacheResponse.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CacheDeleteRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ResultCacheKey) > 0 {
		i -= len(m.ResultCacheKey)
		copy(dAtA[i:], m.ResultCacheKey)
		i = encodeVarint(dAtA, i, uint64(len(m.ResultCacheKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ControlPoint) > 0 {
...
func (m *LimiterDecision_ConcurrencyLimiterInfo_) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ConcurrencyLimiterInfo != nil {
		size, err := m.ConcurrencyLimiterInfo.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *LimiterDecision_ConcurrencySchedulerInfo_) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ConcurrencySchedulerInfo != nil {
		size, err := m.ConcurrencySchedulerInfo.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TokenReturnStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.InflightRequestRef != nil {
		size, err := m.InflightRequestRef.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FlowEndRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.InflightRequests) > 0 {
		for iNdEx := len(m.InflightRequests) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.InflightRequests[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *FlowEndResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TokenReturnStatuses) > 0 {
		for iNdEx := len(m.TokenReturnStatuses) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.TokenReturnStatuses[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CheckResponse) SizeVT() (n int) {
	...
	if m.CacheLookupResponse != nil {
		l = m.CacheLookupResponse.SizeVT()
		n += 1 + l + sov(uint64(l))
	}
	if m.ExpectEnd {
		n += 3
...
func (m *LimiterDecision_ConcurrencyLimiterInfo) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LimiterDecision_ConcurrencySchedulerInfo) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LimiterDecision_ConcurrencyLimiterInfo_) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ConcurrencyLimiterInfo != nil {
		l = m.ConcurrencyLimiterInfo.SizeVT()
		n += 2 + l + sov(uint64(l))
	}
	return n
}
func (m *LimiterDecision_ConcurrencySchedulerInfo_) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ConcurrencySchedulerInfo != nil {
		l = m.ConcurrencySchedulerInfo.SizeVT()
		n += 2 + l + sov(uint64(l))
	}
	return n
}
...
func (m *FlowEndResponse) SizeVT() (n int) {
	...
	_ = l
	if len(m.TokenReturnStatuses) > 0 {
		for _, e := range m.TokenReturnStatuses {
			l = e.SizeVT()
			n += 1 + l + sov(uint64(l))
		}
	}
...
func (m *CheckRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheLookupRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CacheLookupRequest == nil {
				m.CacheLookupRequest = &CacheLookupRequest{}
			}
			if err := m.CacheLookupRequest.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *CheckResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheLookupResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CacheLookupResponse == nil {
				m.CacheLookupResponse = &CacheLookupResponse{}
			}
			if err := m.CacheLookupResponse.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:
...
func (m *KeyLookupResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyLookupResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyLookupResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CacheUpsertRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CacheUpsertRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CacheUpsertRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultCacheEntry", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ResultCacheEntry == nil {
				m.ResultCacheEntry = &CacheEntry{}
			}
			if err := m.ResultCacheEntry.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *CacheUpsertResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CacheUpsertResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CacheUpsertResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultCacheResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ResultCacheResponse == nil {
				m.ResultCacheResponse = &KeyUpsertResponse{}
			}
			if err := m.ResultCacheResponse.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *KeyUpsertResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyUpsertResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyUpsertResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *CacheDeleteRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultCacheKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ResultCacheKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *CacheDeleteResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ResultCacheResponse == nil {
				m.ResultCacheResponse = &KeyDeleteResponse{}
			}
			if err := m.ResultCacheResponse.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *KeyDeleteResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyDeleteResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyDeleteResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *CacheLookupRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CacheLookupRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CacheLookupRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CacheLookupResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CacheLookupResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CacheLookupResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.ResultCacheResponse == nil {
				m.ResultCacheResponse = &KeyLookupResponse{}
			}
			if err := m.ResultCacheResponse.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *LimiterDecision_ConcurrencyLimiterInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LimiterDecision_ConcurrencyLimiterInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LimiterDecision_ConcurrencyLimiterInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LimiterDecision_ConcurrencySchedulerInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LimiterDecision_ConcurrencySchedulerInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LimiterDecision_ConcurrencySchedulerInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *LimiterDecision) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConcurrencyLimiterInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Details.(*LimiterDecision_ConcurrencyLimiterInfo_); ok {
				if err := oneof.ConcurrencyLimiterInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &LimiterDecision_ConcurrencyLimiterInfo{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Details = &LimiterDecision_ConcurrencyLimiterInfo_{ConcurrencyLimiterInfo: v}
			}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConcurrencySchedulerInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Details.(*LimiterDecision_ConcurrencySchedulerInfo_); ok {
				if err := oneof.ConcurrencySchedulerInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &LimiterDecision_ConcurrencySchedulerInfo{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Details = &LimiterDecision_ConcurrencySchedulerInfo_{ConcurrencySchedulerInfo: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *InflightRequestRef) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InflightRequestRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InflightRequestRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TokenReturnStatus) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TokenReturnStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TokenReturnStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InflightRequestRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InflightRequestRef == nil {
				m.InflightRequestRef = &InflightRequestRef{}
			}
			if err := m.InflightRequestRef.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *FlowEndRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowEndRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowEndRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.InflightRequests = append(m.InflightRequests, &InflightRequestRef{})
			if err := m.InflightRequests[len(m.InflightRequests)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FlowEndResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowEndResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowEndResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TokenReturnStatuses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TokenReturnStatuses = append(m.TokenReturnStatuses, &TokenReturnStatus{})
			if err := m.TokenReturnStatuses[len(m.TokenReturnStatuses)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
