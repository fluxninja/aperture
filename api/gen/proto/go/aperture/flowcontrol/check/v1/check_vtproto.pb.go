...
func (m *CheckRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.CacheKeys) > 0 {
		for iNdEx := len(m.CacheKeys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.CacheKeys[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *CacheRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CacheRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CacheRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.Deletes) > 0 {
		for iNdEx := len(m.Deletes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.Deletes[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *CheckResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.CachedResponses) > 0 {
		for k := range m.CachedResponses {
			v := m.CachedResponses[k]
			baseI := i
			size, err := v.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
...
func (m *CacheResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CacheResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CacheResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CacheRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CheckResponse) SizeVT() (n int) {
	...
	if len(m.CachedResponses) > 0 {
		for k, v := range m.CachedResponses {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *CacheResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CacheRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if m.Upserts == nil {
				m.Upserts = make(map[string]*CacheItem)
			}
			var mapkey string
...
func (m *CheckResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CachedResponses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CachedResponses == nil {
				m.CachedResponses = make(map[string]*CacheResponse)
			}
			var mapkey string
			var mapvalue *CacheResponse
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.CachedResponses[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *CacheResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Result |= CacheResult(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
