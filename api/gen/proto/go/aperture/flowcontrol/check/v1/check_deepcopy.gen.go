...
// DeepCopyInto supports using GatewayCheckRequest within kubernetes types, where deepcopy-gen is used.
func (in *GatewayCheckRequest) DeepCopyInto(out *GatewayCheckRequest) {
	p := proto.Clone(in).(*GatewayCheckRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayCheckRequest. Required by controller-gen.
func (in *GatewayCheckRequest) DeepCopy() *GatewayCheckRequest {
	if in == nil {
		return nil
	}
	out := new(GatewayCheckRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new GatewayCheckRequest. Required by controller-gen.
func (in *GatewayCheckRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
