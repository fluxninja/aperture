...
func (m *FlowControlPoints) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FlowControlPoints) > 0 {
		for iNdEx := len(m.FlowControlPoints) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.FlowControlPoints[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *FlowControlPoints) SizeVT() (n int) {
	...
	_ = l
	if len(m.FlowControlPoints) > 0 {
		for _, e := range m.FlowControlPoints {
			l = e.SizeVT()
			n += 1 + l + sov(uint64(l))
		}
	}
...
func (m *FlowControlPoints) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FlowControlPoints: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowControlPoints: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.FlowControlPoints = append(m.FlowControlPoints, &FlowControlPoint{})
			if err := m.FlowControlPoints[len(m.FlowControlPoints)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *FlowControlPoint) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FlowControlPoint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowControlPoint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
