...
// DeepCopyInto supports using MemStats within kubernetes types, where deepcopy-gen is used.
func (in *MemStats) DeepCopyInto(out *MemStats) {
	p := proto.Clone(in).(*MemStats)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemStats. Required by controller-gen.
func (in *MemStats) DeepCopy() *MemStats {
	if in == nil {
		return nil
	}
	out := new(MemStats)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new MemStats. Required by controller-gen.
func (in *MemStats) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using MemStats_BySize within kubernetes types, where deepcopy-gen is used.
func (in *MemStats_BySize) DeepCopyInto(out *MemStats_BySize) {
	p := proto.Clone(in).(*MemStats_BySize)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemStats_BySize. Required by controller-gen.
func (in *MemStats_BySize) DeepCopy() *MemStats_BySize {
	if in == nil {
		return nil
	}
	out := new(MemStats_BySize)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new MemStats_BySize. Required by controller-gen.
func (in *MemStats_BySize) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
