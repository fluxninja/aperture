...
// DeepCopyInto supports using EntityID within kubernetes types, where deepcopy-gen is used.
func (in *EntityID) DeepCopyInto(out *EntityID) {
	p := proto.Clone(in).(*EntityID)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntityID. Required by controller-gen.
func (in *EntityID) DeepCopy() *EntityID {
	if in == nil {
		return nil
	}
	out := new(EntityID)
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new EntityID. Required by controller-gen.
func (in *EntityID) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
