...
// DeepCopyInto supports using PeersRequest within kubernetes types, where deepcopy-gen is used.
func (in *PeersRequest) DeepCopyInto(out *PeersRequest) {
	p := proto.Clone(in).(*PeersRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PeersRequest. Required by controller-gen.
func (in *PeersRequest) DeepCopy() *PeersRequest {
	if in == nil {
		return nil
	}
	out := new(PeersRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new PeersRequest. Required by controller-gen.
func (in *PeersRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
