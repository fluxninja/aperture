...
func (c *infoServiceClient) Version(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*VersionInfo, error) {
	out := new(VersionInfo)
	err := c.cc.Invoke(ctx, "/aperture.common.info.v1.InfoService/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoServiceClient) Process(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProcessInfo, error) {
	out := new(ProcessInfo)
	err := c.cc.Invoke(ctx, "/aperture.common.info.v1.InfoService/Process", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infoServiceClient) Host(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HostInfo, error) {
	out := new(HostInfo)
	err := c.cc.Invoke(ctx, "/aperture.common.info.v1.InfoService/Host", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _InfoService_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aperture.common.info.v1.InfoService/Version",
	}
...
func _InfoService_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aperture.common.info.v1.InfoService/Process",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _InfoService_Host_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aperture.common.info.v1.InfoService/Host",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var InfoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aperture.common.info.v1.InfoService",
	...
	Metadata: "aperture/common/info/v1/info.proto",
}
