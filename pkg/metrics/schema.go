...
const (
	...
	// QuotaCheckCounterTotalMetricName - name of the counter describing times quota was checked for all the labels.
	QuotaCheckCounterTotalMetricName = "quota_check_counter_total"
