...
func (a Agents) ListControlPoints() ([]rpc.Result[*cmdv1.ListControlPointsAgentResponse], error) {
	var req cmdv1.ListControlPointsRequest
	return rpc.CallAll[cmdv1.ListControlPointsAgentResponse](a.Clients, &req)
}
