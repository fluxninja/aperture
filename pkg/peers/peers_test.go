...
// 		grpc.ServerConstructor{Name: "peers-grpc-client"}.Annotate(),
// 		grpcclient.ClientConstructor{Name: "peers-grpc-client", ConfigKey: "peers.client.grpc"}.Annotate(),
// 		fx.Populate(&svc),
// 	)
...
// 	pd, err := peers.NewPeerDiscovery("peers", etcd_client, peers.PeerWatchers{})
// 	Expect(err).NotTo(HaveOccurred())
