...
// DeleteFluxmeterHistogram mocks base method.
func (m *MockResponseMetricsAPI) DeleteFluxmeterHistogram(fluxmeterID string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteFluxmeterHistogram", fluxmeterID)
	ret0, _ := ret[0].(bool)
	return ret0
}

// DeleteFluxmeterHistogram indicates an expected call of DeleteFluxmeterHistogram.
func (mr *MockResponseMetricsAPIMockRecorder) DeleteFluxmeterHistogram(fluxmeterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteFluxmeterHistogram", reflect.TypeOf((*MockResponseMetricsAPI)(nil).DeleteFluxmeterHistogram), fluxmeterID)
}
...
// GetFluxMeterHistogram mocks base method.
func (m *MockResponseMetricsAPI) GetFluxMeterHistogram(fluxmeterID, statusCode, featureStatus string, decisionType flowcontrolv1.CheckResponse_DecisionType) (prometheus.Observer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFluxMeterHistogram", fluxmeterID, statusCode, featureStatus, decisionType)
	ret0, _ := ret[0].(prometheus.Observer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetFluxMeterHistogram indicates an expected call of GetFluxMeterHistogram.
func (mr *MockResponseMetricsAPIMockRecorder) GetFluxMeterHistogram(fluxmeterID, statusCode, featureStatus, decisionType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFluxMeterHistogram", reflect.TypeOf((*MockResponseMetricsAPI)(nil).GetFluxMeterHistogram), fluxmeterID, statusCode, featureStatus, decisionType)
}
