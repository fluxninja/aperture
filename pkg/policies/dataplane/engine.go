...
func (e *Engine) GetFluxMeterHist(policyName, fluxMeterName, policyHash, statusCode string, decisionType flowcontrolv1.DecisionType) prometheus.Histogram {
	...
	if fluxMeter != nil {
		return fluxMeter.GetHistogram(decisionType, statusCode)
	}
	return nil
}
