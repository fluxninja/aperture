...
//
// FIXME reword this
// This struct is meant to be deserializable from json-serialized
...
// ```
//
// And such EMA component this could be serialized and deserialized into Ports
// as:
//
// ```go
//
...
func PortsFromMapStruct(componentMapStruct map[string]any) (Ports, error) {
	...
	decoder.Decode(componentMapStruct)
	return ports, err
}
