...
func ParseLoadShaper(loadShaper *policylangv1.LoadShaper) (*policylangv1.NestedCircuit, error) {
	...
	if loadShaper.Parameters.LoadRegulatorParameters != nil {
		nestedCircuit.Components = append(nestedCircuit.Components, &policylangv1.Component{
			Component: &policylangv1.Component_FlowControl{
				FlowControl: &policylangv1.FlowControl{
					Component: &policylangv1.FlowControl_LoadRegulator{
						LoadRegulator: &policylangv1.LoadRegulator{
							Parameters: loadShaper.Parameters.LoadRegulatorParameters,
							InPorts: &policylangv1.LoadRegulator_Ins{
	...
	} else if loadShaper.Parameters.FlowRegulatorParameters != nil {
		nestedCircuit.Components = append(nestedCircuit.Components, &policylangv1.Component{
			Component: &policylangv1.Component_FlowControl{
				FlowControl: &policylangv1.FlowControl{
