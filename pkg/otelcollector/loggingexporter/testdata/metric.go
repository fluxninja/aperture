...
func GenerateMetricsAllTypesNoDataPoints() pmetric.Metrics {
	...
	initMetric(ms.AppendEmpty(), TestHistogramMetricName, pmetric.MetricDataTypeHistogram)
	initMetric(ms.AppendEmpty(), TestSummaryMetricName, pmetric.MetricDataTypeSummary)
	return md
}
