...
`
		...
		Expect(err).NotTo(HaveOccurred())
		loadScheduler.EXPECT().GetLatencyObserver(labelsFoo1).Return(summary).Times(1)
...
`
		...
		Expect(err).NotTo(HaveOccurred())
		loadScheduler.EXPECT().GetLatencyObserver(labelsFoo1).Return(summaryFoo).Times(1)
		...
		Expect(err).NotTo(HaveOccurred())
		loadScheduler.EXPECT().GetLatencyObserver(labelsFizz1).Return(summaryFizz1).Times(1)
		...
		Expect(err).NotTo(HaveOccurred())
		loadScheduler.EXPECT().GetLatencyObserver(labelsFizz2).Return(summaryFizz2).Times(1)
