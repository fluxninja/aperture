...
var _ = DescribeTable("Check Response labels", func(checkResponse *flowcontrolv1.CheckResponse, after map[string]interface{}) {
	...
	Entry("Sets rate limiters",
		...
		map[string]interface{}{
			otelcollector.ApertureRateLimitersLabel:         []interface{}{"policy_name:foo,component_id:2,policy_hash:foo-hash"},
			otelcollector.ApertureDroppingRateLimitersLabel: []interface{}{"policy_name:foo,component_id:2,policy_hash:foo-hash"},
		},
	),
	...
	Entry("Sets concurrency limiters",
		...
		map[string]interface{}{
			otelcollector.ApertureConcurrencyLimitersLabel:         []interface{}{"policy_name:foo,component_id:1,policy_hash:foo-hash"},
			otelcollector.ApertureDroppingConcurrencyLimitersLabel: []interface{}{"policy_name:foo,component_id:1,policy_hash:foo-hash"},
		},
	),
