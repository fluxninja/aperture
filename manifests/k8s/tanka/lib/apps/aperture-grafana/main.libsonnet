...
local dashboard = import 'github.com/fluxninja/aperture-blueprints/lib/1.0/dashboards/latency-gradient.libsonnet';
...
local dashboards =
  [
    ...
    dashboard.spec.withJson(std.manifestJsonEx(dashboard({
