...
| `controller.replicaCount`                                    | Specifies the number of replicas for the Aperture Agent deployment. Only applicable when .Values.controller.namespaceScoped is true.                                      | `1`                   |
