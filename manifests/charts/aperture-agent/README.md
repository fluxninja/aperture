...
| `agent.config`                                          | Agent Configuration: All the available configuration parameters can be found at https://github.com/fluxninja/aperture/blob/main/docs/gen/config/aperture-agent/swagger.md. | `nil`    |
