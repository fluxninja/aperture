...
| `policy.concurrencyLimiter.alerterChannels`                    | `[]string`                             | `[]`                | A list of alert channels to which the alert will be sent. If default is used it will be overwritten to `[$.common.policyName]`. |
