...
commonConfig {
  policy+: {
    ...
    * @param (policy.rate_limiter.parameters.limit_by_label_key: string) Flow label key to use for rate limiting. If not specified, then all requests matching the selector will be rate limited.
