...
commonConfig {
  ...
  * @param (policy.service_protection_core.aimd_throttling_strategy: aperture.spec.v1.AdaptiveLoadSchedulerAIMDThrottlingStrategy) Parameters for AIMD throttling strategy.
