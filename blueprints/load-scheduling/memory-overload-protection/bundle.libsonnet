...
function(params) {
  ...
  local promqlQuery = 'avg(k8s_pod_memory_usage_bytes{k8s_deployment_name="%(k8s_pod_name)s",k8s_namespace_name="%(k8s_namespace_name)s",policy_name="%(policyName)s", infra_meter_name="kubeletstats"})' % {
