...
* @schema (auto_scaling.scaling_parameters: aperture.spec.v1.AutoScalerScalingParameters) Parameters that define the scaling behavior.
...
* @schema (auto_scaling.scaling_backend: aperture.spec.v1.AutoScalerScalingBackend) Scaling backend for the policy.
*/
