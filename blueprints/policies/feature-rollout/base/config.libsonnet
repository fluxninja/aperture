...
{
  /**
  * @param (policy: rollout_policy) Parameters for the Feature Rollout policy.
  */
  ...
  */
  ...
  /**
  * @schema (rollout_policy.policy_name: string) Name of the policy.
  * @schema (rollout_policy.load_ramp: aperture.spec.v1.LoadRampParameters) Identify the service and flows of the feature that needs to be rolled out. And specify feature rollout steps.
